<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010801090001.aspx.cs" Inherits="P010801090001" %>

<%@ Register Assembly="Framework.WebControls" Namespace="Framework.WebControls" TagPrefix="cc1" %>
<%@ Register Src="~/Common/Controls/CustUpdateProgress.ascx" TagName="image" TagPrefix="cust" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<%-- 修改紀錄:2021/01/25_Ares_Stanley-調整頁面資料避免按鈕失效; 2021/01/26,27_Ares_Stanley-調整版面 --%>
            ...
            <ContentTemplate>                
                <table width="100%" border="0" cellpadding="0" cellspacing="1" id="tabNo1" style="table-layout:fixed">
                    <tr class="trOdd">
                        ...
                        <td align="left" style="width: 115px; word-break:break-all">
                        ...
                        <td align="left" style="width: 15%; word-break:break-all">
                    ...
                    <tr class="trOdd">
                        ...
                        <td align="left" colspan="5"><%--<td align="left" colspan="7">--%>
