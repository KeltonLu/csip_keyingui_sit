<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010105020001.aspx.cs" Inherits="Page_P010105020001" %>

<%@ Register Assembly="Framework.WebControls" Namespace="Framework.WebControls" TagPrefix="cc1" %>
<%@ Register Src="~/Common/Controls/CustUpdateProgress.ascx" TagName="image" TagPrefix="cust" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" >
    <%-- 20201123_Ares_Stanley-修正格式; 20210303_Ares_Stanley-調整版面; 20210329_Ares_Stanley-調整半形轉全形失效; 20210401_Ares_Stanley-調整下拉選單文字顯示; 20210408_Ares_Stanley-調整半形轉全形失效; 20210415_Ares_Stanley-調整全半形轉換; 20210902_Ares_Stanley:移除Email前30後19長度限制, 改為總長度50 --%>
                        ...
                        <td colspan="9">
                            <li>
                                <cc1:CustLabel ID="lblTitle" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    ...
                                    SetOmit="False" StickHeight="False" Width="397px" IsColon="False" ShowID="01_01050200_001"></cc1:CustLabel>
                            </li>
                        </td>
                    </tr>
                    <%--總公司/總店統編--%>
                ...
                <cc1:CustPanel ID="pnlText" runat="server" Width="100%">
                    <table width="100%" border="0" cellpadding="0" cellspacing="1" id="tabNo4" style="">
                        ...
                        <tr class="trEven">
                            ...
                            <td align="left" style="width: 10%">
                                <cc1:CustTextBox ID="txtPrincipalNameCH" runat="server" MaxLength="19"  onblur="changeFullType(this);"
                        ...
                        <tr class="trEven">
                            ...
                            <td align="left" style="width: 10%">
                                <cc1:CustTextBox ID="txtPrincipalIssuePlace" runat="server"  onblur="changeFullType(this);"
                                    onkeydown="entersubmit('btnAdd');" Width="60px" BoxName="發證地點" MaxLength="3"></cc1:CustTextBox>
                            </td>
                            <%--領補換類別--%>
                            <td align="right" style="width: 10%">
                        ...
                        <tr class="trEven">
                           ...
                           <tr class="trOdd">
                            <td >
                             ...
                             <td colspan="10" >
                                    <cc1:CustCheckBox ID="CustChK01" runat="server"
                            ...
                            <td align="left" style="width: 10%" colspan="4">
                                <div style="position: relative">
                                    ...
                                    <cc1:CustTextBox ID="txtSCCDIsSanctionCountryCode2" runat="server" MaxLength="2" Width="50px" onfocus="allselect(this);" 
                                        ...
                                        Style="left: 70px; top: 0px; position: absolute; width: 32px; height: 11px; line-height:11px;"></cc1:CustTextBox>
                                    <cc1:CustDropDownList ID="dropSCCDIsSanctionCountryCode2" kind="select" runat="server" onclick="simOptionClick4IE('txtSCCDIsSanctionCountryCode2');" 
                                        Style="left: 70px; top: 0px; clip: rect(0px auto auto 40px); position: absolute; width: 60px;"></cc1:CustDropDownList>
                                    <cc1:CustTextBox ID="txtSCCDIsSanctionCountryCode3" runat="server" MaxLength="2" Width="50px" onfocus="allselect(this);" 
                                        ...
                                        Style="left: 140px; top: 0px; position: absolute; width: 32px; height: 11px; line-height:11px;"></cc1:CustTextBox>
                                    <cc1:CustDropDownList ID="dropSCCDIsSanctionCountryCode3" kind="select" runat="server" onclick="simOptionClick4IE('txtSCCDIsSanctionCountryCode3');" 
                                        Style="left: 140px; top: 0px; clip: rect(0px auto auto 40px); position: absolute; width: 60px;"></cc1:CustDropDownList>
                                    <cc1:CustTextBox ID="txtSCCDIsSanctionCountryCode4" runat="server" MaxLength="2" Width="50px" onfocus="allselect(this);" 
                                        ...
                                        Style="left: 210px; top: 0px; position: absolute; width: 32px; height: 11px; line-height:11px;"></cc1:CustTextBox>
                                    <cc1:CustDropDownList ID="dropSCCDIsSanctionCountryCode4" kind="select" runat="server" onclick="simOptionClick4IE('txtSCCDIsSanctionCountryCode4');" 
                                        Style="left: 210px; top: 0px; clip: rect(0px auto auto 40px); position: absolute; width: 60px;"></cc1:CustDropDownList>
                                    <cc1:CustTextBox ID="txtSCCDIsSanctionCountryCode5" runat="server" MaxLength="2" Width="50px" onfocus="allselect(this);" 
                                        ...
                                        Style="left: 280px; top: 0px; position: absolute; width: 32px; height: 11px; line-height:11px;"></cc1:CustTextBox>
                                    <cc1:CustDropDownList ID="dropSCCDIsSanctionCountryCode5" kind="select" runat="server" onclick="simOptionClick4IE('txtSCCDIsSanctionCountryCode5');" 
                                        Style="left: 280px; top: 0px; clip: rect(0px auto auto 40px); position: absolute; width: 60px;"></cc1:CustDropDownList>
                                </div>
                            </td>
                        </tr>
                        <tr class="trOdd">
                          ...
                          <%--審核確認--%>
                           <tr class="trOdd">
                            <td >
                             ...
                             <td colspan="9" >
                                    <cc1:CustCheckBox ID="CustChK02" runat="server"
                                    AutoPostBack="false" BoxName="以上資料確認無誤" />
                        ...
                        <tr class="trEven">
                            ...
                            <td align="left" style="width: 33%">
                                ...
                                <cc1:CustLabel ID="lblName_L_1" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01040101_081" StickHeight="False" Width="80px"></cc1:CustLabel>
                                <cc1:CustTextBox ID="txtName_L_1" runat="server" MaxLength="50" Width="280px" checktype="fulltype"  
                                    onkeydown="entersubmit('btnAdd');"  onblur="changeFullType(this);" BoxName="姓名" AutoPostBack="true" OnTextChanged="TextBox_TextChanged" ></cc1:CustTextBox><br />
                                <cc1:CustLabel ID="lblName_Pinyin_1" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01040101_082" StickHeight="False" Width="80px"></cc1:CustLabel>
                         ...
                         <%--審核確認--%>
                           <tr class="trOdd">
                            <td >
                             ...
                             <td colspan="8" >
                                    <cc1:CustCheckBox ID="CustChK03" runat="server"
                                    AutoPostBack="false" BoxName="以上資料確認無誤" />
