...
//20160622 (U) by Tank, eR3270.FUNCTION_CODE由收件編號第二碼判斷新增(K) or 修改(C)

public partial class P010401020001 : PageBase
{
    #region Variable
    private EntityAGENT_INFO eAgentInfo;
    private EntityRedeemSet gpeRS;
    ...
    {
        //*查詢資料檔 L_BATCH_LOG
        string strStartDate = BRL_BATCH_LOG.GetRunningFor2Key("01", "R", "BatchJob_LGOR");

        if ("" != strStartDate)
        {
            EntitySet<EntityRedeem3270> esR3270Count = new EntitySet<EntityRedeem3270>();
            esR3270Count = BRRedeem3270.GetSendData();
            string strAlertMsg = @"『Redeem 點數折抵參數設定 批次上傳主機中 , 請稍後再進行二 KEY 作業 , \r\n 批次上傳起始時間 : " +
                            DateTime.Parse(strStartDate).ToString("HH:mm:ss") +
                            @" \r\n 預估作業時間 : " + ((int)(esR3270Count.Count * 3 / 60)).ToString() + " 分鐘』";
    ...
    protected void btnSelect_Click(object sender, EventArgs e)
    {
        ...
        {
            if (esRS_2Key.GetEntity(0).ISSAME == "Y")
            {
                if (esRS_2Key.GetEntity(0).SEND3270 == "Y")
                {
            ...
            base.strClientMsg = MessageHelper.GetMessage("01_00000000_041");
        }
        else
        {
            setDefaultValue();
    ...
    protected void btnAdd_Click(object sender, EventArgs e)
    {
        ...
        if (esRS_2Key.Count > 0)
        {
            if (BRRedeemSet.UpdateKey2(txtReceiveNumber.Text.Trim(), RedeemSetCreate("N", iDiffCoutn), RedeemSet_ATypeSetCreate(), Redeem3270CreateAll(Redeem3270Create())))
            {
                if (iDiffCoutn == 0)
                {
                    isEnableAll(false);
            ...
            else
            {
                if (iDiffCoutn == 0)
                {
                    base.strClientMsg += MessageHelper.GetMessage("01_00000000_044");
                }
            }
        }
        else
        {
            if (BRRedeemSet.InsertKey2(RedeemSetCreate("N", iDiffCoutn), RedeemSet_ATypeSetCreate(), Redeem3270CreateAll(Redeem3270Create())))
            {
                if (iDiffCoutn == 0)
                {
                    isEnableAll(false);
    ...
    private void SetATypeSetColor()
    {
        int iObjCount = 0;
        BRCardTypeList_Redeem.Select(1, 1, "", ref iObjCount);
        for (int i = 0; i < iObjCount; i++)
        {
            CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_AT1.FindControl("tb_AType" + i.ToString()), Color.White);
            CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_AT2.FindControl("tb_AType" + i.ToString()), Color.White);
            CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_AT3.FindControl("tb_AType" + i.ToString()), Color.White);

            CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_USEREXITAT1.FindControl("tb_AType" + i.ToString()), Color.White);
            CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_USEREXITAT2.FindControl("tb_AType" + i.ToString()), Color.White);
            CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_USEREXITAT3.FindControl("tb_AType" + i.ToString()), Color.White);

            CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_BIRTH1.FindControl("tb_AType" + i.ToString()), Color.White);
            CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_BIRTH2.FindControl("tb_AType" + i.ToString()), Color.White);
            CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_BIRTH3.FindControl("tb_AType" + i.ToString()), Color.White);
        }

        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_AT1.FindControl("tbTBBLimit_INT"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_AT1.FindControl("tbTBBLimit_DEC"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_AT1.FindControl("tbTBBPoints"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_AT1.FindControl("tbTBBAmount"), Color.White);

        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_AT2.FindControl("tbTBBLimit_INT"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_AT2.FindControl("tbTBBLimit_DEC"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_AT2.FindControl("tbTBBPoints"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_AT2.FindControl("tbTBBAmount"), Color.White);

        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_AT3.FindControl("tbTBBLimit_INT"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_AT3.FindControl("tbTBBLimit_DEC"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_AT3.FindControl("tbTBBPoints"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_AT3.FindControl("tbTBBAmount"), Color.White);

        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_USEREXITAT1.FindControl("tbTBBLimit_INT"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_USEREXITAT1.FindControl("tbTBBLimit_DEC"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_USEREXITAT1.FindControl("tbTBBPoints"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_USEREXITAT1.FindControl("tbTBBAmount"), Color.White);

        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_USEREXITAT2.FindControl("tbTBBLimit_INT"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_USEREXITAT2.FindControl("tbTBBLimit_DEC"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_USEREXITAT2.FindControl("tbTBBPoints"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_USEREXITAT2.FindControl("tbTBBAmount"), Color.White);

        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_USEREXITAT3.FindControl("tbTBBLimit_INT"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_USEREXITAT3.FindControl("tbTBBLimit_DEC"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_USEREXITAT3.FindControl("tbTBBPoints"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_USEREXITAT3.FindControl("tbTBBAmount"), Color.White);

        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_BIRTH1.FindControl("tbTBBLimit_INT"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_BIRTH1.FindControl("tbTBBLimit_DEC"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_BIRTH1.FindControl("tbTBBPoints"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_BIRTH1.FindControl("tbTBBAmount"), Color.White);

        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_BIRTH2.FindControl("tbTBBLimit_INT"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_BIRTH2.FindControl("tbTBBLimit_DEC"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_BIRTH2.FindControl("tbTBBPoints"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_BIRTH2.FindControl("tbTBBAmount"), Color.White);

        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_BIRTH3.FindControl("tbTBBLimit_INT"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_BIRTH3.FindControl("tbTBBLimit_DEC"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_BIRTH3.FindControl("tbTBBPoints"), Color.White);
        CommonFunction.SetCustTextBoxBKColor((CustTextBox)atl_BIRTH3.FindControl("tbTBBAmount"), Color.White);
    ...
    private EntityRedeemSet RedeemSetCreate(string strSend3270, int iDiffCount)
    {
        EntityRedeemSet eRS = new EntityRedeemSet();
        EntityRedeemSet eRS1Key = (EntityRedeemSet)ViewState["EntityRedeemSet"];
        ...
        eRS.ReceiveDate = eRS1Key.ReceiveDate;
        eRS.ReceiveTime = eRS1Key.ReceiveTime;
    ...
    private EntitySet<EntityRedeem3270> Redeem3270Create()
    {
        ...
        // 設定電文基本資料
        eR3270.RECEIVE_NUMBER = eRS.RECEIVE_NUMBER;
        eR3270.USER_ID = ((EntityAGENT_INFO)Session["Agent"]).agent_id;

        //20160622 (U) by Tank, eR3270.FUNCTION_CODE由收件編號第二碼判斷新增(K) or 修改(C)
        //eR3270.FUNCTION_CODE = "A";
        string strFunType = txtReceiveNumber.Text.Trim().Substring(1,1);
        if (strFunType == "K")
        {
            eR3270.FUNCTION_CODE = "A";
        }
        ...
        eR3270.CHPOINT = "";
        eR3270.CHAMT = "";
        eR3270.USER_EXIT = "00"; //若有促銷活動 OR 生日活動 , 此欄位會在下方被 reset
        eR3270.CYLCO = "";
        eR3270.STARTU = "";
        eR3270.ENDU = "";
        eR3270.LIMITU = "";
        ...
        if (eRS.LONG_IS_ALLTYPE=="Y")
        {
            dsL = BRRedeemSet_ATypeSet.Select3270_CTAll(txtReceiveNumber.Text.Trim(), "L", "1");
        }
        else
        {
            dsL = BRRedeemSet_ATypeSet.Select3270_CT(txtReceiveNumber.Text.Trim(), "L", "1");
        }

        // 短期促銷
        DataSet dsU = new DataSet();
        if (eRS.USEREXIT_IS_ALLTYPE=="Y")
        {
            dsU = BRRedeemSet_ATypeSet.Select3270_CTAll(txtReceiveNumber.Text.Trim(), "U", "1");
        }
        else
        {
            dsU = BRRedeemSet_ATypeSet.Select3270_CT(txtReceiveNumber.Text.Trim(), "U", "1");
        }


        // 生日活動
        DataSet dsB = new DataSet();
        if (eRS.BIRTH_IS_ALLTYPE=="Y")
        {
            dsB = BRRedeemSet_ATypeSet.Select3270_CTAll(txtReceiveNumber.Text.Trim(), "B", "1");
        }
        else
        {
            dsB = BRRedeemSet_ATypeSet.Select3270_CT(txtReceiveNumber.Text.Trim(), "B", "1");
        }
        ...
        if (dtU.Rows.Count > 0)
        {
            for (int i = 0; i < dtU.Rows.Count; i++)
            {
                if ("Y" != dtU.Rows[i]["state"].ToString())
                {
                    ...
                    eR3270U.IN_CARD_TYPE = dtU.Rows[i]["CARD_TYPE"].ToString();
        ...
        if (dtB.Rows.Count > 0)
        {
            for (int i = 0; i < dtB.Rows.Count; i++)
            {
                if ("Y" != dtB.Rows[i]["state"].ToString())
                {
                    ...
                    eR3270B.IN_CARD_TYPE = dtB.Rows[i]["CARD_TYPE"].ToString();
