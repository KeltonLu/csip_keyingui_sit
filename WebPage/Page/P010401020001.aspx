<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010401020001.aspx.cs" Inherits="P010401020001" %>
    ...
    <script language="javascript" type="text/javascript">
        function checkInputText(id,intType)
        {
            //*檢核輸入欄位【收件編號】是否為空             if(document.getElementById('txtReceiveNumber').value.Trim() == "")
            {
                ...
                return false;
            }                        //*檢核輸入欄位【收件編號】前兩碼需為 RK            //20160622 (U) by Tank, 允許RC 修改            if (document.getElementById("txtReceiveNumber").value.Trim().substring(0,2).toUpperCase() != "RK" && document.getElementById("txtReceiveNumber").value.Trim().substring(0,2).toUpperCase() != "RC")
            {
                alert("收件編號格式不對！");
                document.getElementById('txtReceiveNumber').focus();
            ...
            {                
                ...
                if (!("00" == valueS || "01" == valueS || "02" == valueS || "03" == valueS || "04" == valueS))
                {
                    alert('類型只能輸入00、01、02、03、04');
                ...
                if (!("00" == valueB || "01" == valueB || "02" == valueB || "03" == valueB || "04" == valueB))
                {
                    alert('類型只能輸入00、01、02、03、04');
                ...
                if ("text" == objinput[i].type)
                {
                    if ("U" == strType.toUpperCase())
                    {
                        if ("atl_USEREXITAT" == objinput[i].id.substring(0,14))
                        {
                            ...
                            {
                                if ("atl_USEREXITAT1" == objinput[i].id.substring(0,15))
                                {
                    ...
                    if ("B" == strType.toUpperCase())
                    {
                        if ("atl_BIRTH" == objinput[i].id.substring(0,9))
                        {
                            ...
                            {
                                if ("atl_BIRTH1" == objinput[i].id.substring(0,10))
                                {
                                    objinput[i].disabled = false;
                                }
                            }
                            ...
                            <td colspan="3">
                                <li>
                                    <cc1:CustLabel ID="lblTitle" runat="server" CurAlign="left" CurSymbol="￡" FractionalDigit="2"
                                        ...
                                        SetOmit="False" StickHeight="False" Width="200px" IsColon="False" ShowID="01_01050102_001"></cc1:CustLabel></li>
                            </td>
                        </tr>
                        <tr class="trOdd">
                    ...
                    <cc1:CustPanel ID="pnlText" runat="server" Width="100%">
                        <table width="100%" border="0" cellpadding="0" cellspacing="1" id="Table1" style="">
                            ...
                            <tr class="trEven">
                                ...
                                <td>
                                    <cc1:CustTextBox ID="txtMERCHANTNO1" runat="server" MaxLength="9"  onfocus="allselect(this);" checktype="num"
                                        Width="100px"></cc1:CustTextBox>
                                </td>
                                <td>
                                    <cc1:CustTextBox ID="txtMERCHANTNO2" runat="server" MaxLength="9"  onfocus="allselect(this);" checktype="num"
                                        Width="100px"></cc1:CustTextBox>
                                </td>
                                <td>
                                    <cc1:CustTextBox ID="txtMERCHANTNO3" runat="server" MaxLength="9"  onfocus="allselect(this);" checktype="num"
                                        Width="100px"></cc1:CustTextBox>
                                </td>
                                <td>
                                    <cc1:CustTextBox ID="txtMERCHANTNO4" runat="server" MaxLength="9"  onfocus="allselect(this);" checktype="num"
                                        Width="100px"></cc1:CustTextBox>
                                </td>
                                <td>
                                    <cc1:CustTextBox ID="txtMERCHANTNO5" runat="server" MaxLength="9"  onfocus="allselect(this);" checktype="num"
                                        Width="100px"></cc1:CustTextBox>
                                </td>
                            </tr>
                            <tr class="trOdd">
                                ...
                                <td>
                                    <cc1:CustTextBox ID="txtMERCHANTNO6" runat="server" MaxLength="9"  onfocus="allselect(this);" checktype="num"
                                        Width="100px"></cc1:CustTextBox>
                                </td>
                                <td>
                                    <cc1:CustTextBox ID="txtMERCHANTNO7" runat="server" MaxLength="9"  onfocus="allselect(this);" checktype="num"
                                        Width="100px"></cc1:CustTextBox>
                                </td>
                                <td>
                                    <cc1:CustTextBox ID="txtMERCHANTNO8" runat="server" MaxLength="9"  onfocus="allselect(this);" checktype="num"
                                        Width="100px"></cc1:CustTextBox>
                                </td>
                                <td>
                                    <cc1:CustTextBox ID="txtMERCHANTNO9" runat="server" MaxLength="9"  onfocus="allselect(this);" checktype="num"
                                        Width="100px"></cc1:CustTextBox>
                                </td>
                                <td>
                                    <cc1:CustTextBox ID="txtMERCHANTNO10" runat="server" MaxLength="9"  onfocus="allselect(this);" checktype="num"
                                        Width="100px"></cc1:CustTextBox>
                                </td>
                            </tr>
                            <tr class="trEven">
                            ...
                            <tr class="trOdd">
                                ...
                                <td>
                                    <cc1:CustTextBox ID="txtPRODCODE" runat="server" MaxLength="2"  onfocus="allselect(this);" checktype="num" Width="60px"></cc1:CustTextBox>
                                </td>
                                <td colspan="4">
                            ...
                            <tr class="trEven">
                                ...
                                <td colspan="5">
                                    <cc1:CustTextBox ID="txtPROGRAM" runat="server" MaxLength="5"  onfocus="allselect(this);" checktype="num" Width="80px"></cc1:CustTextBox>
                                </td>
                            </tr>
                            <tr class="trOdd">
                                <td>
                            ...
                            <tr class="trOdd">
                                ...
                                <td colspan="5">
                                    <cc1:CustTextBox ID="txtMERCHANT_INT" runat="server" MaxLength="3"  onfocus="allselect(this);" checktype="num"
                                    ...
                                    <cc1:CustTextBox ID="txtMERCHANT_DEC" runat="server" MaxLength="2"  onfocus="allselect(this);" checktype="num"
                                        Width="40px"></cc1:CustTextBox>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="1" id="Table3" style="">
                            ...
                            <tr class="trOdd">
                                <td align="right" style="width: 15%">
                                    <cc1:CustTextBox ID="txtUSEREXIT_Type" runat="server" MaxLength="2"  onfocus="allselect(this);" checktype="num"
                            ...
                            <tr class="trOdd">
                                ...
                                <td colspan="2">
                                    <cc1:CustLabel ID="lbUSEREXIT_Type04" runat="server" CurAlign="left" CurSymbol="￡"
                                        FractionalDigit="2" IsColon="False" IsCurrency="False" NeedDateFormat="False"
                                        NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01050101_043"
                                        StickHeight="False"></cc1:CustLabel>
                                </td>
                            </tr>                            
                            <tr class="trEven">
                                ...
                                <td colspan="2">
                                    <cc1:CustTextBox ID="txtUSEREXIT_DateS" runat="server" MaxLength="8"  onfocus="allselect(this);" checktype="num"
                                    ...
                                    <cc1:CustLabel ID="lbUSEREXIT_Date1" runat="server" CurAlign="left" CurSymbol="￡"
                                        ...
                                        StickHeight="False"></cc1:CustLabel>
                                    <cc1:CustTextBox ID="txtUSEREXIT_DateE" runat="server" MaxLength="8"  onfocus="allselect(this);" checktype="num"
                                        Width="80px"></cc1:CustTextBox>
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="1" id="Table4" style="">
                            <tr class="trEven">
                                <td colspan="3">
                                    <cc1:CustLabel ID="lbUSEREXIT_OAOS" runat="server" CurAlign="left" CurSymbol="￡"
                                        ...
                                        StickHeight="False"></cc1:CustLabel>
                                    <cc1:CustTextBox ID="txtUSEREXIT_OAOS" runat="server"  onfocus="allselect(this);" checktype="numandletter" MaxLength="6"
                            ...
                            <tr class="trOdd">
                                <td align="right" style="width: 15%">
                                    <cc1:CustTextBox ID="txtBIRTH_Type" runat="server" MaxLength="2"  onfocus="allselect(this);" checktype="num"
                            ...
                            <tr class="trOdd">
                                ...
                                <td colspan="2">
                                    <cc1:CustLabel ID="lbBIRTH_Type04" runat="server" CurAlign="left" CurSymbol="￡" FractionalDigit="2"
                                        IsColon="False" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01050101_043" StickHeight="False"></cc1:CustLabel>
                                </td>
                            </tr>                            
                            <tr class="trEven">
                                <td align="right">
                                ...
                                <td colspan="2">
                                    <cc1:CustTextBox ID="txtBIRTH_DateS" runat="server" MaxLength="8"  onfocus="allselect(this);" checktype="num"
                                        Width="80px"></cc1:CustTextBox>
                                    ...
                                    <cc1:CustTextBox ID="txtBIRTH_DateE" runat="server" MaxLength="8"  onfocus="allselect(this);" checktype="num"
                                        Width="80px"></cc1:CustTextBox>
