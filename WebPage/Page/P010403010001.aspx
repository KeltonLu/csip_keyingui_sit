<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010403010001.aspx.cs" Inherits="P010403010001" %>
    ...
    <script language="javascript" type="text/javascript">
        function checkInputText(id,intType)
        {
            ...
            //*檢核輸入欄位【收件編號】是否為空             if(sReceiveNumber == "")
            {
                ...
                alert('請輸入收件編號');
                return false;
            }else{                //*檢核輸入欄位【收件編號】前兩碼需為 RK                if (sReceiveNumber.substring(0,2).toUpperCase() != "AK")
                {
                    alert("收件編號格式不對！");
                    document.getElementById('txtReceiveNumber').focus();
                    return false;
                }                            if (checkDateSn(sReceiveNumber.substring(2,9))==-2)
                {
                    alert("收件編號格式不對！");
                    document.getElementById('txtReceiveNumber').focus();
                    return false;
            ...
            if(1 == intType)
            {
                if(!checkInputType(id))
                {
            		...
            		var sORG = document.getElementById('txtORG').value.Trim();
            		var sPROGRAMNO = document.getElementById('txtPROGRAMNO').value.Trim();
            		var sPARTNERNO = document.getElementById('txtPARTNERNO').value.Trim();            
            		
            		if(sORG=="" || sORG.length<3){
            		    document.getElementById('txtORG').focus();
            		    alert('【ORG】欄位輸入錯誤，或者未填！');
            		    return false;
            		}
            		
            		if(sPROGRAMNO=="" || sPROGRAMNO.length<5){
            		    document.getElementById('txtPROGRAMNO').focus();
            		    alert('【PROGRAM-NO】欄位輸入錯誤，或者未填！');
            		    return false;
            		}
            		
            		if(sPARTNERNO=="" || sPARTNERNO.length<9){
            		    document.getElementById('txtPARTNERNO').focus();
            		    alert('【PARTNER-NO】欄位輸入錯誤，或者未填！');
            		    return false;
            		}
                ...
                var valueAdd = document.getElementById('txtTCCODE_Add').value.Trim();
             		if(valueAdd=="" || valueAdd.length<2){
            		    document.getElementById('txtTCCODE_Add').focus();
            		    alert('【加項】欄位輸入錯誤，或者未填！');
            		    return false;
            		}else if (valueAdd != "40" && valueAdd != "41"){
                    if (!confirm("加項值不為40/41，請確認是否確定？"))
                    {
                        document.getElementById('txtTCCODE_Add').focus();
                        return false;
                    }
                ...
                var valueMinus = document.getElementById('txtTCCODE_Minus').value.Trim();

             		if(valueMinus=="" || valueMinus.length<2){
            		    document.getElementById('txtTCCODE_Minus').focus();
            		    alert('【減項】欄位輸入錯誤，或者未填！');
            		    return false;
            		}else if (valueMinus != "40" && valueMinus != "41"){
                    if (!confirm("減項值不為40/41，請確認是否確定？"))
                    {
                        document.getElementById('txtTCCODE_Minus').focus();
                        return false;
                    }
                ...
                var MMCCODE_E="";
                for (i=1; i<=10; i++){
            				MMCCODE_B=document.getElementById("txtMMCCODE_" + i + "_B").value.Trim();
            				MMCCODE_E=document.getElementById("txtMMCCODE_" + i + "_E").value.Trim();
             				if(MMCCODE_B!=""){
             					  if(MMCCODE_B.length<4){
            				    		document.getElementById("txtMMCCODE_" + i + "_B").focus();
            				    		alert('【MCC CODE】欄位輸入錯誤！');
            				    		return false;
            				    }
            				} 
             				if(MMCCODE_E!=""){
             					  if(MMCCODE_E.length<4){
            				    		document.getElementById("txtMMCCODE_" + i + "_E").focus();
            				    		alert('【MCC CODE】欄位輸入錯誤！');
            				    		return false;
            				    }
            				}            				           				
        ...
        function checkUserControl(idTitle)
        {
            ...
            for (i=0; i<len; i++)
            {
                if ("text" == objinput[i].type && !objinput[i].disabled)
                {
                    ...
                    {
                        objValue = objinput[i].value.Trim();
                        if (objValue != ""){
                            isNull = false;
                            if(objValue.length >3){  
                            		alert('【ACCUMULATION TYPE】欄位不可輸入小於３碼的值！');   
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="1" id="tabNo1" style="">
                        ...
                        <tr class="trOdd">
                            ...
                            <td style="width: 50%" align="right">
                                <cc1:CustLabel ID="lblReDate1" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_04040100_003" StickHeight="False"></cc1:CustLabel>
                                <cc1:CustTextBox ID="txtReceiveDate" runat="server" MaxLength="8" checktype="num"
                                    Width="85px"></cc1:CustTextBox>
                                <cc1:CustLabel ID="lblReDate2" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_04040100_004" StickHeight="False"></cc1:CustLabel>
                                <cc1:CustTextBox ID="txtReceiveTime" runat="server" MaxLength="4" checktype="num"
                                    Width="45px"></cc1:CustTextBox>
                                <cc1:CustLabel ID="lblReDate3" runat="server" CurSymbol="£" ShowID="01_04040100_005"></cc1:CustLabel>
                            </td>                                      
                        </tr>
                    </table>
                            ...
                            <tr style="background-color: #006666">
                                <td align="center" valign="middle">
                                    <table width="80%" border="0" cellpadding="0" cellspacing="1" id="Table4">
                                        ...
                                        <tr class="trOdd">
                                            <td align="center">
                                                <cc1:CustTextBox ID="MainCardAMT1" runat="server" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                            <td align="center">
                                        ...
                                        <tr class="trEven">
                                            <td align="center">
                                                <cc1:CustTextBox ID="MainCardAMT2" runat="server" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                            <td align="center">
                                        ...
                                        <tr class="trOdd">
                                            <td align="center">
                                                <cc1:CustTextBox ID="MainCardAMT3" runat="server" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                            <td align="center">
                                        ...
                                        <tr class="trEven">
                                            <td align="center">
                                                <cc1:CustTextBox ID="MainCardAMT4" runat="server" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                            <td align="center">
                                ...
                                <td align="center" valign="middle">
                                    <table width="80%" border="0" cellpadding="0" cellspacing="1" id="Table5">
                                        ...
                                        <tr class="trOdd">
                                            <td align="center">
                                                <cc1:CustTextBox ID="SUPPCardAMT1" runat="server" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                            <td align="center">
                                                <cc1:CustTextBox ID="SUPPCardRATE1" runat="server" checktype="num" MaxLength="4"
                                                    Width="40px"></cc1:CustTextBox></td>
                                        </tr>
                                        <tr class="trEven">
                                            <td align="center">
                                                <cc1:CustTextBox ID="SUPPCardAMT2" runat="server" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                            <td align="center">
                                                <cc1:CustTextBox ID="SUPPCardRATE2" runat="server" checktype="num" MaxLength="4"
                                                    Width="40px"></cc1:CustTextBox></td>
                                        </tr>
                                        <tr class="trOdd">
                                            <td align="center">
                                                <cc1:CustTextBox ID="SUPPCardAMT3" runat="server" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                            <td align="center">
                                                <cc1:CustTextBox ID="SUPPCardRATE3" runat="server" checktype="num" MaxLength="4"
                                                    Width="40px"></cc1:CustTextBox></td>
                                        </tr>
                                        <tr class="trEven">
                                            <td align="center">
                                                <cc1:CustTextBox ID="SUPPCardAMT4" runat="server" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                            <td align="center">
                                                <cc1:CustTextBox ID="SUPPCardRATE4" runat="server" checktype="num" MaxLength="4"
                                                    Width="40px"></cc1:CustTextBox></td>
                                        </tr>
                                    </table>
                                </td>
                                        ...
                                        <tr>
                                            <td style="width: 50%" align="center">
                                                <table width="80%" border="0" cellpadding="0" cellspacing="1" id="Table7">
                                                    ...
                                                    <tr class="trOdd">
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="USEREXITAMT1" runat="server" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="USEREXITRATE1" runat="server" checktype="num" MaxLength="4"
                                                                Width="40px"></cc1:CustTextBox></td>
                                                    </tr>
                                                    <tr class="trEven">
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="USEREXITAMT2" runat="server" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="USEREXITRATE2" runat="server" checktype="num" MaxLength="4"
                                                                Width="40px"></cc1:CustTextBox></td>
                                                    </tr>
                                                    <tr class="trOdd">
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="USEREXITAMT3" runat="server" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="USEREXITRATE3" runat="server" checktype="num" MaxLength="4"
                                                                Width="40px"></cc1:CustTextBox></td>
                                                    </tr>
                                                    <tr class="trEven">
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="USEREXITAMT4" runat="server" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="USEREXITRATE4" runat="server" checktype="num" MaxLength="4"
                                                                Width="40px"></cc1:CustTextBox></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr>
                                            <td style="width: 50%" align="center">
                                                <table width="80%" border="0" cellpadding="0" cellspacing="1" id="Table8">
                                                    ...
                                                    <tr class="trOdd">
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="BIRTHAMT1" runat="server" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="BIRTHRATE1" runat="server" checktype="num" MaxLength="4" Width="40px"></cc1:CustTextBox></td>
                                                    </tr>
                                                    <tr class="trEven">
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="BIRTHAMT2" runat="server" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="BIRTHRATE2" runat="server" checktype="num" MaxLength="4" Width="40px"></cc1:CustTextBox></td>
                                                    </tr>
                                                    <tr class="trOdd">
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="BIRTHAMT3" runat="server" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="BIRTHRATE3" runat="server" checktype="num" MaxLength="4" Width="40px"></cc1:CustTextBox></td>
                                                    </tr>
                                                    <tr class="trEven">
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="BIRTHAMT4" runat="server" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="BIRTHRATE4" runat="server" checktype="num" MaxLength="4" Width="40px"></cc1:CustTextBox></td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td>
