<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010403020001.aspx.cs" Inherits="P010403020001" %>
    ...
    <script language="javascript" type="text/javascript">
        function checkInputText(id,intType)
        {
            ...
            if(1 == intType)
            {
                ...
                if(valueUEFrom!=""){
                  if (checkDateSn((parseFloat(valueUEFrom.substring(4,8))-1911).toString()+valueUEFrom.substring(0,4))==-2){
                        alert('活動時間起日錯誤！');
                ...
                if(valueUETo!=""){                
                	if (checkDateSn((parseFloat(valueUETo.substring(4,8))-1911).toString()+valueUETo.substring(0,4))==-2){
                	        alert('活動時間迄日錯誤！');
                ...
                if(valueBFrom!=""){                 
                	if (checkDateSn((parseFloat(valueBFrom.substring(4,8))-1911).toString()+valueBFrom.substring(0,4))==-2)
                	{
                	        alert('活動時間起日錯誤！');
                ...
                if(valueBTo!=""){
                	if (checkDateSn((parseFloat(valueBTo.substring(4,8))-1911).toString()+valueBTo.substring(0,4))==-2)
                	{
                	        alert('活動時間迄日錯誤！');
                            ...
                            <tr style="background-color: #438BE3">
                                <td align="center" valign="middle">
                                    <table width="80%" border="0" cellpadding="0" cellspacing="1" id="Table4">
                                        ...
                                        <tr class="trOdd">
                                            <td align="center">
                                                <cc1:CustTextBox ID="MainCardAMT1" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                            <td align="center">
                                        ...
                                        <tr class="trEven">
                                            <td align="center">
                                                <cc1:CustTextBox ID="MainCardAMT2" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                            <td align="center">
                                        ...
                                        <tr class="trOdd">
                                            <td align="center">
                                                <cc1:CustTextBox ID="MainCardAMT3" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                            <td align="center">
                                        ...
                                        <tr class="trEven">
                                            <td align="center">
                                                <cc1:CustTextBox ID="MainCardAMT4" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                            <td align="center">
                                ...
                                <td align="center" valign="middle">
                                    <table width="80%" border="0" cellpadding="0" cellspacing="1" id="Table5">
                                        ...
                                        <tr class="trOdd">
                                            <td align="center">
                                                <cc1:CustTextBox ID="SUPPCardAMT1" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                            <td align="center">
                                                <cc1:CustTextBox ID="SUPPCardRATE1" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="4"
                                                    Width="40px"></cc1:CustTextBox></td>
                                        </tr>
                                        <tr class="trEven">
                                            <td align="center">
                                                <cc1:CustTextBox ID="SUPPCardAMT2" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                            <td align="center">
                                                <cc1:CustTextBox ID="SUPPCardRATE2" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="4"
                                                    Width="40px"></cc1:CustTextBox></td>
                                        </tr>
                                        <tr class="trOdd">
                                            <td align="center">
                                                <cc1:CustTextBox ID="SUPPCardAMT3" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                            <td align="center">
                                                <cc1:CustTextBox ID="SUPPCardRATE3" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="4"
                                                    Width="40px"></cc1:CustTextBox></td>
                                        </tr>
                                        <tr class="trEven">
                                            <td align="center">
                                                <cc1:CustTextBox ID="SUPPCardAMT4" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                            <td align="center">
                                                <cc1:CustTextBox ID="SUPPCardRATE4" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="4"
                                                    Width="40px"></cc1:CustTextBox></td>
                                        </tr>
                                    </table>
                                </td>
                                        ...
                                        <tr>
                                            <td style="width: 50%" align="center">
                                                <table width="80%" border="0" cellpadding="0" cellspacing="1" id="Table7">
                                                    ...
                                                    <tr class="trOdd">
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="USEREXITAMT1" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="USEREXITRATE1" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="4"
                                                                Width="40px"></cc1:CustTextBox></td>
                                                    </tr>
                                                    <tr class="trEven">
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="USEREXITAMT2" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="USEREXITRATE2" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="4"
                                                                Width="40px"></cc1:CustTextBox></td>
                                                    </tr>
                                                    <tr class="trOdd">
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="USEREXITAMT3" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="USEREXITRATE3" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="4"
                                                                Width="40px"></cc1:CustTextBox></td>
                                                    </tr>
                                                    <tr class="trEven">
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="USEREXITAMT4" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="USEREXITRATE4" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="4"
                                                                Width="40px"></cc1:CustTextBox></td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr>
                                            <td style="width: 50%" align="center">
                                                <table width="80%" border="0" cellpadding="0" cellspacing="1" id="Table8">
                                                    ...
                                                    <tr class="trOdd">
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="BIRTHAMT1" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="BIRTHRATE1" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="4" Width="40px"></cc1:CustTextBox></td>
                                                    </tr>
                                                    <tr class="trEven">
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="BIRTHAMT2" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="BIRTHRATE2" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="4" Width="40px"></cc1:CustTextBox></td>
                                                    </tr>
                                                    <tr class="trOdd">
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="BIRTHAMT3" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="BIRTHRATE3" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="4" Width="40px"></cc1:CustTextBox></td>
                                                    </tr>
                                                    <tr class="trEven">
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="BIRTHAMT4" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="9" Width="90px"></cc1:CustTextBox></td>
                                                        <td align="center">
                                                            <cc1:CustTextBox ID="BIRTHRATE4" runat="server" onfocus="allselect(this);" checktype="num" MaxLength="4" Width="40px"></cc1:CustTextBox></td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td>
