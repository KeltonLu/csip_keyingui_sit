<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010101100001.aspx.cs" Inherits="P010101100001" %>

<%@ Register Assembly="Framework.WebControls" Namespace="Framework.WebControls" TagPrefix="cc1" %>
<%@ Register Src="~/Common/Controls/CustUpdateProgress.ascx" TagName="image" TagPrefix="cust"%>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <%-- 2020/11/19_Ares_Stanley-修正格式 --%>
                            ...
                            <td colspan="4">
                                <li>
                                    <cc1:CustLabel ID="lblTitle" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        ...
                                        SetOmit="False" StickHeight="False" Width="200px" IsColon="False" ShowID="01_01011000_001"></cc1:CustLabel></li>
                            </td>
                        </tr>
                        <tr class="trOdd">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblReceiveNumber" runat="server" CurAlign="left" CurSymbol="£"
                                    ...
                                    NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01011000_002"
                        ...
                        <tr class="trEven">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblUserId" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    ...
                                    SetBreak="False" SetOmit="False" ShowID="01_01011000_003" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 35%">
                                ...
                                <cc1:CustButton ID="btnSelect" CssClass="smallButton" runat="server" Width="40px"
                                    ...
                                    DisabledWhenSubmit="False" onkeydown="setfocuschoice('txtReceiveNumber','txtAccNoBank');" /></td>
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblUserName" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01011000_004" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 35%">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="1" id="tabNo2" style="">
                        ...
                        <tr class="trOdd">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblAccNoBank" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01011000_006" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 85%">
                                <div style="position: relative">
                                    ...
                                    <cc1:CustTextBox ID="txtAccNoBank" runat="server" MaxLength="30" checklength="3"
                                        onkeydown="entersubmit('btnSubmit');" onfocus="allselect(this);" Style="left: 0px; top: 0px; position: absolute;
                                        width: 125px; height: 11px;" BoxName="扣繳帳號"></cc1:CustTextBox>
                                </div>
                            </td>
                        </tr>
                        <tr class="trEven">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblAccNo" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01011000_007" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 85%">
                                <cc1:CustTextBox ID="txtAccNo" runat="server" Width="190px" checktype="num" MaxLength="26"
                                    onkeydown="entersubmit('btnSubmit');" onfocus="allselect(this);" BoxName="銀行帳號"></cc1:CustTextBox></td>
                        </tr>
                        <tr class="trOdd">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lnlPayWay" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01011000_008" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 85%">
                                <cc1:CustTextBox ID="txtPayWay" runat="server" Width="120px" checktype="num" MaxLength="1"
                                    onkeydown="entersubmit('btnSubmit');" onfocus="allselect(this);" BoxName="扣繳方式"></cc1:CustTextBox></td>
                        </tr>
                        <tr class="trEven">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblAccID" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01011000_009" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 85%">
                                <cc1:CustTextBox ID="txtAccID" runat="server" Width="130px" checktype="numandletter"
                                    MaxLength="18" onkeydown="keystoke('btnSubmit','txtBcycleCode');" onfocus="allselect(this);" BoxName="帳戶ID"></cc1:CustTextBox></td>
                        </tr>
                        <tr class="trOdd">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblBcycleCode" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01011000_010" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 85%; float:left;">
                               ...
                               <div style="position: absolute; margin-left:130px;">
                                    ...
                                    <cc1:CustTextBox ID="txtBcycleCode" runat="server" MaxLength="2" checktype="num"
                                        onkeydown="entersubmit('btnSubmit');" onfocus="allselect(this);" Style="left: 0px; top: 2px; position: absolute;
                                        width: 125px; height: 11px;" BoxName="帳單週期" Enabled="false"></cc1:CustTextBox>
                                </div>
                            </td>
                        </tr>
                        <tr class="trEven">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblMobilePhone" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01011000_011" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 85%">
                                <cc1:CustTextBox ID="txtMobilePhone" runat="server" Width="120px" checktype="num"
                                    MaxLength="10" onkeydown="entersubmit('btnSubmit');" onfocus="allselect(this);" BoxName="行動電話"></cc1:CustTextBox></td>
                        </tr>
                        <tr class="trOdd">
                            <td style="width: 15%" height="27" align="right">
                                <cc1:CustLabel ID="lblEmail" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01011000_012" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 85%">
                                <cc1:CustTextBox ID="txtEmail" runat="server" Width="360px" checktype="email" MaxLength="50"
                                    onkeydown="entersubmit('btnSubmit');" onfocus="allselect(this);" BoxName="E-MAIL" ReadOnly="true" BackColor="LightGray"></cc1:CustTextBox></td>
                        </tr>
                        <tr class="trEven">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblEBill" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01011000_013" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 85%">
                                <cc1:CustTextBox ID="txtEBill" runat="server" Width="70px" checktype="num" MaxLength="1"
                                    onkeydown="entersubmit('btnSubmit');" onfocus="allselect(this);" BoxName="電子帳單" ReadOnly="true" BackColor="LightGray"></cc1:CustTextBox>
                                &nbsp;
                            </td>
                        </tr>
                         ...
                         <tr class="trOdd">
                          <td style="width: 15%; height: 25px;" align="right">
                                <cc1:CustLabel ID="lblPopulNo" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01011000_015" StickHeight="False"></cc1:CustLabel>
                            </td>
                        ...
                        <td style="width: 15%; height: 25px;" align="right">
                                <cc1:CustLabel ID="lblPopulEmpNO" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01011000_016" StickHeight="False"></cc1:CustLabel>
                            </td>
                            <td style="width: 35%; height: 25px;">
                        ...
                        <td style="width: 15%; height: 25px;" align="right">
                                <cc1:CustLabel ID="lbCaseClass" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01011000_017" StickHeight="False"></cc1:CustLabel>
                            </td>
                        <td style="width: 35%; height: 25px;">
                                <div style="position: relative">
                                    ...
                                    <cc1:CustTextBox ID="txtCaseClass" runat="server" MaxLength="30" checktype=""
