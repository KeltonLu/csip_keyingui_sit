<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010106010001.aspx.cs" Inherits="P010106010001" %>
                        ...
                        <td colspan="2">
                            <li>
                                <cc1:CustLabel ID="lblTitle" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    ...
                                    SetOmit="False" StickHeight="False" Width="397px" IsColon="False" ShowID="01_01060100_001"></cc1:CustLabel></li>
                        </td>
                    </tr>
                    <tr class="trOdd">
                        <td align="right" style="width: 15%">
                            <cc1:CustLabel ID="lblPath" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                ...
                                SetBreak="False" SetOmit="False" ShowID="01_01060100_002" StickHeight="False"></cc1:CustLabel>
                        </td>
                        <td style="width: 85%">
                    ...
                    <tr class="itemTitle">
                        <td colspan="2" align="center">
                            <cc1:CustButton ID="btnInsert" runat="server" DisabledWhenSubmit="false" CssClass="smallButton"
                                ShowID="01_01060100_003" OnClick="btnInsert_Click" OnClientClick="return sumbit(1);"
