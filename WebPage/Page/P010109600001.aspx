<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010109600001.aspx.cs" Inherits="P010109600001" %>
                                ...
                                <tr class="trOdd">
                                    ...
                                    <td align="left" width="22%">
                                        <cc1:CustLabel ID="lbHQ_SCDD_NameCheck_Item" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                            IsColon="False" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                            SetBreak="False" SetOmit="False" StickHeight="False"></cc1:CustLabel>
                                        <cc1:CustLabel ID="lbHQ_SCDD_NameCheck_Note" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                            IsColon="False" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                            SetBreak="False" SetOmit="False" StickHeight="False"></cc1:CustLabel>
