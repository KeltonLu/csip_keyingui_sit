<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010104080001.aspx.cs" Inherits="P010104080001" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <%-- 2020/11/23_Ares_Stanley-修正radio選取無反應 --%>
        ...
        { 
               ...
               if(document.getElementById('txtShopNo').value.Trim() == "")
               {
                ...
                { 
                    ...
                    if(input != "J" && input != "M" && input != "N" && input != "V" && input != "Z")
                    {
                        alert('CARD-TYPE只能輸入J,M,N,V,Z');
                        return false;
                    }
