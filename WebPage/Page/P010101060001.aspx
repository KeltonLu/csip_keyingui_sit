<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010101060001.aspx.cs" Inherits="P010101060001" %>

<%@ Register Assembly="Framework.WebControls" Namespace="Framework.WebControls" TagPrefix="cc1" %>
<%@ Register Src="~/Common/Controls/CustUpdateProgress.ascx" TagName="image" TagPrefix="cust" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <%-- 2020/11/19_Ares_Stanley-修正格式; 2021/03/04_Ares_Stanley-調整版面; 2021/09/01_Ares_Stanley-調整TAB順序; 2021/09/24_Ares_Stanley-調整查詢按enter沒有反應; 2021/10/08_Ares_Stanley-EMAIL、電子帳單反灰不能修改 --%>
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        var flagChange=0;
   			function SetBcycleTextValue(){
						document.getElementById('txtBcycleCodeText').innerText = dropBcycleCode.options[dropBcycleCode.selectedIndex].innerText;
				}
       ...
       function   keypressbankC(id) 
        {  
             ...
             try
             {
                 ...
                 {
                   if( (document.getElementById("txtAccNoBankH").value.Trim()!=document.getElementById("txtAccNoBank").value.Trim() ))
                   {
                        document.getElementById("txtHiden").value=fid;
                        document.getElementById("txtAccNoBankH").value=document.getElementById("txtAccNoBank").value;
                   }
                            ...
                            <td colspan="4">
                                <li>
                                    <cc1:CustLabel ID="lblTitle" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        ...
                                        SetOmit="False" StickHeight="False" Width="200px" IsColon="False" ShowID="01_01010600_001"></cc1:CustLabel></li>
                            </td>
                        </tr>
                        <tr class="trOdd">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblReceiveNumber" runat="server" CurAlign="left" CurSymbol="£"
                                    ...
                                    NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01010600_002"
                        ...
                        <tr class="trEven">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblUserId" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    ...
                                    SetBreak="False" SetOmit="False" ShowID="01_01010600_003" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 35%">
                                ...
                                <cc1:CustButton ID="btnSelect" CssClass="smallButton" runat="server" Width="40px"
                                    ...
                                    ShowID="01_01010600_022" /></td>
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblUserName" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010600_004" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 35%">
                        ...
                        <tr class="trOdd">
                            <td style="width: 15%; height: 25px;" align="right">
                                <cc1:CustLabel ID="lblAccNoBank" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010600_005" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 35%; height: 25px;">
                                <div style="position: relative">
                                    ...
                                    <cc1:CustTextBox ID="txtAccNoBank" runat="server" MaxLength="30" checklength="3"
                                        onkeydown="keypressbank('btnHiden');" Style="left: 0px; top: 0px; position: absolute;
                                        width: 125px; height: 11px;" AutoPostBack="False" BoxName="銀行代號" onfocus="allselect(this);" TabIndex="1"></cc1:CustTextBox>
                                    <cc1:CustButton ID="btnBankCheck" CssClass="smallButton" runat="server" Style="left: 160px;
                                        top: 0px; position: absolute; width: 90px;" OnClick="btnBankCheck_Click" onkeydown="setfocuschoice('txtAccNo','txtAccNo'); "
                                        DisabledWhenSubmit="False" ShowID="01_01010600_026" />
                                    <cc1:CustTextBox ID="txtAccNoBankH" runat="server" MaxLength="30" CssClass="btnHiden"
                            ...
                            <td style="width: 15%; height: 25px;" align="right">
                                <cc1:CustLabel ID="CustLabel3" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010600_008" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 35%; height: 25px;">
                        ...
                        <tr class="trEven">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="CustLabel1" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010600_006" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 85%" colspan="3">
                        ...
                        <tr class="trOdd">
                            <td style="width: 15%; height: 25px;" align="right">
                                <cc1:CustLabel ID="CustLabel2" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010600_007" StickHeight="False"></cc1:CustLabel></td>
                        ...
                        <tr class="trEven">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lbPayWay" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010600_009" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 35%">
                                <cc1:CustTextBox ID="txtPayWay" runat="server" Width="120px" checktype="num" MaxLength="1"
                                    onkeydown="entersubmit('btnSubmit');" BoxName="扣繳方式" onfocus="allselect(this);" TabIndex="3"></cc1:CustTextBox></td>
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblAccID" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010600_024" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 35%">
                                <cc1:CustTextBox ID="txtAccID" runat="server" Width="130px" checktype="numandletter"
                                    MaxLength="18" onkeydown="setfocus('txtBcycleCode'); keystoke('btnSubmit','txtBcycleCode');" BoxName="帳戶ID"
                                    onfocus="allselect(this);" TabIndex="4"></cc1:CustTextBox></td>
                        </tr>
                        <tr class="trOdd">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblBcycleCode" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010600_011" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 35%; float:left; " valign="middle">
                                <cc1:CustTextBox ID="txtBcycleCodeText" runat="server" Width="120px" checktype="num"
                                    ...
                                    Enabled="false" BoxName="帳單週期" onfocus="allselect(this);" style="height:11px; margin-top:2px; position:absolute;"></cc1:CustTextBox>
                            ...
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="CustLabel4" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010600_012" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 35%">
                                <cc1:CustTextBox ID="txtMobilePhone" runat="server" Width="190px" checktype="num"
                                    MaxLength="10" onkeydown="entersubmit('btnSubmit');" BoxName="行動電話" onfocus="allselect(this);" TabIndex="6"></cc1:CustTextBox></td>
                        </tr>
                        <tr class="trEven">
                            <td align="right" class="auto-style1">
                                <cc1:CustLabel ID="lblEmail" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010600_013" StickHeight="False"></cc1:CustLabel></td>
                            <td width="35%" class="auto-style2">
                                <cc1:CustTextBox ID="txtEmail" runat="server" Width="335px" checktype="email" MaxLength="50"
                                    onkeydown="entersubmit('btnSubmit');" BoxName="E-MAIL" onfocus="allselect(this);" TabIndex="7" ReadOnly="true" BackColor="LightGray"></cc1:CustTextBox></td>
                            <td align="right" class="auto-style1">
                                <cc1:CustLabel ID="lblEBill" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010600_014" StickHeight="False"></cc1:CustLabel></td>
                            <td class="auto-style3">
                                <cc1:CustTextBox ID="txtEBill" runat="server" Width="70px" checktype="num" MaxLength="1"
                                    onkeydown="setfocus('txtApplyType'); keystoke('btnSubmit','txtApplyType');" BoxName="電子帳單" onfocus="allselect(this);" TabIndex="8" ReadOnly="true" BackColor="LightGray"></cc1:CustTextBox>
                                &nbsp;
                            </td>
                        </tr>
                        <tr class="trOdd">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="CustLabel5" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010600_016" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 35%">
                                <div style="position: relative">
                            ...
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="CustLabel6" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010600_017" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 35%">
                                <div style="position: relative">
                                    ...
                                    <cc1:CustTextBox ID="txtTranCode" runat="server" MaxLength="3" checktype="num" onkeydown="entersubmit('btnSubmit');"
                                        Style="left: -4px; top: 0px; position: absolute; width: 125px; height: 11px;"
                        ...
                        <tr class="trEven">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="CustLabel7" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010600_015" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 35%">
                            ...
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="CustLabel8" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010600_018" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 35%">
                        ...
                        <tr class="trOdd">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="CustLabel9" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010600_019" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 35%">
                            ...
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="CustLabel10" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010600_020" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 35%">
                        ...
                        <tr class="trEven">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="CustLabel11" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010600_021" StickHeight="False"></cc1:CustLabel></td>
                            <td colspan="3">
                        ...
                        <tr class="trOdd">
                            <td style="width: 15%; height: 25px;" align="right">
                                <cc1:CustLabel ID="lblPopulNo" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010600_027" StickHeight="False"></cc1:CustLabel>
                            </td>
                      <td colspan="3">
                        ...
                        <tr class="trEven">
                            <td style="width: 15%; height: 25px;" align="right">
                                <cc1:CustLabel ID="lblPopulEmpNO" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010600_028" StickHeight="False"></cc1:CustLabel>
                            </td>
                 <td colspan="3">
                        ...
                        <tr class="trOdd">
                            <td style="width: 15%; height: 25px;" align="right">
                                <cc1:CustLabel ID="lbCaseClass" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010600_029" StickHeight="False"></cc1:CustLabel>
                            </td>
                     <td colspan="3">
                                <div style="position: relative">
                                    <cc1:CustDropDownList ID="dropCaseClass" kind="select" runat="server" Style="left: 0px;
                                        top: 0px; clip: rect(0px auto auto 130px); position: relative; width: 205px;"
                                    ...
                                    <cc1:CustTextBox ID="txtCaseClass" runat="server" MaxLength="50" checktype="" onkeydown="entersubmit('btnSubmit');"
                                        Style="left: 0px; top: 0px; position: absolute; width: 180px; height: 11px;"
                        ...
                        <tr class="itemTitle1">
                            <td colspan="4" align="center">
                                ...
                                <cc1:CustButton ID="btnSubmit" CssClass="smallButton" Width="40px" runat="server"
                                    ...
                                    OnClick="btnSubmit_Click" DisabledWhenSubmit="False" ShowID="01_01010600_023" />
