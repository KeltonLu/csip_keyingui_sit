<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010104020101.aspx.cs" Inherits="P010104020101" %>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="1" id="tabNo4" style="">   
                    <tr class="trOdd">                           
                        ...
                        <td style="width: 33%" colspan="3">
                            <cc1:CustTextBox ID="txtCheckMan" runat="server" MaxLength="4" checktype="num"
                                Width="50px" onkeydown="entersubmit('btnAdd');" BoxName="徵信員" onfocus="allselect(this);"></cc1:CustTextBox>
                        </td>                         
                    </tr>
                    ...
                    <tr class="trEven">
                        ...
                        <td style="width: 11%">
                            <cc1:CustTextBox ID="txtEstablish" runat="server" MaxLength="5" checktype="numandletter"
                                Width="50px" onkeydown="entersubmit('btnAdd');" BoxName="設立" onfocus="allselect(this);"></cc1:CustTextBox>
                        </td>
                        ...
                        <td style="width: 11%">
                            <cc1:CustTextBox ID="txtCapital" runat="server" MaxLength="6" checktype="num" Width="70px"
                                onkeydown="entersubmit('btnAdd');" BoxName="資本" onfocus="allselect(this);"></cc1:CustTextBox>
                        ...
                        <td style="width: 11%">
                            <cc1:CustTextBox ID="txtOrganization" runat="server" MaxLength="1" checktype="numandletter"
                                Width="30px" onkeydown="entersubmit('btnAdd');" BoxName="組織" onfocus="allselect(this);"></cc1:CustTextBox>
                        </td>
                        ...
                        <td style="width: 11%">
                            <cc1:CustTextBox ID="txtRisk" runat="server" MaxLength="3" checktype="numandletter"
                                Width="50px" onkeydown="entersubmit('btnAdd');" BoxName="風險" onfocus="allselect(this);"></cc1:CustTextBox>
                        </td>
                    </tr>
                    ...
                    <tr class="trEven">
                        ...
                        <td style="width: 77%" colspan="7">
                            <cc1:CustTextBox ID="txtRegName" runat="server" MaxLength="19"
                                Width="260px"  onblur="changeFullType(this);" onkeydown="entersubmit('btnAdd');" BoxName="登記名稱" checktype="fulltype" onpaste="paste();" onfocus="allselect(this);"></cc1:CustTextBox>
                        </td>                         
                    </tr>
                    ...
                    <tr class="trOdd">
                        <td align="left" style="width: 11%" colspan="8">
                            <cc1:CustLabel ID="lblBusinessName" runat="server" CurAlign="left" CurSymbol="£"
                                FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01040201_009"
                                StickHeight="False"></cc1:CustLabel>
                        </td>                 
                    </tr>
                    ...
                    <tr class="trOdd">
                        <td align="left" style="width: 11%" colspan="8">
                            <cc1:CustLabel ID="lblRight" runat="server" CurAlign="left" CurSymbol="£"
                                FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01040201_059"
                                StickHeight="False"></cc1:CustLabel>
                            <cc1:CustTextBox ID="txtBusinessName" runat="server" MaxLength="19"  onblur="changeFullType(this);" onkeydown="entersubmit('btnAdd');"
                                Width="260px" BoxName="營業名稱" checktype="fulltype" onpaste="paste();" onfocus="allselect(this);"></cc1:CustTextBox>
                        </td>                 
                    </tr>
                    ...
                    <tr class="trOdd" >
                        <td align="right" style="width: 12%" rowspan="3">
                            <cc1:CustLabel ID="lblBossData" runat="server" CurAlign="left" CurSymbol="£"
                                FractionalDigit="2"  IsCurrency="False" NeedDateFormat="False"
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01040201_032"
                                StickHeight="False"></cc1:CustLabel>&nbsp;&nbsp;&nbsp;
                                <cc1:CustLabel ID="lblBossData1" runat="server" CurAlign="left" CurSymbol="£"
                                FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01040201_065"
                                StickHeight="False"></cc1:CustLabel>
                        </td>
                        ...
                        <td style="width: 11%">
                            <cc1:CustTextBox ID="txtBoss" runat="server" MaxLength="4" 
                                Width="70px"  onblur="changeFullType(this);" onkeydown="entersubmit('btnAdd');" BoxName="負責人姓名" checktype="fulltype" onpaste="paste();" onfocus="allselect(this);"></cc1:CustTextBox>
                        </td>
                        
                        <td align="right" style="width: 11%">
                            <cc1:CustLabel ID="lblBossID" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                SetBreak="False" SetOmit="False" ShowID="01_01040201_013" StickHeight="False"></cc1:CustLabel>
                        </td>
                        <td style="width: 11%">
                            <cc1:CustTextBox ID="txtBossID" runat="server" MaxLength="10" checktype="ID"
                                Width="100px" onkeydown="entersubmit('btnAdd');" BoxName="負責人ID" onfocus="allselect(this);"></cc1:CustTextBox>
                        </td>
                        <td align="right" style="width: 11%">
                        ...
                        <td style="width: 22%" colspan="3">
                            <cc1:CustTextBox ID="txtBossTel1" runat="server" MaxLength="3" checktype="num" Width="30px"
                                onkeydown="entersubmit('btnAdd');" BoxName="負責人電話一" onfocus="allselect(this);"></cc1:CustTextBox>
                            <cc1:CustTextBox ID="txtBossTel2" runat="server" MaxLength="8" checktype="num" Width="70px"
                                onkeydown="entersubmit('btnAdd');" BoxName="負責人電話二" onfocus="allselect(this);"></cc1:CustTextBox>
                            <cc1:CustTextBox ID="txtBossTel3" runat="server" MaxLength="5" checktype="num" Width="40px"
                                onkeydown="entersubmit('btnAdd');" BoxName="負責人電話三" onfocus="allselect(this);"></cc1:CustTextBox>
                        </td>                         
                    </tr>
                    ...
                    <tr class="trOdd">
                        <td align="right" style="width: 11%">
                            <cc1:CustLabel ID="lblBossChangeDate" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                ...
                                SetBreak="False" SetOmit="False" ShowID="01_01040201_032" StickHeight="False"></cc1:CustLabel>&nbsp;&nbsp;&nbsp;
                                <cc1:CustLabel ID="lblBossChangeDate1" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                 IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                SetBreak="False" SetOmit="False" ShowID="01_01040201_061" StickHeight="False"></cc1:CustLabel>
                        </td>
                        <td style="width: 11%">
                            <cc1:CustTextBox ID="txtBossChangeDate" runat="server" MaxLength="7" checktype="num" Width="50px"
                                onkeydown="entersubmit('btnAdd');" BoxName="負責人領換補日" onfocus="allselect(this);"></cc1:CustTextBox>
                        </td>
                        ...
                        <td style="width: 11%">
                            <cc1:CustTextBox ID="txtBossFlag" runat="server" MaxLength="1" checktype="numandletter" Width="20px"
                                onkeydown="entersubmit('btnAdd');" BoxName="代號" onfocus="allselect(this);"></cc1:CustTextBox>
                        </td>
                        
                        <td align="right" style="width: 11%">
                            <cc1:CustLabel ID="lblBossBirthday" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                SetBreak="False" SetOmit="False" ShowID="01_01040201_034" StickHeight="False"></cc1:CustLabel>
                        </td>
                        <td style="width: 11%">
                            <cc1:CustTextBox ID="txtBossBirthday" runat="server" MaxLength="7" checktype="num" Width="50px"
                                onkeydown="entersubmit('btnAdd');" BoxName="生日" onfocus="allselect(this);"></cc1:CustTextBox>
                        </td>
                        ...
                        <td style="width: 11%">
                            <cc1:CustTextBox ID="txtBossAt" runat="server" MaxLength="2"  Width="40px"
                                 onblur="changeFullType(this);" onkeydown="entersubmit('btnAdd');" BoxName="換證點" checktype="fulltype" onpaste="paste();" onfocus="allselect(this);"></cc1:CustTextBox>
                        </td>                          
                    </tr>
                    ...
                    <tr class="trOdd">
                        ...
                        <td style="width: 88%" colspan="8">
                            <cc1:CustTextBox ID="txtRegAddr1" runat="server"  onblur="changeFullType(this);" onkeydown="entersubmit('btnAdd');" MaxLength="6"
                                Width="100px" BoxName="戶籍地址一" checktype="fulltype" onpaste="paste();" onfocus="allselect(this);"></cc1:CustTextBox>
                            <cc1:CustTextBox ID="txtRegAddr2" runat="server"  onblur="changeFullType(this);" onkeydown="entersubmit('btnAdd');" MaxLength="14"
                                Width="220px" BoxName="戶籍地址二" checktype="fulltype" onpaste="paste();" onfocus="allselect(this);"></cc1:CustTextBox>
                            <cc1:CustTextBox ID="txtRegAddr3" runat="server"  onblur="changeFullType(this);" onkeydown="entersubmit('btnAdd');" MaxLength="7"
                                Width="100px" BoxName="戶籍地址二" checktype="fulltype" onpaste="paste();" onfocus="allselect(this);"></cc1:CustTextBox>
                        </td>                           
                    </tr>
                    ...
                    <tr class="trEven">
                        <td style="width: 11%" align="right">
                            <cc1:CustLabel ID="lblOperman1" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                     IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01040201_016" StickHeight="False"></cc1:CustLabel>&nbsp;&nbsp;
                    ...
                    <tr class="trEven">
                        <td style="width: 11%" align="right"> 
                            <cc1:CustLabel ID="lblOperChangeDate1" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                SetBreak="False" SetOmit="False" ShowID="01_01040201_037" StickHeight="False"></cc1:CustLabel>&nbsp;&nbsp;
                                     <cc1:CustLabel ID="lblOperChangeDate2" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                     IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01040201_061" StickHeight="False"></cc1:CustLabel>
                       </td>
                      <td style="width: 11%">  
                    ...
                    <tr class="trOdd" width="88%">
                        ...
                        <td style="width: 11%">
                            <cc1:CustTextBox ID="txtOperman" runat="server" MaxLength="4" Width="60px"  onblur="changeFullType(this);" onkeydown="entersubmit('btnAdd');" BoxName="實際經營者姓名" checktype="fulltype" onpaste="paste();" onfocus="allselect(this);"></cc1:CustTextBox>
                        </td>
                        <td style="width: 11%" align="right">
                        ...
                        <td style="width: 11%">
                            <cc1:CustTextBox ID="txtOperID" runat="server" MaxLength="10" checktype="ID"
                                Width="100px" onkeydown="entersubmit('btnAdd');" BoxName="實際經營者ID" onfocus="allselect(this);"></cc1:CustTextBox>
                        </td>
                        <td style="width: 11%" align="right">
                        ...
                        <td colspan="3">
                            <cc1:CustTextBox ID="txtOperTel1" runat="server" MaxLength="3" checktype="num" Width="30px"
                                onkeydown="entersubmit('btnAdd');" BoxName="實際經營者電話一" onfocus="allselect(this);"></cc1:CustTextBox>
                            <cc1:CustTextBox ID="txtOperTel2" runat="server" MaxLength="8" checktype="num" Width="70px"
                                onkeydown="entersubmit('btnAdd');" BoxName="實際經營者電話二" onfocus="allselect(this);"></cc1:CustTextBox>
                            <cc1:CustTextBox ID="txtOperTel3" runat="server" MaxLength="5" checktype="num" Width="40px"
                                onkeydown="entersubmit('btnAdd');" BoxName="實際經營者電話三" onfocus="allselect(this);"></cc1:CustTextBox>
                        </td>
                    </tr>                       
                    ...
                    <tr class="trOdd">
                        <td style="width: 11%" align="right">
                            <cc1:CustLabel ID="lblOperChangeDate" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                SetBreak="False" SetOmit="False" ShowID="01_01040201_037" StickHeight="False"></cc1:CustLabel>&nbsp;&nbsp;
                                     <cc1:CustLabel ID="lblOperChangeDate6" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                     IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01040201_061" StickHeight="False"></cc1:CustLabel>
                        </td>
                        <td style="width: 11%">
                            <cc1:CustTextBox ID="txtOperChangeDate" runat="server" MaxLength="7" checktype="num" Width="50px"
                                onkeydown="entersubmit('btnAdd');" BoxName="實際經營者領換補日" onfocus="allselect(this);"></cc1:CustTextBox>
                      </td>
                      <td style="width: 11%" align="right">
                    ...
                    <tr class="trOdd">
                        ...
                        <td align="right" style="width: 11%">
                            <cc1:CustLabel ID="lblContactManName" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                SetBreak="False" SetOmit="False" ShowID="01_01040201_041" StickHeight="False"></cc1:CustLabel>
                        </td>
                        <td style="width: 11%">
                            <cc1:CustTextBox ID="txtContactMan" runat="server"  onblur="changeFullType(this);" onkeydown="entersubmit('btnAdd');"
                                MaxLength="4" Width="90px" BoxName="聯絡人姓名" checktype="fulltype" onpaste="paste();" onfocus="allselect(this);"></cc1:CustTextBox>
                        </td>
                        <td align="right" style="width: 11%">
                        ...
                        <td style="width: 22%" colspan="2">
                            <cc1:CustTextBox ID="txtContactManTel1" runat="server" MaxLength="3" checktype="num"
                                Width="25px" onkeydown="entersubmit('btnAdd');" BoxName="聯絡人電話一" onfocus="allselect(this);"></cc1:CustTextBox>
                            <cc1:CustTextBox ID="txtContactManTel2" runat="server" MaxLength="8" checktype="num"
                                Width="58px" onkeydown="entersubmit('btnAdd');" BoxName="聯絡人電話二" onfocus="allselect(this);"></cc1:CustTextBox>
                            <cc1:CustTextBox ID="txtContactManTel3" runat="server" MaxLength="5" checktype="num"
                                Width="36px" onkeydown="entersubmit('btnAdd');" BoxName="聯絡人電話三" onfocus="allselect(this);"></cc1:CustTextBox>
                        </td>
                        <td align="right" style="width: 11%">
                        ...
                        <td style="width: 11%" colspan="2">
                            <cc1:CustTextBox ID="txtFax1" runat="server" MaxLength="3" checktype="num" Width="30px"
                                onkeydown="entersubmit('btnAdd');" BoxName="聯絡人傳真一" onfocus="allselect(this);"></cc1:CustTextBox>
                            <cc1:CustTextBox ID="txtFax2" runat="server" MaxLength="8" checktype="num" Width="70px"
                                onkeydown="entersubmit('btnAdd');" BoxName="聯絡人傳真二" onfocus="allselect(this);"></cc1:CustTextBox>
                        </td>
                    ...
                    <tr class="trEven">
                        ...
                        <td style="width: 88%" colspan="7">
                            <cc1:CustTextBox ID="txtBookAddr1" runat="server"  onblur="changeFullType(this);" onkeydown="entersubmit('btnAdd');"
                                MaxLength="6" Width="100px" BoxName="登記地址一" checktype="fulltype" onpaste="paste();" onfocus="allselect(this);"></cc1:CustTextBox>
                            <cc1:CustTextBox ID="txtBookAddr2" runat="server"  onblur="changeFullType(this);" onkeydown="entersubmit('btnAdd');"
                                MaxLength="14" Width="220px" BoxName="登記地址二" checktype="fulltype" onpaste="paste();" onfocus="allselect(this);"></cc1:CustTextBox>
                            <cc1:CustTextBox ID="txtBookAddr3" runat="server"  onblur="changeFullType(this);" onkeydown="entersubmit('btnAdd');"
                                MaxLength="7" Width="100px" BoxName="登記地址三" checktype="fulltype" onpaste="paste();" onfocus="allselect(this);"></cc1:CustTextBox>
                        </td>
                    </tr>
                    ...
                    <tr class="trOdd">
                        <td colspan="8">
                            ...
                            <cc1:CustLabel ID="lblAdd" runat="server" CurAlign="left" CurSymbol="£"
                                    FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                    NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01040201_055"
                                    StickHeight="False"></cc1:CustLabel> 
                    ...
                    <tr class="trOdd">
                        <td colspan="8">
                            ...
                            <cc1:CustTextBox ID="txtBusinessAddr4" runat="server"
                                MaxLength="6" Width="100px"  onblur="changeFullType(this);" onkeydown="entersubmit('btnAdd');" BoxName="營業地址一" checktype="fulltype" onpaste="paste();" onfocus="allselect(this);"></cc1:CustTextBox>
                            <cc1:CustTextBox ID="txtBusinessAddr5" runat="server" 
                                MaxLength="14" Width="220px"  onblur="changeFullType(this);" onkeydown="entersubmit('btnAdd');" BoxName="營業地址二" checktype="fulltype" onpaste="paste();" onfocus="allselect(this);"></cc1:CustTextBox>
                            <cc1:CustTextBox ID="txtBusinessAddr6" runat="server"
                                MaxLength="7" Width="100px"  onblur="changeFullType(this);" onkeydown="entersubmit('btnAdd');" BoxName="營業地址三" checktype="fulltype" onpaste="paste();" onfocus="allselect(this);"></cc1:CustTextBox>
                    ...
                    <tr class="trOdd">
                        <td align="right" style="width: 12%">
                            <cc1:CustLabel ID="lblJCIC" runat="server" CurAlign="left" CurSymbol="£"
                                FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01040201_043"
                                StickHeight="False" ForeColor="Red"></cc1:CustLabel>
                                
                        </td>
                        <td style="width: 88%" colspan="8">
                            <cc1:CustTextBox ID="txtJCIC" runat="server" MaxLength="1" Width="100px" onkeydown="entersubmit('btnAdd');" checktype="numandletter" BoxName="JCIC查詢" onfocus="allselect(this);"></cc1:CustTextBox>
                                <cc1:CustLabel ID="lblMessage1" runat="server" CurAlign="left" CurSymbol="£"
                                FractionalDigit="2" IsCurrency="False" NeedDateFormat="False"
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01040201_031"
                                StickHeight="False"></cc1:CustLabel>
                        </td>
                    </tr>
                    ...
                    <tr class="trEven">
                        <td align="right" style="width: 12%" rowspan="2">
                            <cc1:CustLabel ID="lblAccounts" runat="server" CurAlign="left" CurSymbol="£"
                                FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01040201_044"
                                StickHeight="False"></cc1:CustLabel>
                        </td>
                        ...
                        <td style="width: 33%" colspan="3">
                            <cc1:CustTextBox ID="txtBank" runat="server" MaxLength="5" 
                                Width="80px"  onblur="changeFullType(this);" onkeydown="entersubmit('btnAdd');" BoxName="銀行(中文)" checktype="fulltype" onpaste="paste();" onfocus="allselect(this);"></cc1:CustTextBox>
                        </td>
                        <td align="right" style="width: 11%">
                        ...
                        <td style="width: 33%" colspan="3">
                            <cc1:CustTextBox ID="txtBranchBank" runat="server" MaxLength="10" 
                                Width="140px"  onblur="changeFullType(this);" onkeydown="entersubmit('btnAdd');" BoxName="分行(中文)" checktype="fulltype" onpaste="paste();" onfocus="allselect(this);"></cc1:CustTextBox>
                        </td>
                    </tr>
                    ...
                    <tr class="trEven">
                        ...
                        <td style="width: 88%" colspan="8">
                            <cc1:CustTextBox ID="txtName" runat="server" MaxLength="20" 
                                Width="300px"  onblur="changeFullType(this);" onkeydown="entersubmit('btnAdd');" BoxName="戶名" checktype="fulltype" onpaste="paste();" onfocus="allselect(this);"></cc1:CustTextBox>
                        </td>
                    </tr>
                    ...
                    <tr class="trOdd">
                        <td align="right" style="width: 12%; height: 33px;">
                            <cc1:CustLabel ID="lblPrev" runat="server" CurAlign="left" CurSymbol="£"
                                FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01040201_045"
                                StickHeight="False"></cc1:CustLabel>
                        </td>
                        ...
                        <td align="right" style="width: 11%; height: 33px;">
                            <cc1:CustLabel ID="lblPrevDesc" runat="server" CurAlign="left" CurSymbol="£"
                                FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01040201_046"
                                StickHeight="False"></cc1:CustLabel>
                        </td>
                        <td style="width: 33%; height: 33px;" colspan="3">
                            <cc1:CustTextBox ID="txtPrevDesc" runat="server" MaxLength="4" 
                                Width="100px"  onblur="changeFullType(this);" onkeydown="entersubmit('btnAdd');" BoxName="帳單內容" checktype="fulltype" onpaste="paste();" onfocus="allselect(this);"></cc1:CustTextBox>
                        </td>
                        ...
                        <td align="right" style="width: 11%; height: 33px;">
                            <cc1:CustLabel ID="lblRedeemCycle" runat="server" CurAlign="left" CurSymbol="£"
                                FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01040201_047"
                                StickHeight="False"></cc1:CustLabel>
                        </td>
                        <td style="width: 11%; height: 33px;">
                    ...
                    <tr class="trEven">
                        ...
                        <td style="width: 88%" colspan="8">
                            <cc1:CustTextBox ID="txtPopMan" runat="server"  onblur="changeFullType(this);" onkeydown="entersubmit('btnAdd');" MaxLength="3"
                                Width="50px" BoxName="推廣員" checktype="fulltype" onpaste="paste();" onfocus="allselect(this);"></cc1:CustTextBox>
                        </td>             
                    </tr>
                    ...
                    <tr class="itemTitle1">
                        <td align="center">
                            <cc1:CustButton ID="btnAdd" runat="server" CssClass="smallButton" ShowID="01_01040201_026"
                                OnClick="btnAdd_Click" OnClientClick="return checkInputText('pnlText', 1);" DisabledWhenSubmit="False" onkeydown="setfocus('txtCardNo1');"/>&nbsp;&nbsp                   
                        </td>
                    </tr>
                </table>
                </cc1:CustPanel>
