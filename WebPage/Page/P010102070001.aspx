<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010102070001.aspx.cs" Inherits="P010102070001" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <%-- 20201119,24_Ares_Stanley-修正格式; 20210331_Ares_Stanley-調整Disabled input背景色; 20210420_Ares_Stanley-修正取卡方式限制一字元問題 --%>
<head runat="server">
    <title></title>
            ...
            <ContentTemplate>
                        ...
                        <td colspan="4">
                            <li>
                                <cc1:CustLabel ID="lblTitle" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    ...
                                    SetOmit="False" StickHeight="False" Width="200px" IsColon="False" ShowID="01_01020700_001"></cc1:CustLabel>
                            </li>
                        </td>
                    </tr>
                    <tr class="trOdd">
                        <td style="width: 15%" align="right">
                            <cc1:CustLabel ID="lblCardNo" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                ...
                                SetBreak="False" SetOmit="False" ShowID="01_01020700_002" StickHeight="False"></cc1:CustLabel>
                        </td>
                        <td colspan="3">
                ...
                <cc1:CustPanel ID="pnlText" runat="server" Width="100%">
                    <table width="100%" border="0" cellpadding="0" cellspacing="1" id="tabNo2" style="">
                        ...
                        <tr class="trOdd">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblChineseName" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01020700_004" StickHeight="False" ForeColor="#FF0066"></cc1:CustLabel>
                            </td>
                            <td style="width: 35%">
                            ...
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblCardPattern" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01020700_007" StickHeight="False"></cc1:CustLabel>
                            </td>
                            <td style="width: 35%">
                                <cc1:CustTextBox ID="txtCardPattern" runat="server" Width="70px" checktype="num"
                                    onkeydown="entersubmit('btnSubmit');" MaxLength="2" onfocus="allselect(this);" BoxName="製卡式樣"></cc1:CustTextBox>
                            </td>                            
                         </tr>   
                         <tr class="trEven">
                             <td align="right">
                                ...
                                IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                SetBreak="False" SetOmit="False" ShowID="01_01020700_003" StickHeight="False"></cc1:CustLabel>
                            </td>
                            <td colspan="3">
                                <cc1:CustLabel ID="lblPA1" runat="server" Width="50px"></cc1:CustLabel>
                                <cc1:CustLabel ID="lblPA2" runat="server" Width="50px"></cc1:CustLabel>
                            </td>
                        </tr>
                        <tr class="trOdd">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblEnglishName" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01020700_005" StickHeight="False"></cc1:CustLabel>
                            </td>
                            <td style="width: 35%" colspan="3">
                                <cc1:CustTextBox ID="txtEnglishName" runat="server" Width="190px" checktype=""
                                    MaxLength="19" onkeydown="keystoke('btnSubmit','txtCardFashion');" onfocus="allselect(this);"
                                    BoxName="製卡英文姓名"></cc1:CustTextBox>
                            </td>
                        </tr>
                        <tr class="trEven">
                            <td align="right" style="width: 15%">
                                <cc1:CustLabel ID="lblCardFashion" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01020700_006" StickHeight="False"></cc1:CustLabel>
                            </td>
                            <td style="width: 35%; position: relative" colspan="3">
                                <div style="position:relative">
                                    ...
                                    <cc1:CustTextBox ID="txtCardFashion" runat="server" checktype="num"
                                        checklength="1" onfocus="allselect(this);" onkeydown="entersubmit('btnSubmit');"
                                        Style="left: 0px; top: 0px; position: relative; width: 125px; height: 11px; line-height: 11px;" BoxName="取卡方式"></cc1:CustTextBox>
                                </div>
                            </td>
                        </tr>
                        <tr class="trOdd">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblMemberNo" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01020700_008" StickHeight="False"></cc1:CustLabel>
                            </td>
                            <td colspan="3" colspan="3">
                                <cc1:CustTextBox ID="txtMemberNo" runat="server" Width="190px" checktype="" MaxLength="11"
                                    onkeydown="entersubmit('btnSubmit');" onfocus="allselect(this);" BoxName="會員編號"></cc1:CustTextBox>        
                            </td>
                        </tr>
                        <tr>
                            <td nowrap colspan="4" style="height: 1px">
                        ...
                        <tr class="itemTitle1">
                            <td colspan="4" align="center">
                                <cc1:CustButton ID="btnSubmit" CssClass="smallButton" Width="40px" runat="server"
                                    ...
                                    onkeydown="setfocus('txtCardNo');" DisabledWhenSubmit="False" ShowID="01_01020700_010" />
                            </td>
                        </tr>
                    </table>
                </cc1:CustPanel>
