<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010801140201.aspx.cs" Inherits="P010801140201" %>

<%@ Register Assembly="Framework.WebControls" Namespace="Framework.WebControls" TagPrefix="cc1" %>
<%@ Register Src="~/Common/Controls/CustUpdateProgress.ascx" TagName="image" TagPrefix="cust" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<%--20210429_Ares_Stanley-按鈕失效問題--%>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
            <ContentTemplate>                
                <table width="100%" border="0" cellpadding="0" cellspacing="1" id="tabNo1" style="">
                    ...
                    <tr class="trOdd">
                        <td align="left">
                            <%--AML名單掃描結果--%><%--20191107-RQ-2018-015749-002--%>
                        ...
                        <td align="left" colspan="3"><%--<td align="left" colspan="7">--%>
