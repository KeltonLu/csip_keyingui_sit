<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010101070001.aspx.cs" Inherits="P010101070001" %>

<%@ Register Assembly="Framework.WebControls" Namespace="Framework.WebControls" TagPrefix="cc1" %>
<%@ Register Src="~/Common/Controls/CustUpdateProgress.ascx" TagName="image" TagPrefix="cust" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
    <%-- 2020/11/19_Ares_Stanley-修正格式; 2020/12/11_Ares_Stanley-修正格式; 2021/09/01_Ares_Stanley-查詢結果扣繳帳號改銀行代號; 2021/09/02_Ares_Stanley-調整TAB問題; 2021/10/08_Ares_Stanley-EMAIL、電子帳單反灰不能修改 --%>
<head runat="server">
    <title></title>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function checkIdEn(id) {
            ...
            if (!((id.Trim().charCodeAt(0) >= 65 && id.Trim().charCodeAt(0) <= 90) ||
                 (id.Trim().charCodeAt(0) >= 97 && id.Trim().charCodeAt(0) <= 122))) {
                return false;
            }
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                            ...
                            <td colspan="4">
                                <li>
                                    <cc1:CustLabel ID="lblTitle" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        ...
                                        SetOmit="False" StickHeight="False" Width="200px" IsColon="False" ShowID="01_01010700_001"></cc1:CustLabel></li>
                            </td>
                        </tr>
                        <tr class="trOdd">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblReceiveNumber" runat="server" CurAlign="left" CurSymbol="£"
                                    ...
                                    NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01010700_002"
                        ...
                        <tr class="trEven">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblUserId" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    ...
                                    SetBreak="False" SetOmit="False" ShowID="01_01010700_003" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 35%">
                            ...
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblUserName" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010700_004" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 35%">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="1" id="Table2">
                        <tr>
                            <td align="right" style="height: 1px"></td>
                        </tr>
                    </table>
                        ...
                        <tr class="trOdd">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblAccNoBank" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010700_006" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 85%">
                                <div style="position: relative">
                                    <cc1:CustDropDownList ID="dropAccNo" kind="select" runat="server" Style="left: 0px; top: 0px; clip: rect(0px auto auto 130px); position: absolute; width: 150px;"
                                    ...
                                    <cc1:CustTextBox ID="txtAccNoBank" runat="server" MaxLength="30" checklength="3" onkeydown="return  checkBank();"
                                        Style="left: 0px; top: 0px; position: relative; width: 125px; height: 11px;" BoxName="銀行代號" onfocus="allselect(this);"></cc1:CustTextBox>
                                </div>
                            </td>
                        </tr>
                        <tr class="trEven">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblAccNo" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010700_007" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 85%">
                        ...
                        <tr class="trOdd">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lnlPayWay" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010700_008" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 85%">
                        ...
                        <tr class="trEven">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblAccID" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010700_009" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 85%">
                                <cc1:CustTextBox ID="txtAccID" runat="server" Width="130px" checktype="numandletter"
                                    MaxLength="18" onkeydown="setfocus('txtBcycleCode'); keystoke('btnSubmit','txtBcycleCode');" BoxName="帳戶ID"></cc1:CustTextBox></td>
                        </tr>
                        <tr class="trOdd">
                            <td style="width: 15%" align="right">
                        ...
                        <tr class="trEven">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblMobilePhone" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010700_011" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 85%">
                        ...
                        <tr class="trOdd">
                            <td style="width: 15%" height="27" align="right">
                                <cc1:CustLabel ID="lblEmail" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010700_012" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 85%">
                        ...
                        <tr class="trEven">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblEBill" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010700_013" StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 85%">
                        ...
                        <tr class="trOdd">
                            <td style="width: 15%; height: 25px;" align="right">
                                <cc1:CustLabel ID="lblPopulNo" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010700_015" StickHeight="False"></cc1:CustLabel>
                            </td>
                        ...
                        <tr class="trEven">
                            <td style="width: 15%; height: 25px;" align="right">
                                <cc1:CustLabel ID="lblPopulEmpNO" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010700_016" StickHeight="False"></cc1:CustLabel>
                            </td>
                            <td style="width: 35%; height: 25px;">
                        ...
                        <tr class="trOdd">
                            <td style="width: 15%; height: 25px;" align="right">
                                <cc1:CustLabel ID="lbCaseClass" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01010700_017" StickHeight="False"></cc1:CustLabel>
                            </td>
                            <td style="width: 35%; height: 25px;">
                                <div style="position: relative">
                                    <cc1:CustDropDownList ID="dropCaseClass" kind="select" runat="server" Style="left: 0px; top: 0px; clip: rect(0px auto auto 130px); position: absolute; width: 150px;"
