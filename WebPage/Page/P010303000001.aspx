<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010303000001.aspx.cs" Inherits="P010303000001" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
            <ContentTemplate>
                        ...
                        <td colspan="2">
                            <li>
                                <cc1:CustLabel ID="lblTitle" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    ...
                                    SetBreak="False" SetOmit="False" ShowID="01_03030000_001" StickHeight="False"></cc1:CustLabel></li>
                        </td>
                    </tr>
                    <tr class="trOdd">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="1" id="Table1">
                    <tr>
                        <td>
                            <cc1:CustGridView ID="grvUserView" runat="server"
                                              AllowSorting="True" PagerID="gpList"
                                              Width="100%" BorderWidth="0px" CellPadding="0" CellSpacing="1" BorderStyle="Solid" CssClass="longTableGridView">
