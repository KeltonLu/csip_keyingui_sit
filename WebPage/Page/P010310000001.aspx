<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010310000001.aspx.cs" Inherits="P010310000001" %>
                        ...
                        <td colspan="2">
                            <li>
                                <cc1:CustLabel ID="lblTitle" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    ...
                                    SetBreak="False" SetOmit="False" ShowID="01_03100000_001" StickHeight="False"></cc1:CustLabel></li>
                        </td>
                    </tr>
                    <tr class="trOdd">
                        <td align="right" style="width: 20%">
                            <cc1:CustLabel ID="lblSearchSpan" runat="server" CurAlign="left" CurSymbol="&#163;"
                                ...
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_03100000_002"
                    ...
                    <tr class="trEven">
                        <td align="right" style="width: 20%">
                            <cc1:CustLabel ID="lblProperty" runat="server" CurAlign="left" CurSymbol="&#163;"
                                FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_03100000_003"
                                StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 80%">
                            <cc1:CustDropDownList ID="dropProperty" runat="server" AutoPostBack="True" OnSelectedIndexChanged="dropProperty_SelectedIndexChanged">
                    ...
                    <tr class="itemTitle">
                        <td colspan="2" align="center">
                            ...
                            <cc1:CustButton ID="btnSearch" runat="server" CssClass="smallButton" DisabledWhenSubmit="False"
                                                            OnClientClick="return checkInput();" Text="" Width="50px" ShowID="01_03100000_005"
                                                            OnClick="btnSearch_Click" />&nbsp;&nbsp;
                            
                            <cc1:CustButton ID="btnPrint" runat="server" CssClass="smallButton" DisabledWhenSubmit="False"
                                OnClientClick="return checkInput();" Text="" Width="50px" ShowID="01_03100000_004"
