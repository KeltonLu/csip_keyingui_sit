<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010105040001.aspx.cs" Inherits="P010105040001" %>
            ...
            <ContentTemplate>
                        ...
                        <td>
                            <li>
                                <cc1:CustLabel ID="Title" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    ...
                                    SetOmit="False" StickHeight="False" Width="397px" IsColon="False" ShowID="01_01090100_001"></cc1:CustLabel>
                            </li>
                        </td>
                    </tr>
                    <tr class="trOdd">
                        <td align="left" style="width: 100%">
                            ...
                            <div style="margin: 5px">
                                <cc1:CustLabel ID="lblOWNER_ID" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    ...
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_002" StickHeight="False"></cc1:CustLabel>
                                ...
                                <%--//20211028_Ares_Jack_HTG電文無資料，請手動建檔--%>
                            ...
                            <div style="margin: 5px">
                                <cc1:CustLabel ID="lblOWNER_ID_OLD" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01090100_004" StickHeight="False" Style="margin-right:24px"></cc1:CustLabel>
                ...
                <cc1:CustPanel ID="pnlText" runat="server" Width="100%">
                        ...
                        <tr class="trEven">
                            <%--身分證字號--%>
                             <td align="right" style="width: 11%">
                                <cc1:CustLabel ID="lblOWNER_ID2" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_005" StickHeight="False"></cc1:CustLabel>
                            </td>
                            <td style="width: 20%" colspan="2">
                                <cc1:CustTextBox ID="txtOWNER_ID2" runat="server" MaxLength="10" checktype="ID" Width="90px"
                                    onkeydown="entersubmit('btnAdd');" BoxName="身分證字號" InputType="LetterAndInt" Enabled="false"></cc1:CustTextBox>
                            </td>
                            <%--中文姓名--%>
                            <td align="right" style="width: 11%">
                                <cc1:CustLabel ID="lblNameCH" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_006" StickHeight="False"></cc1:CustLabel>
                            </td>
                            <td >
                            ...
                            <td align="right" style="width: 11%" colspan="2">
                                <cc1:CustLabel ID="lblNameCH_OLD" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_007" StickHeight="False"></cc1:CustLabel>
                            </td>
                            <td style="width: 17%" >
                        ...
                        <tr class="trOdd">
                            ...
                            <td align="right" style="width: 11%">
                                <cc1:CustLabel ID="lblNameEN" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_008" StickHeight="False"></cc1:CustLabel>
                            </td>
                            ...
                            <td align="right" style="width: 11%">
                                <cc1:CustLabel ID="lblBIRTH_DATE" runat="server" CurAlign="left" CurSymbol="£"
                                    ...
                                    NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01090100_009"
                                    StickHeight="False"></cc1:CustLabel>
                            </td>
                            <td  >
                                <cc1:CustTextBox ID="txtBIRTH_DATE" runat="server" MaxLength="7" checktype="num"
                                    Width="200px" onkeydown="entersubmit('btnAdd');" BoxName="出生年月日" Columns="6" ToolTip="yyyMMdd"></cc1:CustTextBox>
                            </td>
                            <%-- 性別 --%>
                            <td align="right" style="width: 11%" colspan="2">
                                <cc1:CustLabel ID="lblGENDER" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_010" StickHeight="False"></cc1:CustLabel>
                            </td>
                            <td style="width: 17%">
                        ...
                        <tr class="trEven">
                            ...
                            <td align="right" style="width: 10%">
                                <cc1:CustLabel ID="CustLabel57" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_040" StickHeight="False"></cc1:CustLabel>
                            </td>
                            <%--中文長姓名--%>
                            <td style="width: 10%" colspan="3">
                                ...
                                <cc1:CustLabel ID="lblNameCH_L" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_041" StickHeight="False"></cc1:CustLabel>
                                <cc1:CustTextBox ID="txtNameCH_L" runat="server" MaxLength="50" Width="260px" onblur="changeFullType(this);"
                                    ...
                                    onpaste="paste();" AutoPostBack="False"></cc1:CustTextBox>
                            </td>
                            <%--羅馬拼音--%>
                            <td align="right" style="width: 10%">
                                <cc1:CustLabel ID="lblNameCH_Pinyin" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_042" StickHeight="False"></cc1:CustLabel>
                            </td>
                            <td style="width: 10%" colspan="3">
                        ...
                        <tr class="trOdd">
                            ...
                            <td align="right" style="width: 11%">
                                <cc1:CustLabel ID="lblCountryCode" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_011" StickHeight="False"></cc1:CustLabel>
                            </td>
                            <td style="width: 11%" >
                                <div style="position: relative">
                                    <cc1:CustTextBox ID="txtCountryCode" runat="server" Width="50px" onfocus="allselect(this);" 
                                        onkeydown="entersubmit('btnAdd');" BoxName="國籍1" OnTextChanged="txtCodeType_TextChanged" AutoPostBack="true" Enabled="false" CssClass="auto-style1">14</cc1:CustTextBox>
                                    <cc1:CustDropDownList ID="dropCountry1" kind="select" runat="server" onclick="simOptionClick4IE('txtCountryCode');" 
                                        Style="clip: rect(0px auto auto 40px); " Enabled="false" CssClass="auto-style2"></cc1:CustDropDownList>
                            ...
                            <td align="right" style="width: 11%">
                                <cc1:CustLabel ID="lblCountryCode2" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_012" StickHeight="False"></cc1:CustLabel>
                            </td>
                            <td style="width: 11%" colspan="5">
                                <div style="position: relative">
                                    <cc1:CustTextBox ID="txtCountryCode2" runat="server"  Width="50px" onfocus="allselect(this);" 
                                    ...
                                    <cc1:CustDropDownList ID="dropCountry2" kind="select" runat="server" onclick="simOptionClick4IE('txtCountryCode2');" 
                                        Style="clip: rect(0px auto auto 40px); " CssClass="auto-style2"></cc1:CustDropDownList>
                         ...
                         <tr class="trEven">
                             ...
                             <td align="right" style="width: 11%">
                                <cc1:CustLabel ID="lblID_ISSUEDATE" runat="server" CurAlign="left" CurSymbol="£"
                                    FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                    NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01090100_013"
                                    StickHeight="False"></cc1:CustLabel>
                            </td>
                            <td style="width: 11%" >
                             ...
                             <td align="right" style="width: 11%">
                                <cc1:CustLabel ID="lblID_ISSUEPLACE" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_014" StickHeight="False"></cc1:CustLabel>
                            </td>
                            <td style="width: 11%">
                             ...
                             <td align="right" >
                                <cc1:CustLabel ID="lblID_REPLACETYPE" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_015" StickHeight="False"></cc1:CustLabel>
                            </td>
                            <td style="width: 11%">
                             ...
                             <td align="right" style="width: 23%">
                                <cc1:CustLabel ID="lblID_PHOTOFLAG" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_016" StickHeight="False"></cc1:CustLabel>
                            </td>
                            <td style="width: 11%">
                        ...
                        <tr class="trOdd">
                            ...
                            <td align="right" style="width: 11%">
                                <cc1:CustLabel ID="residenceAddress" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_017" StickHeight="False"></cc1:CustLabel>
                            </td>
                            <td style="width: 88%" colspan="7">
                                <cc1:CustTextBox ID="txtREG_ZIPCODE" runat="server" checktype="fulltype" MaxLength="7"
                                    Width="80px" onkeydown="entersubmit('btnAdd'); setfocus('txtREG_ADDR1');"
                        ...
                        <tr class="trEven">
                            ...
                            <td align="right" style="width: 11%">
                                <cc1:CustLabel ID="mailingAddress" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_018" StickHeight="False"></cc1:CustLabel>
                            </td>
                            <td style="width: 88%" colspan="7">
                        ...
                        <tr class="trOdd">
                            ...
                            <td align="right" style="width: 11%">
                                <cc1:CustLabel ID="lblEMAIL" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_019" StickHeight="False"></cc1:CustLabel>
                            </td>
                        ...
                        <tr class="trEven">
                            ...
                            <td align="right" style="width: 15%">
                                    <cc1:CustLabel ID="contactTel" runat="server" CurAlign="left" CurSymbol="£"
                                        FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                        NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01090100_020"
                            ...
                            <td align="right">
                                    <cc1:CustLabel ID="mobilePhone" runat="server" CurAlign="left" CurSymbol="£"
                                        FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                        NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01090100_021"
                                        StickHeight="False"></cc1:CustLabel></td>
                            <td style="width: 35%" colspan="3">
                        ...
                        <tr class="trOdd">
                            <td align="right" style="width: 11%">
                                <cc1:CustLabel ID="lblNP_COMPANY_NAME" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_032" StickHeight="False"></cc1:CustLabel>
                            </td>
                            ...
                            <td style="width: 89%" colspan="7">
                                <div style="position: relative">
                                    <cc1:CustTextBox ID="txtTITLE" runat="server"  onfocus="allselect(this);" 
                                        onkeydown="entersubmit('btnAdd');" BoxName="職稱" MaxLength="2"
                        ...
                        <tr class="trEven" style="height:60px">
                            ...
                            <td align="right" style="width: 11%">
                                  <cc1:CustLabel ID="income" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_026" StickHeight="False"></cc1:CustLabel>
                             </td >
                             <td  colspan="7">
                                 ...
                                 <cc1:CustLabel ID="CustLabel2" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="False" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_043" StickHeight="False" Style="margin-right:10px"></cc1:CustLabel>
                                 ...
                                 <cc1:CustLabel ID="CustLabel3" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="False" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_044" StickHeight="False" Style="margin-right:10px"></cc1:CustLabel>
                                 ...
                                 <cc1:CustLabel ID="CustLabel4" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="False" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_045" StickHeight="False" Style="margin-right:10px"></cc1:CustLabel>
                                 ...
                                 <cc1:CustLabel ID="CustLabel5" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="False" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_046" StickHeight="False" Style="margin-right:10px"></cc1:CustLabel>
                                 ...
                                 <cc1:CustLabel ID="CustLabel6" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="False" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_047" StickHeight="False" Style="margin-right:10px"></cc1:CustLabel>
                                 ...
                                 <cc1:CustLabel ID="CustLabel7" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="False" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_048" StickHeight="False" Style="margin-right:10px"></cc1:CustLabel>
                                 ...
                                 <cc1:CustLabel ID="CustLabel8" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="False" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_049" StickHeight="False" Style="margin-right:10px"></cc1:CustLabel>
                                 ...
                                 <cc1:CustLabel ID="CustLabel9" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="False" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_052" StickHeight="False" Style="margin-right:10px"></cc1:CustLabel>
                                 ...
                                 <cc1:CustLabel ID="CustLabel11" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="False" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_050" StickHeight="False" Style="margin-right:10px"></cc1:CustLabel>

                                 <cc1:CustHiddenField ID="hidIncome" runat="server" />
                            </td>
                        </tr>
                        <%--資料最後異動--%>
                        <tr class="trOdd">
                            ...
                            <td align="right" style="width: 11%">
                             ...
                             <td colspan="7" >
                                <cc1:CustCheckBox ID="chkisSCDD" runat="server"
                                    AutoPostBack="false" BoxName="已完成SCC表"  onkeydown="entersubmit('btnAdd');"/>
                                <cc1:CustLabel ID="CustLabel1" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="False" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01090100_030" StickHeight="False"></cc1:CustLabel>
                                 <%--AML審查Y為勾選--%>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="1" id="tabNo3" style="">
                        <tr class="itemTitle">
                            <td align="center">
                                <cc1:CustButton ID="btnAdd" runat="server" CssClass="smallButton" ShowID="01_01090100_031"
