<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010104030001.aspx.cs" Inherits="P010104030001" %>

<%@ Register Assembly="Framework.WebControls" Namespace="Framework.WebControls" TagPrefix="cc1" %>
<%@ Register Src="~/Common/Controls/CustUpdateProgress.ascx" TagName="image" TagPrefix="cust"%>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<%-- 20201231_Ares_Stanley-調整排版, 20210201_Ares_Stanley-調整版面; 20210329_Ares_Stanley-調整半形轉全形失效; 20210408_Ares_Stanley-調整半形轉全形失效; 20210409_Ares_Stanley-修正onblur alert死循環; 20210415_Ares_Stanley-調整全半形轉換 --%>
        ...
        {        
              ...
              //*檢核輸入欄位身分證號碼是否為空
                if(document.getElementById('txtShopId').value.Trim() == "")
                {
                    ...
                    return false;
                }else if(document.getElementById('txtShopId').value.Trim().length < 10){
                    alert('商店代號有誤');
                    document.getElementById('txtShopId').focus();
                    return false;
                }
            ...
            {      
                if(document.getElementById('radRegName').checked == false && document.getElementById('radBusinessName').checked == false && document.getElementById('radMerchantName').checked == false)
                {
                   ...
                   if(document.getElementById('txtFileNo').value.Trim() == "")
                  {
                       ...
                       return false;
                  }else if(document.getElementById('txtFileNo').value.Trim().length !=9){
                       alert('歸檔編號長度不可小於9碼! ');
                       document.getElementById('txtFileNo').focus(); 
                       return false;                    
                  }
                        ...
                        <tr class="trOdd">
                            ...
                            <td style="width: 35%">
                                <cc1:CustTextBox ID="txtEngName" runat="server" MaxLength="25" 
                                    Width="200px" onkeydown="entersubmit('btnAdd');" TabIndex="6" BoxName="英文名稱"></cc1:CustTextBox>
                            </td>
                            <td align="right" style="width: 15%">
                            ...
                            <td style="width: 35%">
                                <cc1:CustTextBox ID="txtDbaCity" runat="server" MaxLength="14" checktype="numandletter"
                                    Width="260px" onkeydown="entersubmit('btnAdd');" TabIndex="7" BoxName="英文CITY"></cc1:CustTextBox>
                            </td>
                          ...
                          <tr class="trEven">
                            ...
                            <td style="width: 35%">
                                <cc1:CustTextBox ID="txtOwner" runat="server" MaxLength="25" checktype="undefined"
                                    Width="260px" onkeydown="entersubmit('btnAdd');" TabIndex="8" BoxName="負責人英文名"></cc1:CustTextBox>
                            </td>
                            <td align="right" style="width: 15%">
                            ...
                            <td style="width: 35%">
                                <cc1:CustTextBox ID="txtPhone1" runat="server" MaxLength="3" checktype="numandletter" Width="60px"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="9" onblur="checkTelLength(1);" BoxName="連絡電話一"></cc1:CustTextBox>
                                <cc1:CustTextBox ID="txtPhone2" runat="server" MaxLength="8" checktype="numandletter" Width="100px"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="10" onblur="checkTelLength(2);" BoxName="連絡電話二"></cc1:CustTextBox>
                                <cc1:CustTextBox ID="txtPhone3" runat="server" MaxLength="5" checktype="numandletter" Width="60px"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="11"  BoxName="連絡電話三"></cc1:CustTextBox>
                        ...
                        <tr class="trOdd">
                            ...
                            <td style="width: 85%" colspan="3">
                                <cc1:CustTextBox ID="txtZip" runat="server" MaxLength="3" checktype="numandletter"
                                    Width="60px" onkeydown="entersubmit('btnAdd');" TabIndex="12" BoxName="區域號碼"></cc1:CustTextBox>
                                ...
                                <cc1:CustTextBox ID="txtAddress1" runat="server" MaxLength="14"  onblur="changeFullType(this);"
                                    Width="220px" onkeydown="entersubmit('btnAdd');" TabIndex="14" BoxName="帳單地址一" checktype="fulltype" onpaste="paste();"></cc1:CustTextBox>                               
                                <cc1:CustTextBox ID="txtAddress2" runat="server" MaxLength="14"  onblur="changeFullType(this);"
                                    Width="220px" onkeydown="entersubmit('btnAdd');" TabIndex="15" BoxName="帳單地址二" checktype="fulltype" onpaste="paste();"></cc1:CustTextBox>
                        ...
                        <tr class="trOdd">
                            ...
                            <td style="width: 13%">
                                <cc1:CustTextBox ID="txtImp1" runat="server" Width="50px" MaxLength="3" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="15" BoxName="IMP1"></cc1:CustTextBox>
                            </td>
                            <td style="width: 10%" align="right">
                            ...
                            <td style="width: 13%">
                                <cc1:CustTextBox ID="txtPos1" runat="server" Width="51px" MaxLength="3" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="16" BoxName="POS1"></cc1:CustTextBox>
                            </td>
                            <td style="width: 10%" align="right">
                            ...
                            <td style="width: 13%">
                                <cc1:CustTextBox ID="txtEdc1" runat="server" Width="50px" MaxLength="3" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="17" BoxName="EDC1"></cc1:CustTextBox>
                            </td>
                        </tr>
                        <tr class="trEven">
                            <td style="width: 10%" align="right">
                            ...
                            <td style="width: 13%">
                                <cc1:CustTextBox ID="txtImp2" runat="server" Width="50px" MaxLength="3" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="18" BoxName="IMP2"></cc1:CustTextBox>
                            </td>
                            <td style="width: 10%" align="right">
                            ...
                            <td style="width: 13%">
                                <cc1:CustTextBox ID="txtPos2" runat="server" Width="50px" MaxLength="3" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="19" BoxName="POS2"></cc1:CustTextBox>
                            </td>
                            <td style="width: 10%" align="right">
                            ...
                            <td style="width: 13%">
                                <cc1:CustTextBox ID="txtEdc2" runat="server" Width="50px" MaxLength="3" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="20" BoxName="EDC2"></cc1:CustTextBox>
                            </td>
                        </tr>
                        <tr class="itemTitle">
                            <td colspan="6">
                        ...
                        <tr class="trOdd">
                            ...
                            <td style="width: 35%; height: 25px;">
                                <cc1:CustTextBox ID="txtSalesName" runat="server" MaxLength="6" Width="120px"  onblur="changeFullType(this);"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="21" BoxName="推廣姓名" checktype="fulltype" onpaste="paste();"></cc1:CustTextBox>
                            </td>
                            <td align="right" style="width: 15%; height: 25px;">
                            ...
                            <td style="width: 35%; height: 25px;">
                                <cc1:CustTextBox ID="txtAgentBank" runat="server" MaxLength="5" Width="120px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="22" BoxName="推廣代碼"></cc1:CustTextBox>
                            </td>
                        </tr>
                        <tr class="itemTitle">
                            <td colspan="4">
                        ...
                        <tr class="trOdd">
                            ...
                            <td style="width:7%;">
                                <cc1:CustTextBox ID="txtType" runat="server" MaxLength="2" Width="30px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="23" BoxName="TYPE"></cc1:CustTextBox>
                            </td>
                            ...
                            <td style="width:7%;">
                                <cc1:CustTextBox ID="txtStore" runat="server" MaxLength="9" Width="80px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="24" BoxName="STORE"></cc1:CustTextBox>
                            </td><td style="width:7%; text-align:right;">
                            ...
                            <td style="width:7%;">
                                <cc1:CustTextBox ID="txtMerch" runat="server" MaxLength="9" Width="80px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="25" BoxName="MERCH"></cc1:CustTextBox>
                            </td>
                            <td style="width:7%; text-align:right;">
                            ...
                            <td style="width:7%;">
                                <cc1:CustTextBox ID="txtLevel" runat="server" MaxLength="1" Width="30px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="26" BoxName="LEVEL"></cc1:CustTextBox>
                            </td>
                            <td style="width:7%; text-align:right;">
                            ...
                            <td style="width:7%;">
                                <cc1:CustTextBox ID="txtSource" runat="server" MaxLength="3" Width="40px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="27" BoxName="SOURCE"></cc1:CustTextBox>
                            </td>
                            <td colspan="2"></td>
                        </tr>
                        <tr class="trEven">
                            ...
                            <td style="width:7%;">
                                <cc1:CustTextBox ID="txtMcc" runat="server" MaxLength="4" Width="50px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="28" BoxName="MCC"></cc1:CustTextBox>
                            </td>
                            <td style="width:7%; text-align:right;">
                            ...
                            <td style="width:7%;">
                                <cc1:CustTextBox ID="txtAve" runat="server" MaxLength="7" Width="80px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="29" BoxName="AVE"></cc1:CustTextBox>
                            </td>
                            <td style="width:7%; text-align:right;">
                            ...
                            <td style="width:7%;">
                                <cc1:CustTextBox ID="txtMonth" runat="server" MaxLength="5" Width="120px" checktype="num"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="30" BoxName="MONTH"></cc1:CustTextBox>
                            </td>
                            <td style="width:7%; text-align:right;">
                            ...
                            <td style="width:7%;">
                                <cc1:CustTextBox ID="txtBranch" runat="server" MaxLength="5" Width="70px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="31" BoxName="BRANCH"></cc1:CustTextBox>
                            </td> 
                            <td colspan="4"></td>
                        </tr>
                        <tr class="trOdd">
                            ...
                            <td style="width:7%;">
                                <cc1:CustTextBox ID="txtInt" runat="server" MaxLength="1" Width="30px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="32" BoxName="INT"></cc1:CustTextBox>
                            </td>
                            <td style="width:7%; text-align:right;">
                            ...
                            <td style="width:7%;">
                                <cc1:CustTextBox ID="txtMail" runat="server" MaxLength="1" Width="30px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="33" BoxName="MAIL"></cc1:CustTextBox>
                            </td>
                            <td style="width:7%; text-align:right;">
                            ...
                            <td style="width:7%;">
                                <cc1:CustTextBox ID="txtPosCa" runat="server" MaxLength="1" Width="30px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="34" BoxName="POS CA"></cc1:CustTextBox>
                            </td>
                            <td style="width:7%; text-align:right;">
                            ...
                            <td style="width:7%;">
                                <cc1:CustTextBox ID="txtPosMo" runat="server" MaxLength="2" Width="30px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="35" BoxName="POS MO"></cc1:CustTextBox>
                            </td>
                            <td style="width:7%; text-align:right;">
                            ...
                            <td style="width:7%;">
                                <cc1:CustTextBox ID="txtCH" runat="server" MaxLength="1" Width="30px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="36" BoxName="C/H"></cc1:CustTextBox>
                            </td>
                            <td style="width:7%; text-align:right;">
                            ...
                            <td style="">
                                <cc1:CustTextBox ID="txtMC" runat="server" MaxLength="1" Width="30px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="37" BoxName="M/C"></cc1:CustTextBox>
                            </td>
                        </tr>
                        <tr class="itemTitle">
                            <td colspan="12"></td>
                        ...
                        <tr class="trOdd">
                            ...
                            <td style="width: 35%">
                                <cc1:CustTextBox ID="txtFileNo" runat="server" MaxLength="9" checktype="numandletter"
                                    Width="140px" onkeydown="entersubmit('btnAdd');" TabIndex="38" BoxName="歸檔編號"></cc1:CustTextBox>
                            </td>
                            <td align="right" style="width: 15%">
                            ...
                            <td style="width: 35%">
                                <cc1:CustTextBox ID="txtHOLDSTMT" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px" onkeydown="entersubmit('btnAdd');" TabIndex="39" BoxName="HOLD STMT"></cc1:CustTextBox>
                            </td>
                        </tr>
                        <tr class="trEven">
                            <td align="right" style="width: 15%">
                            ...
                            <td style="width: 85%" colspan="3">
                                <cc1:CustTextBox ID="txtDdaNo1" runat="server" MaxLength="3" checktype="numandletter"
                                    Width="60px" onkeydown="entersubmit('btnAdd');" TabIndex="40" BoxName="帳號一"></cc1:CustTextBox>
                                <cc1:CustTextBox ID="txtDdaNo2" runat="server" MaxLength="16" checktype="numandletter"
                                    Width="380px" onkeydown="entersubmit('btnAdd');" TabIndex="41" BoxName="帳號二"></cc1:CustTextBox>
                            </td>
                        </tr>
                        <tr class="itemTitle">
                            <td colspan="4">
                        ...
                        <tr class="trEven">
                            ...
                            <td style="width: 17%">
                                <cc1:CustTextBox ID="txtStatus1" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px" onkeydown="entersubmit('btnAdd');" TabIndex="42" onblur="lostFocus(this,'txtDisRate1');" BoxName="01"></cc1:CustTextBox>
                            </td>
                            <td align="center" style="width: 23%">
                            ...
                            <td align="center" style="width: 43%">
                                <cc1:CustTextBox ID="txtDisRate1" runat="server" MaxLength="5" checktype="num"
                                    Width="80px" onkeydown="entersubmit('btnAdd');" TabIndex="57" BoxName="費率01"></cc1:CustTextBox>%
                            </td>
                        </tr>
                        <tr class="trOdd">
                            <td align="right" style="width: 17%">
                            ...
                            <td style="width: 17%">
                                <cc1:CustTextBox ID="txtStatus2" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px" onkeydown="entersubmit('btnAdd');" TabIndex="43" onblur="lostFocus(this,'txtDisRate2');" BoxName="02"></cc1:CustTextBox>
                            </td>
                            <td align="center" style="width: 23%">
                            ...
                            <td align="center" style="width: 43%">
                                <cc1:CustTextBox ID="txtDisRate2" runat="server" MaxLength="5" checktype="num"
                                    Width="80px" onkeydown="entersubmit('btnAdd');" TabIndex="58" BoxName="費率02"></cc1:CustTextBox>%
                            </td>
                        </tr>
                        <tr class="trEven">
                            <td align="right" style="width: 17%">
                            ...
                            <td style="width: 17%">
                                <cc1:CustTextBox ID="txtStatus3" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px" onkeydown="entersubmit('btnAdd');" TabIndex="44" onblur="lostFocus(this,'txtDisRate3');" BoxName="03"></cc1:CustTextBox>
                            </td>
                            <td align="center" style="width: 23%">
                            ...
                            <td align="center" style="width: 43%">
                                <cc1:CustTextBox ID="txtDisRate3" runat="server" MaxLength="5" checktype="num"
                                    Width="80px" onkeydown="entersubmit('btnAdd');" TabIndex="59" BoxName="費率03"></cc1:CustTextBox>%
                            </td>
                        </tr>
                        <tr class="trOdd">
                            <td align="right" style="width: 17%">
                            ...
                            <td style="width: 17%">
                                <cc1:CustTextBox ID="txtStatus4" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px" onkeydown="entersubmit('btnAdd');" TabIndex="45" onblur="lostFocus(this,'txtDisRate4');" BoxName="04"></cc1:CustTextBox>
                            </td>
                            <td align="center" style="width: 23%">
                            ...
                            <td align="center" style="width: 43%">
                                <cc1:CustTextBox ID="txtDisRate4" runat="server" MaxLength="5" checktype="num"
                                    Width="80px" onkeydown="entersubmit('btnAdd');" TabIndex="60" BoxName="費率04"></cc1:CustTextBox>%
                            </td>
                        </tr>
                        <tr class="trEven">
                            <td align="right" style="width: 17%">
                            ...
                            <td style="width: 17%">
                                <cc1:CustTextBox ID="txtStatus5" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px" onkeydown="entersubmit('btnAdd');" TabIndex="46" onblur="lostFocus(this,'txtDisRate5');" BoxName="05"></cc1:CustTextBox>
                            </td>
                            <td align="center" style="width: 23%">
                            ...
                            <td align="center" style="width: 43%">
                                <cc1:CustTextBox ID="txtDisRate5" runat="server" MaxLength="5" checktype="num"
                                    Width="80px" onkeydown="entersubmit('btnAdd');" TabIndex="61" BoxName="費率05"></cc1:CustTextBox>%
                            </td>
                        </tr>
                        <tr class="trOdd">
                            <td align="right" style="width: 17%">
                            ...
                            <td style="width: 17%">
                                <cc1:CustTextBox ID="txtStatus6" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px" onkeydown="entersubmit('btnAdd');" TabIndex="47" onblur="lostFocus(this,'txtDisRate6');" BoxName="06"></cc1:CustTextBox>
                            </td>
                            <td align="center" style="width: 23%">
                            ...
                            <td align="center" style="width: 43%">
                                <cc1:CustTextBox ID="txtDisRate6" runat="server" MaxLength="5" checktype="num"
                                    Width="80px" onkeydown="entersubmit('btnAdd');" TabIndex="62" BoxName="費率06"></cc1:CustTextBox>%
                            </td>
                        </tr>
                        <tr class="trEven">
                            <td align="right" style="width: 17%">
                            ...
                            <td style="width: 17%">
                                <cc1:CustTextBox ID="txtStatus7" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px" onkeydown="entersubmit('btnAdd');" TabIndex="48" onblur="lostFocus(this,'txtDisRate7');" BoxName="07"></cc1:CustTextBox>
                            </td>
                            <td align="center" style="width: 23%">
                            ...
                            <td align="center" style="width: 43%">
                                <cc1:CustTextBox ID="txtDisRate7" runat="server" MaxLength="5" checktype="num"
                                    Width="80px" onkeydown="entersubmit('btnAdd');" TabIndex="63" BoxName="費率07"></cc1:CustTextBox>%
                            </td>
                        </tr>
                        <tr class="trOdd">
                            <td align="right" style="width: 17%">
                            ...
                            <td style="width: 17%">
                                <cc1:CustTextBox ID="txtStatus8" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px"  onkeydown="entersubmit('btnAdd');" TabIndex="49" onblur="lostFocus(this,'txtDisRate8');" BoxName="08"></cc1:CustTextBox>
                            </td>
                            <td align="center" style="width: 23%">
                            ...
                            <td align="center" style="width: 43%">
                                <cc1:CustTextBox ID="txtDisRate8" runat="server" MaxLength="5" checktype="num"
                                    Width="80px" onkeydown="entersubmit('btnAdd');" TabIndex="64" BoxName="費率08"></cc1:CustTextBox>%
                            </td>
                        </tr>
                        ...
                        <tr class="trEven">
                            ...
                            <td style="width: 17%">
                                <cc1:CustTextBox ID="txtStatus9" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px"  onkeydown="entersubmit('btnAdd');" TabIndex="50" onblur="lostFocus(this,'txtDisRate9');" BoxName="09"></cc1:CustTextBox>
                            </td>
                            <td align="center" style="width: 23%">
                            ...
                            <td align="center" style="width: 43%">
                                <cc1:CustTextBox ID="txtDisRate9" runat="server" MaxLength="5" checktype="num"
                                    Width="80px" onkeydown="entersubmit('btnAdd');" TabIndex="65" BoxName="費率09"></cc1:CustTextBox>%
                            </td>
                        </tr>
                        ...
                        <tr class="trOdd">
                            ...
                            <td style="width: 17%">
                                <cc1:CustTextBox ID="txtStatus10" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px"  onkeydown="entersubmit('btnAdd');" TabIndex="51" onblur="lostFocus(this,'txtDisRate10');" BoxName="08"></cc1:CustTextBox>
                            </td>
                            <td align="center" style="width: 23%">
                                <!--20160525 (U) by Tank-->
                            ...
                            <td align="center" style="width: 43%">
                                <cc1:CustTextBox ID="txtDisRate10" runat="server" MaxLength="5" checktype="num"
                                    Width="80px" onkeydown="entersubmit('btnAdd');" TabIndex="66" BoxName="費率10"></cc1:CustTextBox>%
                            </td>
                        </tr>
                        ...
                        <tr class="trEven">
                            ...
                            <td style="width: 17%">
                                <cc1:CustTextBox ID="txtStatus11" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px"  onkeydown="entersubmit('btnAdd');" TabIndex="52" onblur="lostFocus(this,'txtDisRate11');" BoxName="08"></cc1:CustTextBox>
                            </td>
                            <td align="center" style="width: 23%">
                                <!--20160525 (U) by Tank-->
                            ...
                            <td align="center" style="width: 43%">
                                <cc1:CustTextBox ID="txtDisRate11" runat="server" MaxLength="5" checktype="num"
                                    Width="80px" onkeydown="entersubmit('btnAdd');" TabIndex="67" BoxName="費率11"></cc1:CustTextBox>%
                            </td>
                        </tr>
