<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010106030001.aspx.cs" Inherits="Page_P010106030001" %>
                        ...
                        <td colspan="8">
                            <li>
                                <cc1:CustLabel ID="CustLabel46" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    ...
                                    SetOmit="False" StickHeight="False" Width="200px" IsColon="False" ShowID="01_01060200_049"></cc1:CustLabel></li>
                        </td>
                    </tr>
                    <tr class="trOdd">
                        ...
                        <tr class="trOdd">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblShop_ID2" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01060200_009" StickHeight="False"
                        ...
                        <tr class="trOdd">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblReceipt_Type2" runat="server" CurSymbol="£" IsColon="True"
                                    ShowID="01_01060200_019" Font-Bold="True" ForeColor="Red"></cc1:CustLabel>
                            </td>
                            <td style="width: 85%" colspan="7">
                                <cc1:CustTextBox ID="txtP1" runat="server" MaxLength="2" TabIndex="55"></cc1:CustTextBox>
                                <cc1:CustDropDownList ID="ddlP1" runat="server" Enabled="false" onchange="AuthCode()"></cc1:CustDropDownList>                                
                            </td>
                        </tr>
                        <tr class="trEven">
                            <td style="width: 15%" align="right">
                                <cc1:CustLabel ID="lblAMT" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                    SetBreak="False" SetOmit="False" ShowID="01_01060200_018" StickHeight="False"></cc1:CustLabel>                                
                            </td>
                            <td style="width: 85%" colspan="7">
                                <cc1:CustTextBox ID="txtAMT" runat="server" MaxLength="7" TabIndex="60"></cc1:CustTextBox>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <cc1:CustButton ID="btnConfirm" runat="server" DisabledWhenSubmit="false" CssClass="smallButton2"
                                    ShowID="01_01060200_020" OnClick="btnConfirm_Click" Font-Bold="True" Font-Size="X-Large"
                                    TabIndex="65" />
