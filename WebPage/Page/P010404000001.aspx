<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010404000001.aspx.cs" Inherits="P010404000001" %>
        ...
        <ContentTemplate>
            <table width="100%" border="0" cellpadding="0" cellspacing="1" id="tabNo1" style="">
	            ...
	            <tr class="trOdd">	
                    ...
                    <td style="width: 80%">
                        <cc1:CustTextBox ID="txtReceiveNumber" runat="server" MaxLength="12" checktype="num" onkeydown="keypressstop();" onkeyup="ChangeEnableR();"></cc1:CustTextBox>
                        <cc1:CustTextBox ID="txtReceiveNumberH" runat="server" MaxLength="12" checktype="num" CssClass="btnHiden" Text=""></cc1:CustTextBox>
                     </td> 
	            </tr>
	            <tr class="trEven">
	                <td style="width: 20%" align="right" >
