<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010104020201.aspx.cs" Inherits="P010104020201" %>
                        ...
                        <tr class="trOdd">
                            ...
                            <td style="width: 35%">
                                <cc1:CustTextBox ID="txtDbaCity" runat="server" MaxLength="14" checktype="numandletter"
                                    Width="260px" onkeydown="entersubmit('btnAdd');" TabIndex="6" BoxName="英文CITY" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                            ...
                            <td style="width: 35%">
                                <cc1:CustTextBox ID="txtEngName" runat="server" MaxLength="25" checktype="numandletter"
                                    Width="200px" onkeydown="entersubmit('btnAdd');" TabIndex="7" BoxName="英文名稱" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                        </tr>
                        ...
                        <tr class="trEven">
                            ...
                            <td style="width: 85%" colspan="3">
                                <cc1:CustTextBox ID="txtZip" runat="server" MaxLength="3" checktype="numandletter"
                                    Width="60px" onkeydown="entersubmit('btnAdd');" TabIndex="8" BoxName="區域號碼" onfocus="allselect(this);"></cc1:CustTextBox>
                                ...
                                <cc1:CustTextBox ID="txtAddress1" runat="server" MaxLength="6"  onblur="changeFullType(this);"
                                    Width="120px" onkeydown="entersubmit('btnAdd');" TabIndex="9" BoxName="帳單地址一" checktype="fulltype" onpaste="paste();" onfocus="allselect(this);"></cc1:CustTextBox>                               
                                <cc1:CustTextBox ID="txtAddress2" runat="server" MaxLength="13"  onblur="changeFullType(this);"
                                    Width="210px" onkeydown="entersubmit('btnAdd');" TabIndex="10" BoxName="帳單地址二" checktype="fulltype" onpaste="paste();" onfocus="allselect(this);"></cc1:CustTextBox>
                        ...
                        <tr class="trOdd">
                            ...
                            <td style="width: 35%">
                                <cc1:CustTextBox ID="txtOwner" runat="server" MaxLength="25" checktype="numandletter"
                                    Width="260px" onkeydown="entersubmit('btnAdd');" TabIndex="11" BoxName="負責人英文名" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                            <td align="right" style="width: 15%">
                            ...
                            <td style="width: 35%">
                                <cc1:CustTextBox ID="txtPhone1" runat="server" MaxLength="3" checktype="numandletter" Width="60px"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="12" onblur="checkTelLength(1);" BoxName="連絡電話一" onfocus="allselect(this);"></cc1:CustTextBox>
                                <cc1:CustTextBox ID="txtPhone2" runat="server" MaxLength="17" checktype="numandletter" Width="190px"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="13" onblur="checkTelLength(2);" BoxName="連絡電話二" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                        </tr>
                        <tr class="itemTitle1">
                            <td colspan="4">
                        ...
                        <tr class="trOdd">
                            ...
                            <td style="width: 13%">
                                <cc1:CustTextBox ID="txtImp1" runat="server" Width="50px" MaxLength="3" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="14" BoxName="IMP1" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                            <td style="width: 10%" align="right">
                            ...
                            <td style="width: 13%">
                                <cc1:CustTextBox ID="txtPos1" runat="server" Width="51px" MaxLength="3" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="15" BoxName="POS1" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                            <td style="width: 10%" align="right">
                            ...
                            <td style="width: 13%">
                                <cc1:CustTextBox ID="txtEdc1" runat="server" Width="50px" MaxLength="3" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="16" BoxName="EDC1" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                        </tr>
                        <tr class="trEven">
                            <td style="width: 10%" align="right">
                            ...
                            <td style="width: 13%">
                                <cc1:CustTextBox ID="txtImp2" runat="server" Width="50px" MaxLength="3" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="17" BoxName="IMP2" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                            <td style="width: 10%" align="right">
                            ...
                            <td style="width: 13%">
                                <cc1:CustTextBox ID="txtPos2" runat="server" Width="50px" MaxLength="3" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="18" BoxName="POS2" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                            <td style="width: 10%" align="right">
                            ...
                            <td style="width: 13%">
                                <cc1:CustTextBox ID="txtEdc2" runat="server" Width="50px" MaxLength="3" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="19" BoxName="EDC2" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                        </tr>
                        <tr class="itemTitle1">
                            <td colspan="6">
                        ...
                        <tr class="trOdd">
                            ...
                            <td style="width: 35%; height: 25px;">
                                <cc1:CustTextBox ID="txtSalesName" runat="server" MaxLength="6" Width="120px"  onblur="changeFullType(this);"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="20" BoxName="推廣姓名" checktype="fulltype" onpaste="paste();" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                            <td align="right" style="width: 15%; height: 25px;">
                            ...
                            <td style="width: 35%; height: 25px;">
                                <cc1:CustTextBox ID="txtAgentBank" runat="server" MaxLength="5" Width="120px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="21" BoxName="推廣代碼" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                        </tr>
                        <tr class="itemTitle1">
                            <td colspan="4">
                        ...
                        <tr class="trOdd">
                            <td>
                                ...
                                <cc1:CustTextBox ID="txtType" runat="server" MaxLength="2" Width="30px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="22" BoxName="TYPE" onfocus="allselect(this);"></cc1:CustTextBox>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <cc1:CustTextBox ID="txtStore" runat="server" MaxLength="9" Width="80px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="23" BoxName="STORE" onfocus="allselect(this);"></cc1:CustTextBox>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <cc1:CustTextBox ID="txtMerch" runat="server" MaxLength="9" Width="80px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="24" BoxName="MERCH" onfocus="allselect(this);"></cc1:CustTextBox>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <cc1:CustTextBox ID="txtLevel" runat="server" MaxLength="1" Width="30px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="25" BoxName="LEVEL" onfocus="allselect(this);"></cc1:CustTextBox>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <cc1:CustTextBox ID="txtSource" runat="server" MaxLength="3" Width="40px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="26" BoxName="SOURCE" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                        </tr>
                        <tr class="trEven">
                            <td>
                                ...
                                <cc1:CustTextBox ID="txtMcc" runat="server" MaxLength="4" Width="50px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="27" BoxName="MCC" onfocus="allselect(this);"></cc1:CustTextBox>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <cc1:CustTextBox ID="txtAve" runat="server" MaxLength="7" Width="80px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="28" BoxName="AVE" onfocus="allselect(this);"></cc1:CustTextBox>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <cc1:CustTextBox ID="txtMonth" runat="server" MaxLength="10" Width="120px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="29" BoxName="MONTH" onfocus="allselect(this);"></cc1:CustTextBox>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <cc1:CustTextBox ID="txtBranch" runat="server" MaxLength="5" Width="70px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="30" BoxName="BRANCH" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td> 
                        </tr>
                        <tr class="trOdd">
                            <td>
                                ...
                                <cc1:CustTextBox ID="txtInt" runat="server" MaxLength="1" Width="30px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="31" BoxName="INT" onfocus="allselect(this);"></cc1:CustTextBox>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <cc1:CustTextBox ID="txtMail" runat="server" MaxLength="1" Width="30px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="32" BoxName="MAIL" onfocus="allselect(this);"></cc1:CustTextBox>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <cc1:CustTextBox ID="txtPosCa" runat="server" MaxLength="1" Width="30px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="33" BoxName="POS CA" onfocus="allselect(this);"></cc1:CustTextBox>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <cc1:CustTextBox ID="txtPosMo" runat="server" MaxLength="2" Width="30px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="34" BoxName="POS MO" onfocus="allselect(this);"></cc1:CustTextBox>
                                &nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <cc1:CustTextBox ID="txtCH" runat="server" MaxLength="1" Width="30px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="35" BoxName="C/H" onfocus="allselect(this);"></cc1:CustTextBox>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <cc1:CustTextBox ID="txtMC" runat="server" MaxLength="1" Width="30px" checktype="numandletter"
                                    onkeydown="entersubmit('btnAdd');" TabIndex="36" BoxName="M/C" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                        </tr>
                        <tr class="itemTitle1">
                            <td colspan="4">
                        ...
                        <tr class="trOdd">
                            ...
                            <td style="width: 35%">
                                <cc1:CustTextBox ID="txtFileNo" runat="server" MaxLength="9" checktype="numandletter"
                                    Width="140px" onkeydown="entersubmit('btnAdd');" TabIndex="37" BoxName="歸檔編號" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                            <td align="right" style="width: 15%">
                            ...
                            <td style="width: 35%">
                                <cc1:CustTextBox ID="txtHOLDSTMT" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px" onkeydown="entersubmit('btnAdd');" TabIndex="38" BoxName="HOLD STMT" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                        </tr>
                        <tr class="trEven">
                            <td align="right" style="width: 15%">
                            ...
                            <td style="width: 85%" colspan="3">
                                <cc1:CustTextBox ID="txtDdaNo1" runat="server" MaxLength="3" checktype="numandletter"
                                    Width="60px" onkeydown="entersubmit('btnAdd');" TabIndex="39" BoxName="帳號一" onfocus="allselect(this);"></cc1:CustTextBox>
                                <cc1:CustTextBox ID="txtDdaNo2" runat="server" MaxLength="50" checktype="numandletter"
                                    Width="380px" onkeydown="entersubmit('btnAdd');" TabIndex="40" BoxName="帳號二" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                        </tr>
                        <tr class="itemTitle1">
                            <td colspan="4">
                        ...
                        <tr class="trEven">
                            ...
                            <td style="width: 17%">
                                <cc1:CustTextBox ID="txtStatus1" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px" onkeydown="entersubmit('btnAdd');" TabIndex="41" onblur="lostFocus(this,'txtDisRate1');" BoxName="01" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                            <td align="center" style="width: 23%">
                            ...
                            <td align="center" style="width: 43%">
                                <cc1:CustTextBox ID="txtDisRate1" runat="server" MaxLength="5" checktype="num"
                                    Width="80px" onkeydown="entersubmit('btnAdd');" TabIndex="56" BoxName="費率01" onfocus="allselect(this);"></cc1:CustTextBox>%
                            </td>
                        </tr>
                        <tr class="trOdd">
                            <td align="right" style="width: 17%">
                            ...
                            <td style="width: 17%">
                                <cc1:CustTextBox ID="txtStatus2" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px" onkeydown="entersubmit('btnAdd');" TabIndex="42" onblur="lostFocus(this,'txtDisRate2');" BoxName="02" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                            <td align="center" style="width: 23%">
                            ...
                            <td align="center" style="width: 43%">
                                <cc1:CustTextBox ID="txtDisRate2" runat="server" MaxLength="5" checktype="num"
                                    Width="80px" onkeydown="entersubmit('btnAdd');" TabIndex="57" BoxName="費率02" onfocus="allselect(this);"></cc1:CustTextBox>%
                            </td>
                        </tr>
                        <tr class="trEven">
                            <td align="right" style="width: 17%">
                            ...
                            <td style="width: 17%">
                                <cc1:CustTextBox ID="txtStatus3" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px" onkeydown="entersubmit('btnAdd');" TabIndex="43" onblur="lostFocus(this,'txtDisRate3');" BoxName="03" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                            <td align="center" style="width: 23%">
                            ...
                            <td align="center" style="width: 43%">
                                <cc1:CustTextBox ID="txtDisRate3" runat="server" MaxLength="5" checktype="num"
                                    Width="80px" onkeydown="entersubmit('btnAdd');" TabIndex="58" BoxName="費率03" onfocus="allselect(this);"></cc1:CustTextBox>%
                            </td>
                        </tr>
                        <tr class="trOdd">
                            <td align="right" style="width: 17%">
                            ...
                            <td style="width: 17%">
                                <cc1:CustTextBox ID="txtStatus4" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px" onkeydown="entersubmit('btnAdd');" TabIndex="44" onblur="lostFocus(this,'txtDisRate4');" BoxName="04" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                            <td align="center" style="width: 23%">
                            ...
                            <td align="center" style="width: 43%">
                                <cc1:CustTextBox ID="txtDisRate4" runat="server" MaxLength="5" checktype="num"
                                    Width="80px" onkeydown="entersubmit('btnAdd');" TabIndex="59" BoxName="費率04" onfocus="allselect(this);"></cc1:CustTextBox>%
                            </td>
                        </tr>
                        <tr class="trEven">
                            <td align="right" style="width: 17%">
                            ...
                            <td style="width: 17%">
                                <cc1:CustTextBox ID="txtStatus5" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px" onkeydown="entersubmit('btnAdd');" TabIndex="45" onblur="lostFocus(this,'txtDisRate5');" BoxName="05" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                            <td align="center" style="width: 23%">
                            ...
                            <td align="center" style="width: 43%">
                                <cc1:CustTextBox ID="txtDisRate5" runat="server" MaxLength="5" checktype="num"
                                    Width="80px" onkeydown="entersubmit('btnAdd');" TabIndex="60" BoxName="費率05" onfocus="allselect(this);"></cc1:CustTextBox>%
                            </td>
                        </tr>
                        <tr class="trOdd">
                            <td align="right" style="width: 17%">
                            ...
                            <td style="width: 17%">
                                <cc1:CustTextBox ID="txtStatus6" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px" onkeydown="entersubmit('btnAdd');" TabIndex="46" onblur="lostFocus(this,'txtDisRate6');" BoxName="06" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                            <td align="center" style="width: 23%">
                            ...
                            <td align="center" style="width: 43%">
                                <cc1:CustTextBox ID="txtDisRate6" runat="server" MaxLength="5" checktype="num"
                                    Width="80px" onkeydown="entersubmit('btnAdd');" TabIndex="61" BoxName="費率06" onfocus="allselect(this);"></cc1:CustTextBox>%
                            </td>
                        </tr>
                        <tr class="trEven">
                            <td align="right" style="width: 17%">
                            ...
                            <td style="width: 17%">
                                <cc1:CustTextBox ID="txtStatus7" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px" onkeydown="entersubmit('btnAdd');" TabIndex="47" onblur="lostFocus(this,'txtDisRate7');" BoxName="07" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                            <td align="center" style="width: 23%">
                            ...
                            <td align="center" style="width: 43%">
                                <cc1:CustTextBox ID="txtDisRate7" runat="server" MaxLength="5" checktype="num"
                                    Width="80px" onkeydown="entersubmit('btnAdd');" TabIndex="62" BoxName="費率07" onfocus="allselect(this);"></cc1:CustTextBox>%
                            </td>
                        </tr>
                        <tr class="trOdd">
                            <td align="right" style="width: 17%">
                            ...
                            <td style="width: 17%">
                                <cc1:CustTextBox ID="txtStatus8" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px"  onkeydown="entersubmit('btnAdd');" TabIndex="48" onblur="lostFocus(this,'txtDisRate8');" BoxName="08" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                            <td align="center" style="width: 23%">
                            ...
                            <td align="center" style="width: 43%">
                                <cc1:CustTextBox ID="txtDisRate8" runat="server" MaxLength="5" checktype="num"
                                    Width="80px" onkeydown="entersubmit('btnAdd');" TabIndex="63" BoxName="費率08" onfocus="allselect(this);"></cc1:CustTextBox>%
                            </td>
                        </tr>
                        ...
                        <tr class="trEven">
                            ...
                            <td style="width: 17%">
                                <cc1:CustTextBox ID="txtStatus9" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px"  onkeydown="entersubmit('btnAdd');" TabIndex="49" onblur="lostFocus(this,'txtDisRate9');" BoxName="09" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                            <td align="center" style="width: 23%">
                            ...
                            <td align="center" style="width: 43%">
                                <cc1:CustTextBox ID="txtDisRate9" runat="server" MaxLength="5" checktype="num"
                                    Width="80px" onkeydown="entersubmit('btnAdd');" TabIndex="64" BoxName="費率09" onfocus="allselect(this);"></cc1:CustTextBox>%
                            </td>
                        </tr>
                        ...
                        <tr class="trOdd">
                            ...
                            <td style="width: 17%">
                                <cc1:CustTextBox ID="txtStatus10" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px"  onkeydown="entersubmit('btnAdd');" TabIndex="50" onblur="lostFocus(this,'txtDisRate10');" BoxName="10" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                            <td align="center" style="width: 23%">
                            ...
                            <td align="center" style="width: 43%">
                                <cc1:CustTextBox ID="txtDisRate10" runat="server" MaxLength="5" checktype="num"
                                    Width="80px" onkeydown="entersubmit('btnAdd');" TabIndex="65" BoxName="費率10" onfocus="allselect(this);"></cc1:CustTextBox>%
                            </td>
                        </tr>
                        ...
                        <tr class="trEven">
                            ...
                            <td style="width: 17%">
                                <cc1:CustTextBox ID="txtStatus11" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px"  onkeydown="entersubmit('btnAdd');" TabIndex="51" onblur="lostFocus(this,'txtDisRate11');" BoxName="11" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                            <td align="center" style="width: 23%">
                            ...
                            <td align="center" style="width: 43%">
                                <cc1:CustTextBox ID="txtDisRate11" runat="server" MaxLength="5" checktype="num"
                                    Width="80px" onkeydown="entersubmit('btnAdd');" TabIndex="66" BoxName="費率11" onfocus="allselect(this);"></cc1:CustTextBox>%
                            </td>
                        </tr>
                         ...
                         <tr class="trOdd">
                            ...
                            <td style="width: 17%">
                                <cc1:CustTextBox ID="txtStatus12" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px"  onkeydown="entersubmit('btnAdd');" TabIndex="52" onblur="lostFocus(this,'txtDisRate12');" BoxName="12" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                            <td align="center" style="width: 23%">
                            ...
                            <td align="center" style="width: 43%">
                                <cc1:CustTextBox ID="txtDisRate12" runat="server" MaxLength="5" checktype="num"
                                    Width="80px" onkeydown="entersubmit('btnAdd');" TabIndex="67" BoxName="費率12" onfocus="allselect(this);"></cc1:CustTextBox>%
                            </td>
                        </tr>
                        ...
                        <tr class="trEven">
                            ...
                            <td style="width: 17%">
                                <cc1:CustTextBox ID="txtStatus13" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px"  onkeydown="entersubmit('btnAdd');" TabIndex="53" onblur="lostFocus(this,'txtDisRate13');" BoxName="13" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                            <td align="center" style="width: 23%">
                            ...
                            <td align="center" style="width: 43%">
                                <cc1:CustTextBox ID="txtDisRate13" runat="server" MaxLength="5" checktype="num"
                                    Width="80px" onkeydown="entersubmit('btnAdd');" TabIndex="68" BoxName="費率13" onfocus="allselect(this);"></cc1:CustTextBox>%
                            </td>
                        </tr>
                        ...
                        <tr class="trOdd">
                            ...
                            <td style="width: 17%">
                                <cc1:CustTextBox ID="txtStatus14" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px"  onkeydown="entersubmit('btnAdd');" TabIndex="54" onblur="lostFocus(this,'txtDisRate14');" BoxName="14" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                            <td align="center" style="width: 23%">
                            ...
                            <td align="center" style="width: 43%">
                                <cc1:CustTextBox ID="txtDisRate14" runat="server" MaxLength="5" checktype="num"
                                    Width="80px" onkeydown="entersubmit('btnAdd');" TabIndex="69" BoxName="費率14" onfocus="allselect(this);"></cc1:CustTextBox>%
                            </td>
                        </tr>
                        ...
                        <tr class="trEven">
                            ...
                            <td style="width: 17%">
                                <cc1:CustTextBox ID="txtStatus15" runat="server" MaxLength="1" checktype="numandletter"
                                    Width="30px"  onkeydown="entersubmit('btnAdd');" TabIndex="55" onblur="lostFocus(this,'txtDisRate15');" BoxName="15" onfocus="allselect(this);"></cc1:CustTextBox>
                            </td>
                            <td align="center" style="width: 23%">
                            ...
                            <td align="center" style="width: 43%">
                                <cc1:CustTextBox ID="txtDisRate15" runat="server" MaxLength="5" checktype="num"
                                    Width="80px" onkeydown="entersubmit('btnAdd');" TabIndex="70" BoxName="費率15" onfocus="allselect(this);"></cc1:CustTextBox>%
                            </td>
                        </tr>
                    </table>
