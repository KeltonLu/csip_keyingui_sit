<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010101120001.aspx.cs" Inherits="P010101120001" %>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                            ...
                            <td colspan="2">
                                <li>
                                    <cc1:CustLabel ID="lblTitle" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        ...
                                        SetBreak="False" SetOmit="False" StickHeight="False" Width="200px" ShowID="01_01011200_001" />
                                </li>
                            </td>
                        </tr>
                        <%--業務類別--%>
                        ...
                        <tr class="trEven">
                            <td style="width: 20%" align="right">
                                <cc1:CustLabel ID="lblBusinessCategory" runat="server" CurAlign="left" CurSymbol="£"
                                    FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                    NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" StickHeight="False"
                                    ShowID="01_01011200_007" Style="color: Red" />
                            </td>
                            <td style="width: 80%">
                                ...
                                <cc1:CustButton ID="btnSelect" CssClass="smallButton" Width="40px" runat="server" ShowID="01_01011200_006" DisabledWhenSubmit="False" 
                        ...
                        <tr class="trOdd">
                            <td style="width: 20%" align="right">
                                <cc1:CustLabel ID="CustLabel6" runat="server" CurAlign="left" CurSymbol="£"
                                    FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                    NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" StickHeight="False"
                                    ShowID="01_01011200_008" Style="color: Red" />
                            </td>
                            <td style="width: 80%">
                        ...
                        <tr class="trEven">
                            <td style="width: 20%" align="right">
                                <cc1:CustLabel ID="CustLabel2" runat="server" CurAlign="left" CurSymbol="£"
                                    FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                    NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" StickHeight="False"
                                    ShowID="01_01011200_009" Style="color: Red" />
                            </td>
                            <td style="width: 80%">
                        ...
                        <tr class="trOdd">
                            <td style="width: 20%" align="right">
                                <cc1:CustLabel ID="CustLabel4" runat="server" CurAlign="left" CurSymbol="£"
                                    FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                    NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" StickHeight="False"
                                    ShowID="01_01011200_011" Style="color: Red" />
                            </td>
                            <td style="width: 80%">
                        ...
                        <tr class="trEven">
                            <td style="width: 20%" align="right">
                                <cc1:CustLabel ID="CustLabel5" runat="server" CurAlign="left" CurSymbol="£"
                                    FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                    NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" StickHeight="False"
                                    ShowID="01_01011200_012" Style="color: Red" />
                            </td>
                            <td style="width: 80%">
                        ...
                        <tr class="trOdd">
                            <td style="width: 20%" align="right">
                                <cc1:CustLabel ID="CustLabel1" runat="server" CurAlign="left" CurSymbol="£"
                                    FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                    NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" StickHeight="False"
                                    ShowID="01_01011200_013" Style="color: Red" />
                            </td>
                            <td style="width: 80%">
                        ...
                        <tr class="trOdd">
                            <td style="width: 20%" align="right">
                                <cc1:CustLabel ID="CustLabel8" runat="server" CurAlign="left" CurSymbol="£"
                                    FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                    NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" StickHeight="False"
                                    ShowID="01_01011200_014" />
                            </td>
                            <td style="width: 80%">
                                <cc1:CustTextBox ID="txtMonthlyParkingNO" runat="server" MaxLength="8" BoxName="月租停車場代碼" onkeypress="otherEnter();"></cc1:CustTextBox>
                            </td>
                        </tr>
                        <%--車牌號碼2--%>
                        <tr class="trEven">
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="1">
                        <tr class="itemTitle">
                            <td align="center">
                                <cc1:CustButton ID="btnSubmit" CssClass="smallButton" Width="40px" runat="server" DisabledWhenSubmit="False" ShowID="01_01011200_006" Enabled="false"
