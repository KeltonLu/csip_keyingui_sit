<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010209000001.aspx.cs" Inherits="P010209000001" %>

<%@ Register Src="~/Common/Controls/CustUpdateProgress.ascx" TagName="image" TagPrefix="cust" %>
<%@ Register Assembly="Framework.WebControls" Namespace="Framework.WebControls" TagPrefix="cc1" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<%--2021/01/06_Ares_Stanley-修正選取後文字欄位變成編輯欄位--%>
                    ...
                    <tr>
                        <td>
                            <cc1:CustGridView ID="gvList" Width="100%" BorderWidth="0px" CellPadding="0" CellSpacing="1"
                                BorderStyle="Solid" runat="server" PagerID="gpList" AllowSorting="True" OnRowDataBound="gvList_RowDataBound" OnSelectedIndexChanging="gvList_SelectedIndexChanged">
