<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010801080001.aspx.cs" Inherits="P010801080001" %>
...
<%--                <table width="100%" border="0" cellpadding="0" cellspacing="1" id="CaseInfo" style="">
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="1" id="Table1" style="">
                    ...
                    <tr class="trOdd" id="Personnel_tr" style="<%=Personnel_HtmlPanel%>">                    
                        ...
                        <td align="left">
                            <%--姓名--%>
                                <cc1:CustLabel ID="CustLabel67" runat="server" CurAlign="right" ShowID="01_08010600_041" ></cc1:CustLabel>
                        </td>
                        <td align="left">
                            <%--國籍--%>
                                <cc1:CustLabel ID="CustLabel68" runat="server" CurAlign="right" ShowID="01_08010600_042" ></cc1:CustLabel>
                        </td>
                        <td align="left">
                            <%--姓名--%>
                                <cc1:CustLabel ID="CustLabel8" runat="server" CurAlign="right" ShowID="01_08010600_041" ></cc1:CustLabel>
                        </td>
                        <td align="left">
                            <%--國籍--%>
                                <cc1:CustLabel ID="CustLabel11" runat="server" CurAlign="right" ShowID="01_08010600_042" ></cc1:CustLabel>
                        </td>
                        <td align="left">
                            <%--姓名--%>
                                <cc1:CustLabel ID="CustLabel12" runat="server" CurAlign="right" ShowID="01_08010600_041" ></cc1:CustLabel>
                        </td>
                        <td align="left">
                            <%--國籍--%>
                                <cc1:CustLabel ID="CustLabel18" runat="server" CurAlign="right" ShowID="01_08010600_042" ></cc1:CustLabel>
                        </td>
                    </tr>                    
                    <%=Personnel_HtmlValue%>
                </table>
