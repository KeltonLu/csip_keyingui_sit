<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010103010001.aspx.cs" Inherits="P010103010001" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <%-- 20201123_Ares_Stanley-修正格式; 20210329_Ares_Stanley-調整半形轉全形失效; 20210408_Ares_Stanley-調整半形轉全形失效; 20210415_Ares_Stanley-調整全半形轉換; 20210902_Ares_Stanley:移除Email前30後19長度限制, 改為總長度50 --%>
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function checkCancel() {
            ...
            //20210527 EOS_AML(NOVA) 增加欄位 by Ares Dennis
            //*資料最後異動分行不為空
            if (document.getElementById('txtLAST_UPD_BRANCH2').value.Trim() == "") {
                alert('資料最後異動分行不為空! ');
                document.getElementById('txtLAST_UPD_BRANCH2').focus();
                return false;
            }

            //*資料最後異動MAKER不為空
            if (document.getElementById('txtLAST_UPD_MAKER2').value.Trim() == "") {
                alert('資料最後異動MAKER不為空! ');
                document.getElementById('txtLAST_UPD_MAKER2').focus();
                return false;
            }

            //*資料最後異動CHECKER不為空
            if (document.getElementById('txtLAST_UPD_CHECKER2').value.Trim() == "") {
                alert('資料最後異動CHECKER不為空! ');
                document.getElementById('txtLAST_UPD_CHECKER2').focus();
                return false;
            }
        ...
        //*若本行卡(1.3.5.7)欄位有填值時,下方01N(本行),03V(本行),05M(本行),07J(本行) 欄位 disabled,反之enabled
        ...
        function checkBasicByTaxno() {
            ...
            //20210527 EOS_AML(NOVA) 增加欄位 by Ares Dennis
            //*資料最後異動分行不為空
            if (document.getElementById('txtLAST_UPD_BRANCH3').value.Trim() == "") {
                alert('資料最後異動分行不為空! ');
                document.getElementById('txtLAST_UPD_BRANCH3').focus();
                return false;
            }

            //*資料最後異動MAKER不為空
            if (document.getElementById('txtLAST_UPD_MAKER3').value.Trim() == "") {
                alert('資料最後異動MAKER不為空! ');
                document.getElementById('txtLAST_UPD_MAKER3').focus();
                return false;
            }

            //*資料最後異動CHECKER不為空
            if (document.getElementById('txtLAST_UPD_CHECKER3').value.Trim() == "") {
                alert('資料最後異動CHECKER不為空! ');
                document.getElementById('txtLAST_UPD_CHECKER3').focus();
                return false;
            }
...
<body class="workingArea">
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
            <ContentTemplate>
                <table width="100%" cellpadding="0" cellspacing="1" id="TABLE2">
                    <tr class="itemTitle">
                        <td>
                            <li>
                                <cc1:CustLabel ID="lblTitle" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False"
                                    SetOmit="False" StickHeight="False" Width="181px" IsColon="False" ShowID="01_01030100_086"></cc1:CustLabel></li>
                        </td>
                    </tr>
                    <tr class="itemTitle">
                        <td align="center">
                            ...
                            <cc1:CustButton ID="btnBasicData" Text="" runat="server" CssClass="smallButton" OnClick="btnBasicData_Click"
                                Width="150px" UseSubmitBehavior="False" DisabledWhenSubmit="False" ShowID="01_01030100_007" />
                            <%--費率異動作業畫面：P4A--%>
                            <cc1:CustButton ID="btnFee" runat="server" Text="" CssClass="smallButton" OnClick="btnFee_Click"
                                Width="150px" UseSubmitBehavior="False" DisabledWhenSubmit="False" ShowID="01_01030100_003" />
                            <%--帳號異動(作業畫面：P4/P4A)--%>
                            <cc1:CustButton ID="btnAccounts" Text="" runat="server" CssClass="smallButton" OnClick="btnAccounts_Click"
                                Width="170px" UseSubmitBehavior="False" DisabledWhenSubmit="False" ShowID="01_01030100_004" />
                            <%--解約作業(作業畫面：P4/P4A)--%>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="1" style="height: 92px" id="tabMostly" runat="server">
                    <tr class="trOdd">
                        ...
                        <td align="right" style="width: 15%; height: 27px;">
                            <cc1:CustLabel ID="lblShopId" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                ...
                                SetBreak="False" SetOmit="False" ShowID="01_01030100_082" StickHeight="False"></cc1:CustLabel>
                        </td>
                        <td style="width: 35%; height: 27px;">
                            <cc1:CustTextBox ID="txtShopId" runat="server" Width="143px" MaxLength="9" onkeydown="entersubmit('btnSelect');"
                                checktype="numandletter" onkeyup="ChangeEnable();" BoxName="商店代號"></cc1:CustTextBox>
                            <cc1:CustTextBox ID="txtShopIdH" runat="server" Width="143px" MaxLength="9" CssClass="btnHiden"
                                Text=""></cc1:CustTextBox>
                            &nbsp;&nbsp;&nbsp;&nbsp
                            <%--查詢--%>
                            <cc1:CustButton ID="btnSelect" Text="" runat="server" Width="64px" CssClass="smallButton"
                                OnClick="btnSelect_Click" OnClientClick=" return checktextbox('tabMostly',0);"
                        ...
                        <td align="right" style="width: 15%; height: 27px;">
                            <cc1:CustLabel ID="lblTask" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                SetBreak="False" SetOmit="False" ShowID="01_01030100_083" StickHeight="False"></cc1:CustLabel></td>
                        <td style="width: 37%; height: 27px;">
                    ...
                    <tr class="trEven">
                        ...
                        <td align="right" style="width: 15%">
                            <cc1:CustLabel ID="lblMerchantName" runat="server" CurAlign="left" CurSymbol="£"
                                ...
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01030100_084"
                    ...
                    <tr class="trOdd">
                        ...
                        <td align="right" style="width: 15%;">
                            <cc1:CustLabel ID="lblBusinessName" runat="server" CurAlign="left" CurSymbol="£"
                                FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01030100_085"
                    ...
                    <tr>
                        <td style="white-space:nowrap; height: 1px;" colspan="4"></td>
                    </tr>
                </table>
                ...
                <cc1:CustPanel ID="pnlText" runat="server" Width="100%">
                    <cc1:CustPanel ID="pnlBasic" runat="server" Height="363px" Width="100%">
                        <table width="100%" border="0" cellpadding="0" cellspacing="1" id="tabBasic" style="">
                                ...
                                <td colspan="4" align="left">
                                    <li>
                                        <cc1:CustLabel ID="lblBasic" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                            IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False"
                                            SetOmit="False" StickHeight="False" Width="232px" IsColon="False" ShowID="01_01030100_007"></cc1:CustLabel>
                                    </li>
                            </tr>
                            <tr class="trOdd">
                                <%--總公司統一編號--%>
                            ...
                            <tr class="trOdd">
                                ...
                                <td style="width: 15%;" align="right">
                                    <cc1:CustLabel ID="lblRecordNameTwo" runat="server" CurAlign="left" CurSymbol="£"
                                        FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                        NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01030100_008"
                                        StickHeight="False"></cc1:CustLabel>
                                </td>
                                <td style="width: 35%;">
                                    <cc1:CustTextBox ID="txtRecordNameTwo" runat="server" Width="240px" IsValEmpty="False"
                                        ...
                                        onpaste="paste();" BoxName="登記名稱" checktype="fulltype"></cc1:CustTextBox>
                                </td>
                                <%--營業名稱--%>
                                <td align="right" style="width: 15%;">
                                    <cc1:CustLabel ID="lblBusinessNameTwo" runat="server" CurAlign="left" CurSymbol="£"
                                        FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                        NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01030100_009"
                                        StickHeight="False"></cc1:CustLabel>
                                </td>
                                <td style="width: 35%;">
                                    <cc1:CustTextBox ID="txtBusinessNameTwo" runat="server" Width="240px" MaxLength="19"
                                        ...
                                        BoxName="營業名稱" checktype="fulltype"></cc1:CustTextBox>
                                </td>
                            </tr>
                            <tr class="trEven">
                                <%--帳單列示名稱--%>
                                ...
                                <td style="width: 35%">
                                    <cc1:CustTextBox ID="txtMerchantNameTwo" runat="server" Width="240px" MaxLength="14"
                                        onkeydown="entersubmit('btnBasicSubmit');"  onblur="changeFullType(this);" onpaste="paste();"
                                        BoxName="帳單列示名稱" checktype="fulltype"></cc1:CustTextBox>
                                </td>
                                <%--商店英文名稱--%>
                                <td align="right" style="width: 15%">&nbsp;<cc1:CustLabel ID="lblEnglishName" runat="server" CurAlign="left" CurSymbol="£"
                                    FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                    NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01030100_011"
                                    StickHeight="False"></cc1:CustLabel>
                                </td>
                                <td style="width: 35%">
                                    <cc1:CustTextBox ID="txtEnglishName" runat="server" Width="240px" MaxLength="24"
                                        onkeydown="entersubmit('btnBasicSubmit');" BoxName="商店英文名稱"></cc1:CustTextBox>
                                </td>
                            </tr>
                            <tr class="trOdd">
                                <%--負責人--%>
                                ...
                                <td style="width: 35%">
                                    <cc1:CustTextBox ID="txtUndertaker" runat="server" Width="130px" MaxLength="4" onkeydown="entersubmit('btnBasicSubmit');"
                                         onblur="changeFullType(this);" onpaste="paste();" BoxName="負責人" checktype="fulltype"></cc1:CustTextBox></td>
                                <%--負責人ID--%>
                                <td align="right" style="width: 15%">
                                ...
                                <td style="width: 35%">
                                    <cc1:CustTextBox ID="txtUndertakerID" runat="server" Width="140px" MaxLength="10"
                                        onkeydown="entersubmit('btnBasicSubmit');" checktype="ID" BoxName="負責人ID" InputType="LetterAndInt"></cc1:CustTextBox>
                                </td>
                            </tr>
                            ...
                            <tr class="trEven">
                                ...
                                <td style="width: 35%">
                                    <cc1:CustTextBox ID="txtUndertakerEngName" runat="server" Width="240px" MaxLength="25"
                                        onkeydown="entersubmit('btnBasicSubmit');" BoxName="負責人英文名"></cc1:CustTextBox>
                                </td>
                                <%--負責人電話--%>
                                <td align="right" style="width: 15%">
                                ...
                                <td style="width: 35%">
                                    <cc1:CustTextBox ID="txtUndertakerTel1" runat="server" Width="40px" MaxLength="3"
                                        onkeydown="entersubmit('btnBasicSubmit');" checktype="num" BoxName="負責人電話一"></cc1:CustTextBox>
                                    <cc1:CustTextBox ID="txtUndertakerTel2" runat="server" Width="100px" MaxLength="8"
                                        onkeydown="entersubmit('btnBasicSubmit');" checktype="num" BoxName="負責人電話二"></cc1:CustTextBox>
                                    <cc1:CustTextBox ID="txtUndertakerTel3" runat="server" Width="40px" MaxLength="5"
                                        onkeydown="entersubmit('btnBasicSubmit');" checktype="num" BoxName="負責人電話三"></cc1:CustTextBox>
                                </td>
                            </tr>
                            ...
                            <tr class="trOdd">
                                ...
                                <td align="right" style="width: 15%">
                                    <cc1:CustLabel ID="lblCountryCode" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_092" StickHeight="False"></cc1:CustLabel>
                                </td>
                            ...
                            <tr class="trEven">
                                ...
                                <td colspan="3" style="width: 85%">
                                    <cc1:CustTextBox ID="txtUndertakerAdd1" runat="server" Width="130px" MaxLength="6"
                                        onkeydown="entersubmit('btnBasicSubmit');"  onblur="changeFullType(this);" onpaste="paste();"
                                        BoxName="負責人戶籍地址一" checktype="fulltype"></cc1:CustTextBox>
                                    <cc1:CustTextBox ID="txtUndertakerAdd2" runat="server" Width="280px" MaxLength="14"
                                        onkeydown="entersubmit('btnBasicSubmit');"  onblur="changeFullType(this);" onpaste="paste();"
                                        BoxName="負責人戶籍地址二" checktype="fulltype"></cc1:CustTextBox>
                                    <cc1:CustTextBox ID="txtUndertakerAdd3" runat="server" Width="140px" MaxLength="7"
                                        onkeydown="entersubmit('btnBasicSubmit');"  onblur="changeFullType(this);" onpaste="paste();"
                                        BoxName="負責人戶籍地址三" checktype="fulltype"></cc1:CustTextBox></td>
                            </tr>
                            <tr class="trOdd" style="display: none">
                                ...
                                <td align="right" style="width: 15%">
                                    <cc1:CustLabel ID="lblRealPerson" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_017" StickHeight="False"></cc1:CustLabel>
                                </td>
                                <td style="width: 35%">
                                    <cc1:CustTextBox ID="txtRealPerson" runat="server" Width="130px" IsValEmpty="False"
                                        ...
                                        onpaste="paste();" BoxName="實際經營人" checktype="fulltype"></cc1:CustTextBox>
                                </td>
                                <%--實際經營人ID--%>
                                <td align="right" style="width: 15%">
                                    <cc1:CustLabel ID="lblRealPersonID" runat="server" CurAlign="left" CurSymbol="£"
                                        FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                        NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01030100_018"
                                        StickHeight="False"></cc1:CustLabel>
                                </td>
                                <td style="width: 35%">
                                    <cc1:CustTextBox ID="txtRealPersonID" runat="server" Width="140px" MaxLength="10"
                                        onkeydown="entersubmit('btnBasicSubmit');" checktype="ID" BoxName="實際經營人ID" InputType="LetterAndInt"></cc1:CustTextBox>
                                </td>
                            </tr>
                            <tr class="trOdd">
                                <%--聯絡人--%>
                                <td align="right" style="width: 15%">
                                    <cc1:CustLabel ID="lblJunctionPerson" runat="server" CurAlign="left" CurSymbol="£"
                                        FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                        NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01030100_020"
                                        StickHeight="False"></cc1:CustLabel>
                                </td>
                                <td style="width: 35%" colspan="3">
                                    <cc1:CustTextBox ID="txtJunctionPerson" runat="server" Width="140px" MaxLength="4"
                                        onkeydown="entersubmit('btnBasicSubmit');"  onblur="changeFullType(this);" onpaste="paste();"
                                        BoxName="聯絡人" checktype="fulltype"></cc1:CustTextBox>
                                </td>
                            </tr>
                            <tr class="trEven" style="display: none">
                                ...
                                <td align="right" style="width: 15%">&nbsp;&nbsp;
                                    <cc1:CustLabel ID="lblRealPersonTel" runat="server" CurAlign="left" CurSymbol="£"
                                        FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                        NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01030100_019"
                                        StickHeight="False"></cc1:CustLabel>
                                </td>
                                <td style="width: 35%">
                                    <cc1:CustTextBox ID="txtRealPersonTel1" runat="server" Width="36px" MaxLength="3"
                                        onkeydown="entersubmit('btnBasicSubmit');" checktype="num" BoxName="實際經營人電話一"></cc1:CustTextBox>
                                    <cc1:CustTextBox ID="txtRealPersonTel2" runat="server" Width="110px" MaxLength="8"
                                        onkeydown="entersubmit('btnBasicSubmit');" checktype="num" BoxName="實際經營人電話二"></cc1:CustTextBox>
                                    <cc1:CustTextBox ID="txtRealPersonTel3" runat="server" Width="50px" MaxLength="5"
                                        onkeydown="entersubmit('btnBasicSubmit');" checktype="num" BoxName="實際經營人電話三"></cc1:CustTextBox>
                                </td>
                            </tr>
                            ...
                            <tr class="trEven">
                                ...
                                <td align="right" style="width: 15%">
                                    <cc1:CustLabel ID="lblJunctionPersonTel" runat="server" CurAlign="left" CurSymbol="£"
                                        FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                        NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01030100_021"
                                        StickHeight="False"></cc1:CustLabel>
                                </td>
                                <td style="width: 35%">
                                    <cc1:CustTextBox ID="txtJunctionPersonTel1" runat="server" Width="36px" IsValEmpty="False"
                                        ...
                                        BoxName="聯絡人電話一"></cc1:CustTextBox>
                                    <cc1:CustTextBox ID="txtJunctionPersonTel2" runat="server" Width="110px" MaxLength="8"
                                        onkeydown="entersubmit('btnBasicSubmit');" checktype="num" BoxName="聯絡人電話二"></cc1:CustTextBox>
                                    <cc1:CustTextBox ID="txtJunctionPersonTel3" runat="server" Width="50px" MaxLength="5"
                                        onkeydown="entersubmit('btnBasicSubmit');" checktype="num" BoxName="聯絡人電話三"></cc1:CustTextBox>
                                </td>
                                <%--聯絡人傳真--%>
                                <td align="right" style="width: 15%">
                                    <cc1:CustLabel ID="lblJunctionPersonFax" runat="server" CurAlign="left" CurSymbol="£"
                                        FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                        NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01030100_022"
                                        StickHeight="False"></cc1:CustLabel>
                                </td>
                                <td style="width: 35%">
                                    <cc1:CustTextBox ID="txtJunctionPersonFax1" runat="server" Width="36px" MaxLength="3"
                                        onkeydown="entersubmit('btnBasicSubmit');" checktype="num" BoxName="聯絡人傳真一"></cc1:CustTextBox>
                                    <cc1:CustTextBox ID="txtJunctionPersonFax2" runat="server" Width="110px" MaxLength="8"
                                        onkeydown="entersubmit('btnBasicSubmit');" checktype="num" BoxName="聯絡人傳真二"></cc1:CustTextBox>
                                </td>
                            </tr>
                            <tr class="trEven" style="display: none">
                                <%--實際經營人戶籍--%>
                                <td align="right" style="width: 15%">
                                    <cc1:CustLabel ID="lblRealPersonAdd" runat="server" CurAlign="left" CurSymbol="£"
                                        FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                        NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01030100_023"
                                        StickHeight="False"></cc1:CustLabel></td>
                                <td colspan="3" style="width: 85%">
                                    <cc1:CustTextBox ID="txtRealPersonAdd1" runat="server" Width="130px" MaxLength="6"
                                        onkeydown="entersubmit('btnBasicSubmit');"  onblur="changeFullType(this);" onpaste="paste();"
                                        BoxName="實際經營人戶籍一" checktype="fulltype"></cc1:CustTextBox>
                                    <cc1:CustTextBox ID="txtRealPersonAdd2" runat="server" Width="280px" MaxLength="14"
                                        onkeydown="entersubmit('btnBasicSubmit');"  onblur="changeFullType(this);" onpaste="paste();"
                                        BoxName="實際經營人戶籍二" checktype="fulltype"></cc1:CustTextBox>
                                    <cc1:CustTextBox ID="txtRealPersonAdd3" runat="server" Width="140px" MaxLength="7"
                                        onkeydown="entersubmit('btnBasicSubmit');"  onblur="changeFullType(this);" onpaste="paste();"
                                        BoxName="實際經營人戶籍三" checktype="fulltype"></cc1:CustTextBox></td>
                            </tr>
                            ...
                            <tr class="trOdd">
                                <td align="right" style="width: 12%">
                                    <cc1:CustLabel ID="lblEmail" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_095" StickHeight="False"></cc1:CustLabel>
                                </td>
                            ...
                            <tr class="trEven">
                                ...
                                <td colspan="3" style="width: 85%">
                                    ...
                                    <cc1:CustTextBox ID="txtJunctionPersonRecadd1" runat="server" Width="130px" MaxLength="6"
                                        onkeydown="entersubmit('btnBasicSubmit');"  onblur="changeFullType(this);" onpaste="paste();"
                                        BoxName="商店登記地址一" checktype="fulltype" AutoPostBack="true" OnTextChanged="TextBox_AddrChanged"></cc1:CustTextBox>
                                    <cc1:CustTextBox ID="txtJunctionPersonRecadd2" runat="server" Width="280px" MaxLength="14"
                                        onkeydown="entersubmit('btnBasicSubmit');"  onblur="changeFullType(this);" onpaste="paste();"
                                        BoxName="商店登記地址二" checktype="fulltype"></cc1:CustTextBox>
                                    <cc1:CustTextBox ID="txtJunctionPersonRecadd3" runat="server" Width="140px" MaxLength="7"
                                        onkeydown="entersubmit('btnBasicSubmit');"  onblur="changeFullType(this);" onpaste="paste();"
                                        BoxName="商店登記地址三" checktype="fulltype"></cc1:CustTextBox></td>
                            </tr>
                            <tr class="trOdd">
                                <%--商店營業地址--%>
                                <td align="right" style="width: 15%">&nbsp;&nbsp;
                                    <cc1:CustLabel ID="lblJunctionPersonRealadd" runat="server" CurAlign="left" CurSymbol="£"
                                        FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                        NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01030100_025"
                                        StickHeight="False"></cc1:CustLabel></td>
                                <td colspan="3" style="width: 85%">
                                    <cc1:CustTextBox ID="txtRealaddZip" runat="server" Width="60px" MaxLength="3" onkeydown="entersubmit('btnBasicSubmit');"
                                        checktype="num" BoxName="商店營業地址一"></cc1:CustTextBox>
                                    <cc1:CustTextBox ID="txtJunctionPersonRealadd1" runat="server" Width="130px" MaxLength="6"
                                        onkeydown="entersubmit('btnBasicSubmit');"  onblur="changeFullType(this);" onpaste="paste();"
                                        BoxName="商店營業地址二" checktype="fulltype"></cc1:CustTextBox>
                                    <cc1:CustTextBox ID="txtJunctionPersonRealadd2" runat="server" Width="250px" MaxLength="14"
                                        onkeydown="entersubmit('btnBasicSubmit');"  onblur="changeFullType(this);" onpaste="paste();"
                                        BoxName="商店營業地址三" checktype="fulltype"></cc1:CustTextBox>
                                    <cc1:CustTextBox ID="txtJunctionPersonRealadd3" runat="server" Width="140px" MaxLength="7"
                                        onkeydown="entersubmit('btnBasicSubmit');"  onblur="changeFullType(this);" onpaste="paste();"
                                        BoxName="商店營業地址四" checktype="fulltype"></cc1:CustTextBox></td>
                            </tr>
                            <tr class="trEven">
                                <%--帳單地址--%>
                                <td align="right" style="width: 15%">
                                    <cc1:CustLabel ID="lblCommadd" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_026" StickHeight="False"></cc1:CustLabel>
                                </td>
                                <td colspan="3" style="width: 85%">
                                    <cc1:CustTextBox ID="txtZip" runat="server" Width="60px" MaxLength="3" onkeydown="entersubmit('btnBasicSubmit');"
                                        checktype="num" BoxName="帳單地址一"></cc1:CustTextBox>
                                    <cc1:CustTextBox ID="txtCommadd1" runat="server" Width="130px" MaxLength="14" onkeydown="entersubmit('btnBasicSubmit');"
                                         onblur="changeFullType(this);" onpaste="paste();" BoxName="帳單地址二" checktype="fulltype"></cc1:CustTextBox>
                                    <cc1:CustTextBox ID="txtComaddr2" runat="server" Width="250px" MaxLength="14" onkeydown="entersubmit('btnBasicSubmit');"
                                         onblur="changeFullType(this);" onpaste="paste();" BoxName="帳單地址三" checktype="fulltype"></cc1:CustTextBox></td>
                            </tr>
                            <tr class="trOdd">
                                <%--推廣員--%>
                                <td align="right" style="width: 15%">
                                    <cc1:CustLabel ID="lblIntroduces" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_027" StickHeight="False"></cc1:CustLabel>
                                </td>
                                <td style="width: 35%">
                                    <cc1:CustTextBox ID="txtIntroduces" runat="server" Width="120px" MaxLength="3" onkeydown="entersubmit('btnBasicSubmit');"
                                         onblur="changeFullType(this);" onpaste="paste();" BoxName="推廣員" checktype="fulltype"></cc1:CustTextBox>
                                </td>
                                <%--推廣代號--%>
                                <td align="right" style="width: 15%">
                                    <cc1:CustLabel ID="lblIntroduceFlag" runat="server" CurAlign="left" CurSymbol="£"
                                        FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                        NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01030100_028"
                                        StickHeight="False"></cc1:CustLabel>
                                </td>
                                <td style="width: 35%">
                                    <cc1:CustTextBox ID="txtIntroduceFlag" runat="server" Width="140px" MaxLength="5"
                                        onkeydown="entersubmit('btnBasicSubmit');" checktype="num" BoxName="推廣代號"></cc1:CustTextBox>
                                </td>
                            </tr>
                            <tr class="trEven">
                                <%--發票週期--%>
                                <td align="right" style="width: 15%; height: 13px;">
                                    <cc1:CustLabel ID="lblInvoiceCycle" runat="server" CurAlign="left" CurSymbol="£"
                                        FractionalDigit="2" IsColon="True" IsCurrency="False" NeedDateFormat="False"
                                        NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False" ShowID="01_01030100_029"
                                        StickHeight="False"></cc1:CustLabel>
                                </td>
                            ...
                            <tr class="trOdd">
                                ...
                                <td align="right" style="width: 15%">
                                    <cc1:CustLabel ID="lblReqAppro" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_091" StickHeight="False"></cc1:CustLabel>
                                </td>
                            ...
                            <tr class="itemTitle">
                                <%--提交--%>
                                <td colspan="4" align="center">&nbsp;<cc1:CustButton ID="btnBasicSubmit" Text="" runat="server" Width="57px" CssClass="smallButton"
                                    Enabled="False" OnClick="btnSubmitClick" OnClientClick="return checktextbox('tabBasic',1);"
                                    onkeydown="setfocus('btnBasicData');" DisabledWhenSubmit="False" ShowID="01_01030100_002" />
                                </td>
                            </tr>
                        </table>
                    </cc1:CustPanel>
                                ...
                                <td colspan="4" style="width: 70%">
                                    <li>
                                        <cc1:CustLabel ID="lblFee" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                            IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False"
                                            SetOmit="False" StickHeight="False" Width="218px" IsColon="False" ShowID="01_01030100_033"></cc1:CustLabel></li>
                                </td>
                                <%--舊制外加費率異動(P4A-6122)--%>
                                <td colspan="2" style="width: 30%">
                                    <li>
                                        <cc1:CustLabel ID="lblCup" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                            IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False"
                                            SetOmit="False" StickHeight="False" Width="240px" IsColon="False" ShowID="01_01030100_090"></cc1:CustLabel></li>
                                </td>
                            </tr>
                            <tr class="trOdd">
                                <%--新增JCB(全)--%>
                                <td style="width: 15%" align="right">
                                    <cc1:CustLabel ID="lblAddjcb" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_034" StickHeight="False"></cc1:CustLabel>
                                </td>
                                <td colspan="3" style="width: 55%">
                                    <cc1:CustTextBox ID="txtAddjcb" runat="server" MaxLength="1" onkeydown="entersubmit('btnFeeSubmit');"
                                        checktype="num" onkeyup="changeFeeStatus();" BoxName="新增JCB(全)" Width="70px"
                                        TabIndex="1"></cc1:CustTextBox>
                                    &nbsp;&nbsp;
                                    <cc1:CustLabel ID="lblMessage2" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2" IsColon="False"
                                        IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False"
                                        ShowID="01_01030100_035" StickHeight="False" ForeColor="Red"></cc1:CustLabel>
                                </td>
                                <td align="right" style="width: 15%">
                                ...
                                <td style="width: 15%">
                                    <cc1:CustTextBox ID="txtStatus1" runat="server" MaxLength="1" checktype="num" onkeydown="entersubmit('btnFeeSubmit');"
                                        Width="31px" BoxName="舊制外加費率一STATUS" TabIndex="23"></cc1:CustTextBox>
                                    &nbsp;&nbsp;<cc1:CustTextBox ID="txtFee1" runat="server" MaxLength="5" checktype="num"
                                        onkeydown="entersubmit('btnFeeSubmit');" Width="60px" BoxName="舊制外加費率一" TabIndex="24"></cc1:CustTextBox>
                                </td>
                            </tr>
                            <tr class="trEven">
                                <%--新增JCB(本行)--%>
                                <td style="width: 15%" align="right">
                                    <cc1:CustLabel ID="lblAddjcbUs" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_036" StickHeight="False"></cc1:CustLabel>
                                </td>
                                <td colspan="3" style="width: 55%">
                                    <cc1:CustTextBox ID="txtAddjcbUs" runat="server" MaxLength="1" onkeydown="entersubmit('btnFeeSubmit');"
                                        checktype="num" BoxName="新增JCB(本行)" Width="70px" TabIndex="2"></cc1:CustTextBox>
                                </td>
                                <td align="right" style="width: 15%">
                                ...
                                <td style="width: 15%">
                                    <cc1:CustTextBox ID="txtStatus2" runat="server" MaxLength="1" checktype="num" onkeydown="entersubmit('btnFeeSubmit');"
                                        Width="31px" BoxName="舊制外加費率二STATUS" TabIndex="25"></cc1:CustTextBox>
                                    &nbsp;&nbsp;
                                    <cc1:CustTextBox ID="txtFee2" runat="server" MaxLength="5" checktype="num" onkeydown="entersubmit('btnFeeSubmit');"
                                        Width="60px" BoxName="舊制外加費率二" TabIndex="26"></cc1:CustTextBox>
                                </td>
                            </tr>
                            <%--新增JCB(他行)--%>
                            <tr class="trOdd">
                                <td style="width: 15%" align="right">
                                    <cc1:CustLabel ID="lblAddjcbNotus" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_037" StickHeight="False"></cc1:CustLabel>
                                </td>
                                <td colspan="3" style="width: 55%">
                                    <cc1:CustTextBox ID="txtAddjcbNotus" runat="server" onkeydown="entersubmit('btnFeeSubmit');"
                                        checktype="num" MaxLength="1" BoxName="新增JCB(他行)" Width="70px" TabIndex="3"></cc1:CustTextBox>
                                </td>
                                <td align="right" style="width: 15%">
                                ...
                                <td style="width: 15%">
                                    <cc1:CustTextBox ID="txtStatus3" runat="server" MaxLength="1" checktype="num" onkeydown="entersubmit('btnFeeSubmit');"
                                        Width="31px" BoxName="舊制外加費率三STATUS" TabIndex="27"></cc1:CustTextBox>
                                    &nbsp;&nbsp;<cc1:CustTextBox ID="txtFee3" runat="server" MaxLength="5" checktype="num"
                                        onkeydown="entersubmit('btnFeeSubmit');" Width="60px" BoxName="舊制外加費率三" TabIndex="28"></cc1:CustTextBox>
                                </td>
                            </tr>
                            <tr class="trEven">
                                <%--費率異動日--%>
                                <td style="width: 15%" align="right">
                                    <cc1:CustLabel ID="lblModdate" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_038" StickHeight="False"></cc1:CustLabel>
                                </td>
                                <td colspan="3" style="width: 55%">
                                    <cc1:CustTextBox ID="txtModdate" runat="server" MaxLength="6" onkeydown="entersubmit('btnFeeSubmit');"
                                        checktype="num" BoxName="費率異動日" Width="70px" TabIndex="4"></cc1:CustTextBox>
                                    <span style="color: red">&nbsp;&nbsp;
                                        <%--MMDDYY(西元年後二碼)--%>
                                        <cc1:CustLabel ID="lblMessage3" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                            IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False"
                                            StickHeight="False" ForeColor="Red" IsColon="False" ShowID="01_01030100_039"></cc1:CustLabel>
                                </td>
                                <td align="right" style="width: 15%">
                                ...
                                <td style="width: 15%">
                                    <cc1:CustTextBox ID="txtStatus4" runat="server" MaxLength="1" checktype="num" onkeydown="entersubmit('btnFeeSubmit');"
                                        Width="31px" BoxName="舊制外加費率四STATUS" TabIndex="29"></cc1:CustTextBox>
                                    &nbsp;&nbsp;<cc1:CustTextBox ID="txtFee4" runat="server" MaxLength="5" checktype="num"
                                        onkeydown="entersubmit('btnFeeSubmit');" Width="60px" BoxName="舊制外加費率四" TabIndex="30"></cc1:CustTextBox>
                                </td>
                            </tr>
                            <tr class="trOdd">
                                <td style="width: 15%" align="right">
                                    <cc1:CustLabel ID="lblPage1" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_040" StickHeight="False"></cc1:CustLabel></td>
                                <td colspan="3" style="width: 55%">
                                    <cc1:CustTextBox ID="txtPage1" runat="server" MaxLength="5" onkeydown="entersubmit('btnFeeSubmit');"
                                        checktype="num" onkeyup="changeFeeUsStatus();" BoxName="本行卡(1.3.5.7)" Width="70px"
                                        TabIndex="5"></cc1:CustTextBox>&nbsp;&nbsp;<cc1:CustLabel ID="lblMessage1" runat="server"
                                            CurAlign="left" CurSymbol="£" FractionalDigit="2" IsColon="False" IsCurrency="False"
                                            NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False" SetOmit="False"
                                            ShowID="01_01030100_041" StickHeight="False" ForeColor="Red"></cc1:CustLabel></td>
                                <td align="right" style="width: 15%">
                                ...
                                <td style="width: 15%">
                                    <cc1:CustTextBox ID="txtStatus5" runat="server" MaxLength="1" checktype="num" onkeydown="entersubmit('btnFeeSubmit');"
                                        Width="31px" BoxName="舊制外加費率五STATUS" TabIndex="31"></cc1:CustTextBox>
                                    &nbsp;&nbsp;<cc1:CustTextBox ID="txtFee5" runat="server" MaxLength="5" checktype="num"
                                        onkeydown="entersubmit('btnFeeSubmit');" Width="60px" BoxName="舊制外加費率五" TabIndex="32"></cc1:CustTextBox>
                                </td>
                            </tr>
                            <tr class="trEven">
                                <td style="width: 15%" align="right">
                                    <cc1:CustLabel ID="lblPage2" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_042" StickHeight="False"></cc1:CustLabel></td>
                                <td colspan="3" style="width: 55%">
                                    <cc1:CustTextBox ID="txtPage2" runat="server" MaxLength="5" onkeydown="entersubmit('btnFeeSubmit');"
                                        checktype="num" onkeyup="changeFeeOtherStatus();" BoxName="他行卡(2.4.6.8)" Width="70px"
                                        TabIndex="6"></cc1:CustTextBox></td>
                                <td align="right" style="width: 15%">
                                ...
                                <td style="width: 15%">
                                    <cc1:CustTextBox ID="txtStatus6" runat="server" MaxLength="1" checktype="num" onkeydown="entersubmit('btnFeeSubmit');"
                                        Width="31px" BoxName="舊制外加費率六STATUS" TabIndex="33"></cc1:CustTextBox>
                                    &nbsp;&nbsp;<cc1:CustTextBox ID="txtFee6" runat="server" MaxLength="5" checktype="num"
                                        onkeydown="entersubmit('btnFeeSubmit');" Width="60px" BoxName="舊制外加費率六" TabIndex="34"></cc1:CustTextBox>
                                </td>
                            </tr>
                            <tr class="trOdd">
                                <td style="width: 15%" align="right">
                                    <cc1:CustLabel ID="lblPage3" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_043" StickHeight="False"></cc1:CustLabel></td>
                                <td colspan="3" style="width: 55%">
                                    <cc1:CustTextBox ID="txtPage3" runat="server" MaxLength="5" onkeydown="entersubmit('btnFeeSubmit');"
                                        checktype="num" onkeyup="changeFeeAllStatus();" BoxName="全卡(1-8)" Width="70px"
                                        TabIndex="7"></cc1:CustTextBox></td>
                                <td align="right" style="width: 15%">
                                ...
                                <td style="width: 15%">
                                    <cc1:CustTextBox ID="txtStatus7" runat="server" MaxLength="1" checktype="num" onkeydown="entersubmit('btnFeeSubmit');"
                                        Width="31px" BoxName="舊制外加費率七STATUS" TabIndex="35"></cc1:CustTextBox>
                                    &nbsp;&nbsp;<cc1:CustTextBox ID="txtFee7" runat="server" MaxLength="5" checktype="num"
                                        onkeydown="entersubmit('btnFeeSubmit');" Width="60px" BoxName="舊制外加費率七" TabIndex="36"></cc1:CustTextBox>
                                </td>
                            </tr>
                            <tr class="trEven">
                                <td style="width: 15%; height: 25px;" align="right">
                                    <cc1:CustLabel ID="lblPage4" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_044" StickHeight="False"></cc1:CustLabel></td>
                                <td style="width: 20%; height: 25px;">
                                    <cc1:CustTextBox ID="txtPage4" runat="server" Width="60px" MaxLength="5" onkeydown="entersubmit('btnFeeSubmit');"
                                        checktype="num" BoxName="01N(本行)" TabIndex="8"></cc1:CustTextBox></td>
                                <td style="height: 25px; width: 15%;" align="right">
                                    <cc1:CustLabel ID="lblRate09" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_052" StickHeight="False"></cc1:CustLabel></td>
                                <td style="width: 20%; height: 25px;">
                                    <cc1:CustTextBox ID="txtRate09" runat="server" Width="60px" MaxLength="5" onkeydown="entersubmit('btnFeeSubmit');"
                                        checktype="num" BoxName="09" TabIndex="16"></cc1:CustTextBox></td>
                                ...
                                <td style="width: 15%; height: 25px;">
                                    <cc1:CustTextBox ID="txtStatus8" runat="server" MaxLength="1" checktype="num" onkeydown="entersubmit('btnFeeSubmit');"
                                        Width="31px" BoxName="舊制外加費率八STATUS" TabIndex="37"></cc1:CustTextBox>
                                    &nbsp;&nbsp;<cc1:CustTextBox ID="txtFee8" runat="server" MaxLength="5" checktype="num"
                                        onkeydown="entersubmit('btnFeeSubmit');" Width="60px" BoxName="舊制外加費率八" TabIndex="38"></cc1:CustTextBox>
                                </td>
                            </tr>
                            <tr class="trOdd">
                                <td style="width: 15%; height: 25px;" align="right">
                                    <cc1:CustLabel ID="lblRate02N" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_045" StickHeight="False"></cc1:CustLabel></td>
                                <td style="width: 20%; height: 25px;">
                                    <cc1:CustTextBox ID="txtRate02N" runat="server" Width="60px" MaxLength="5" onkeydown="entersubmit('btnFeeSubmit');"
                                        checktype="num" BoxName="02N(他行)" TabIndex="9"></cc1:CustTextBox></td>
                                <td style="width: 15%" align="right">
                                    <cc1:CustLabel ID="lblRate10" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_053" StickHeight="False"></cc1:CustLabel></td>
                                <td style="width: 20%">
                                    <cc1:CustTextBox ID="txtRate10" runat="server" Width="60px" MaxLength="5" onkeydown="entersubmit('btnFeeSubmit');"
                                        checktype="num" BoxName="10" TabIndex="17"></cc1:CustTextBox></td>
                                <td align="right" style="width: 15%">
                                ...
                                <td style="width: 15%">
                                    <cc1:CustTextBox ID="txtStatus9" runat="server" MaxLength="1" checktype="num" onkeydown="entersubmit('btnFeeSubmit');"
                                        Width="31px" BoxName="舊制外加費率九STATUS" TabIndex="39"></cc1:CustTextBox>
                                    &nbsp;&nbsp;<cc1:CustTextBox ID="txtFee9" runat="server" MaxLength="5" checktype="num"
                                        onkeydown="entersubmit('btnFeeSubmit');" Width="60px" BoxName="舊制外加費率九" TabIndex="40"></cc1:CustTextBox>
                                </td>
                            </tr>
                            <tr class="trEven">
                                <td style="width: 15%; height: 25px;" align="right">
                                    <cc1:CustLabel ID="lblRate03V" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_046" StickHeight="False"></cc1:CustLabel></td>
                                <td style="width: 20%; height: 25px;">
                                    <cc1:CustTextBox ID="txtRate03V" runat="server" Width="60px" MaxLength="5" onkeydown="entersubmit('btnFeeSubmit');"
                                        checktype="num" BoxName="03V(本行)" TabIndex="10"></cc1:CustTextBox></td>
                                <td style="width: 15%; height: 29px;" align="right">
                                    <cc1:CustLabel ID="lblRate11" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_054" StickHeight="False"></cc1:CustLabel></td>
                                <td style="width: 20%; height: 29px;">
                                    <cc1:CustTextBox ID="txtRate11" runat="server" Width="60px" MaxLength="5" onkeydown="entersubmit('btnFeeSubmit');"
                                        checktype="num" BoxName="11" TabIndex="18"></cc1:CustTextBox></td>
                                <td align="right" style="width: 15%">
                                ...
                                <td style="width: 15%">
                                    <cc1:CustTextBox ID="txtStatus10" runat="server" MaxLength="1" checktype="num" onkeydown="entersubmit('btnFeeSubmit');"
                                        Width="31px" BoxName="舊制外加費率十STATUS" TabIndex="41"></cc1:CustTextBox>
                                    &nbsp;&nbsp;<cc1:CustTextBox ID="txtFee10" runat="server" MaxLength="5" checktype="num"
                                        onkeydown="entersubmit('btnFeeSubmit');" Width="60px" BoxName="舊制外加費率十" TabIndex="42"></cc1:CustTextBox>
                                </td>
                            </tr>
                            <tr class="trOdd">
                                <td style="width: 15%; height: 25px;" align="right">
                                    <cc1:CustLabel ID="lblRate04V" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_047" StickHeight="False"></cc1:CustLabel></td>
                                <td style="width: 20%; height: 25px;">
                                    <cc1:CustTextBox ID="txtRate04V" runat="server" Width="60px" MaxLength="5" onkeydown="entersubmit('btnFeeSubmit');"
                                        checktype="num" BoxName="04V(他行)" TabIndex="11"></cc1:CustTextBox></td>
                                <td style="width: 15%; height: 29px;" align="right">
                                    <cc1:CustLabel ID="lblRate12" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_055" StickHeight="False"></cc1:CustLabel></td>
                                <td style="width: 20%; height: 29px;">
                                    <cc1:CustTextBox ID="txtRate12" runat="server" Width="60px" MaxLength="5" onkeydown="entersubmit('btnFeeSubmit');"
                                        checktype="num" BoxName="12" TabIndex="19"></cc1:CustTextBox></td>
                            ...
                            <tr class="trEven">
                                <td style="width: 15%; height: 25px;" align="right">
                                    <cc1:CustLabel ID="lblRate05M" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_048" StickHeight="False"></cc1:CustLabel></td>
                                <td style="width: 20%; height: 25px;">
                                    <cc1:CustTextBox ID="txtRate05M" runat="server" Width="60px" MaxLength="5" onkeydown="entersubmit('btnFeeSubmit');"
                                        checktype="num" BoxName="05M(本行)" TabIndex="12"></cc1:CustTextBox></td>
                                <td style="width: 15%; height: 29px;" align="right">
                                    <cc1:CustLabel ID="lblRate13" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_056" StickHeight="False"></cc1:CustLabel></td>
                                <td style="width: 20%; height: 29px;">
                                    <cc1:CustTextBox ID="txtRate13" runat="server" Width="60px" MaxLength="5" onkeydown="entersubmit('btnFeeSubmit');"
                                        checktype="num" BoxName="13" TabIndex="20"></cc1:CustTextBox></td>
                                <td colspan="2" style="width: 30%"></td>
                            </tr>
                            <tr class="trOdd">
                                <td style="width: 15%" align="right">
                                    <cc1:CustLabel ID="lblRate06M" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_049" StickHeight="False"></cc1:CustLabel></td>
                                <td style="width: 20%">
                                    <cc1:CustTextBox ID="txtRate06M" runat="server" Width="60px" MaxLength="5" onkeydown="entersubmit('btnFeeSubmit');"
                                        checktype="num" BoxName="06M(他行)" TabIndex="13"></cc1:CustTextBox></td>
                                <td style="width: 15%; height: 29px;" align="right">
                                    <cc1:CustLabel ID="lblRate14" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_057" StickHeight="False"></cc1:CustLabel></td>
                                <td style="width: 20%; height: 29px;">
                                    <cc1:CustTextBox ID="txtRate14" runat="server" Width="60px" MaxLength="5" onkeydown="entersubmit('btnFeeSubmit');"
                                        checktype="num" BoxName="14" TabIndex="21"></cc1:CustTextBox></td>
                                <td colspan="2" style="width: 30%"></td>
                            </tr>
                            <tr class="trEven">
                                <td style="width: 15%" align="right">
                                    <cc1:CustLabel ID="lblRate07J" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_050" StickHeight="False"></cc1:CustLabel></td>
                                <td style="width: 20%">
                                    <cc1:CustTextBox ID="txtRate07J" runat="server" Width="60px" MaxLength="5" onkeydown="entersubmit('btnFeeSubmit');"
                                        checktype="num" BoxName="07J(本行)" TabIndex="14"></cc1:CustTextBox></td>
                                <td style="width: 15%; height: 29px;" align="right">
                                    <cc1:CustLabel ID="lblRate15" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_058" StickHeight="False"></cc1:CustLabel></td>
                                <td style="width: 20%; height: 29px;">
                                    <cc1:CustTextBox ID="txtRate15" runat="server" Width="60px" MaxLength="5" onkeydown="entersubmit('btnFeeSubmit');"
                                        checktype="num" BoxName="15" TabIndex="22"></cc1:CustTextBox></td>
                                <td colspan="2" style="width: 30%"></td>
                            </tr>
                            <tr class="trOdd">
                                <td style="width: 15%" align="right">
                                    <cc1:CustLabel ID="lblRate08J" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_051" StickHeight="False"></cc1:CustLabel></td>
                                <td style="width: 20%">
                                    <cc1:CustTextBox ID="txtRate08J" runat="server" Width="60px" MaxLength="5" onkeydown="entersubmit('btnFeeSubmit');"
                                        checktype="num" BoxName="08J(他行)" TabIndex="15"></cc1:CustTextBox></td>
                                ...
                                <td colspan="2" style="height: 25px">
                                    <li>
                                        <cc1:CustLabel ID="lblAccount" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                            IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False"
                                            SetOmit="False" StickHeight="False" Width="253px" IsColon="False" ShowID="01_01030100_059"></cc1:CustLabel></li>
                                </td>
                            </tr>
                            <tr class="trOdd">
                                <td style="width: 15%" align="right">
                                    <cc1:CustLabel ID="lblBankName" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_060" StickHeight="False"></cc1:CustLabel></td>
                                <td style="width: 85%">
                                    <cc1:CustTextBox ID="txtBankName" runat="server" MaxLength="5" onkeydown="entersubmit('btnAccountSubmit');"
                                         onblur="changeFullType(this);" onpaste="paste();" BoxName="銀行名稱" checktype="fulltype"></cc1:CustTextBox></td>
                            </tr>
                            <tr class="trEven">
                                <td style="width: 15%" align="right">
                                    <cc1:CustLabel ID="lblBranchName" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_061" StickHeight="False"></cc1:CustLabel></td>
                                <td style="width: 85%">
                                    <cc1:CustTextBox ID="txtBranchName" runat="server" MaxLength="10" onkeydown="entersubmit('btnAccountSubmit');"
                                         onblur="changeFullType(this);" onpaste="paste();" BoxName="分行名稱" checktype="fulltype"></cc1:CustTextBox></td>
                            </tr>
                            <tr class="trOdd">
                                <td style="width: 15%" align="right">
                                    <cc1:CustLabel ID="lblAccountName" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_062" StickHeight="False"></cc1:CustLabel></td>
                                <td style="width: 85%">
                                    <cc1:CustTextBox ID="txtAccount" runat="server" MaxLength="20" onkeydown="entersubmit('btnAccountSubmit');"
                                         onblur="changeFullType(this);" onpaste="paste();" BoxName="戶名" checktype="fulltype"></cc1:CustTextBox></td>
                            </tr>
                            <tr class="trEven">
                                <td style="width: 15%" align="right">
                                    <cc1:CustLabel ID="lblCheckNum" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_063" StickHeight="False"></cc1:CustLabel></td>
                                <td style="width: 85%">
                                    <cc1:CustTextBox ID="txtCheckNum" runat="server" checktype="num" MaxLength="4" onkeydown="entersubmit('btnAccountSubmit');"
                                        onpaste="paste();" Width="96px" BoxName="檢碼"></cc1:CustTextBox></td>
                            </tr>
                            <tr class="trOdd">
                                <td style="width: 15%" align="right">
                                    <cc1:CustLabel ID="lblAccountID" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_064" StickHeight="False"></cc1:CustLabel></td>
                                <td style="width: 85%">
                                    <cc1:CustTextBox ID="txtAccount1" runat="server" Width="96px" MaxLength="3" onkeydown="entersubmit('btnAccountSubmit');"
                                        checktype="num" BoxName="帳號一"></cc1:CustTextBox>&nbsp;<cc1:CustTextBox ID="txtAccount2"
                                            runat="server" MaxLength="14" onkeydown="entersubmit('btnAccountSubmit');" checktype="num"
                                            BoxName="帳號二"></cc1:CustTextBox></td>
                            </tr>
                            <tr class="itemTitle">
                                ...
                                <td colspan="2">
                                    <li>
                                        <cc1:CustLabel ID="lblCancelCode" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                            IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False"
                                            SetOmit="False" StickHeight="False" Width="249px" IsColon="False" ShowID="01_01030100_065"></cc1:CustLabel></li>
                                </td>
                            </tr>
                            <tr class="trOdd">
                                <td style="width: 15%" align="right">
                                    <cc1:CustLabel ID="lblCancelCode1" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_066" StickHeight="False"></cc1:CustLabel></td>
                                <td style="width: 85%">
                                    <cc1:CustTextBox ID="txtCancelCode1" runat="server" Width="90px" MaxLength="1" checktype="num"
                                        onkeydown="entersubmit('btnCancelTaskSubmit');" BoxName="解約代號"></cc1:CustTextBox></td>
                            </tr>
                            <tr class="trEven">
                                <td style="width: 15%" align="right">
                                    <cc1:CustLabel ID="lblCancelDate" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_067" StickHeight="False"></cc1:CustLabel></td>
                                <td style="width: 85%">
                                    <cc1:CustTextBox ID="txtCancelDate" runat="server" Width="90px" MaxLength="6" onkeydown="entersubmit('btnCancelTaskSubmit');"
                                        checktype="num" BoxName="解約日期"></cc1:CustTextBox>&nbsp;&nbsp;<cc1:CustLabel ID="lblMessageDate"
                                            runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2" IsColon="False"
                                            IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False"
                                            SetOmit="False" ShowID="01_01030100_068" StickHeight="False"></cc1:CustLabel></td>
                            </tr>
                            <tr class="trOdd">
                                <td style="width: 15%; height: 17px;" align="right">
                                    <cc1:CustLabel ID="lblCancelCode2" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_069" StickHeight="False"></cc1:CustLabel></td>
                                <td style="width: 85%; height: 17px;">
                                    <cc1:CustTextBox ID="txtCancelCode2" runat="server" Width="90px" MaxLength="2" onkeydown="entersubmit('btnCancelTaskSubmit');"
                                        checktype="numandletter" BoxName="解約原因碼"></cc1:CustTextBox></td>
                            </tr>
                            <%--分隔行--%>
                            <tr class="itemTitle">
                                <td colspan="2"></td>
                                ...
                                <td colspan="6">
                                    <li>
                                        <cc1:CustLabel ID="lblMachineData" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                            IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False"
                                            SetOmit="False" StickHeight="False" Width="250px" IsColon="False" ShowID="01_01030100_070"></cc1:CustLabel></li>
                                </td>
                            </tr>
                            <tr class="trOdd">
                                ...
                                <td style="width: 13%" align="left">&nbsp;&nbsp;&nbsp;
                                    <cc1:CustLabel ID="lblType1" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        ...
                                        SetBreak="False" SetOmit="False" ShowID="01_01030100_080" StickHeight="False"></cc1:CustLabel>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<cc1:CustLabel
                                            ID="lblCount1" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                            IsColon="False" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                            SetBreak="False" SetOmit="False" ShowID="01_01030100_081" StickHeight="False"></cc1:CustLabel>
                                </td>
                                <td style="width: 10%" align="right"></td>
                                <td style="width: 13%" align="left">&nbsp;&nbsp;&nbsp;
                            ...
                            <tr class="trEven">
                                ...
                                <td style="width: 10%" align="right">
                                    <cc1:CustLabel ID="lblEdcMoney" runat="server" CurSymbol="£" FractionalDigit="0"
                                        ...
                                        SetOmit="False" StickHeight="False" IsColon="True" CurAlign="left" ShowID="01_01030100_079"></cc1:CustLabel></td>
                                <td style="width: 13%" align="left">
                                    <cc1:CustTextBox ID="txtEdcMoney" runat="server" Width="50px" MaxLength="5" onkeydown="entersubmit('btnMaSubmit');"
                                        checktype="num" BoxName="保證金3"></cc1:CustTextBox></td>
                            </tr>
                            <tr class="itemTitle">
                                <td colspan="6" align="center">
                    ...
                    <cc1:CustPanel ID="pnlBasicByTaxno" runat="server" Height="363px" Width="100%" Visible="false">
                        <table width="100%" border="0" cellpadding="0" cellspacing="1" id="tabBasicByTaxno" style="">
                            ...
                            <tr class="trEven">
                                ...
                                <td style="width: 35%">
                                    <cc1:CustTextBox ID="txtCORP_NO" runat="server" Width="140px" MaxLength="8" TabIndex="1"
                                        onkeydown="entersubmit('btnSubmitByTaxno');" checktype="num" BoxName="總公司統一編號"></cc1:CustTextBox>
                                </td>
                                <%--AML行業編號--%>
                                <td align="right" style="width: 15%">
                            ...
                            <tr class="trOdd">
                                ...
                                <td style="width: 35%;" colspan="3">
                                    <cc1:CustTextBox ID="txtREG_NAME_CH" runat="server" Width="240px" IsValEmpty="False" TabIndex="7"
                            ...
                            <tr class="trEven">
                                ...
                                <td style="width: 35%" colspan="3">
                                    <cc1:CustTextBox ID="txtREG_NAME_EN" runat="server" Width="240px" MaxLength="40" TabIndex="8"
                                        onkeydown="entersubmit('btnSubmitByTaxno');" BoxName="商店英文名稱"></cc1:CustTextBox>
                                </td>
                            </tr>
                            <tr class="trOdd">
                                <%--登記地址--%>
                            ...
                            <tr class="trEven">
                                ...
                                <td style="width: 35%">
                                    <cc1:CustTextBox ID="txtReplaceType" runat="server" Width="40px" MaxLength="1" TabIndex="21"
                                        onkeydown="entersubmit('btnSubmitByTaxno');" checktype="num" BoxName="換證點" ToolTip="1.初 2.補 3.換"></cc1:CustTextBox>
                                </td>
                            </tr>
                            <tr class="trOdd">
                                <%--國籍--%>
                                ...
                                <td style="width: 35%" colspan="3">
                                    <div style="position: relative">
                                        <cc1:CustTextBox ID="txtPrincipalCountryCode" runat="server" MaxLength="2" Width="50px" onfocus="allselect(this);"
                                            onkeydown="entersubmit('btnSubmitByTaxno');" BoxName="國籍" TabIndex="22"
                                            Style="left: 0px; top: 0px; position: relative; width: 32px; height: 11px;" AutoPostBack="true" OnTextChanged="txtCodeType_TextChanged"></cc1:CustTextBox>
                            ...
                            <tr class="trEven">
                                ...
                                <td style="width: 35%">
                                    <cc1:CustTextBox ID="txtPrincipalPassportNo" runat="server" MaxLength="22" Width="200px" TabIndex="23"
                                        onkeydown="entersubmit('btnSubmitByTaxno');" BoxName="護照號碼" InputType="LetterAndInt"></cc1:CustTextBox>
                                </td>
                                <%--護照效期--%>
                                <td align="right" style="width: 15%">
                                ...
                                <td style="width: 35%">
                                    <cc1:CustTextBox ID="txtPrincipalPassportExpdt" runat="server" MaxLength="8" Width="200px" TabIndex="24"
                                        onkeydown="entersubmit('btnSubmitByTaxno');" BoxName="護照效期" InputType="LetterAndInt"></cc1:CustTextBox>
                                </td>
                            </tr>
                            <tr class="trOdd">
                                <%--居留證號--%>
                                ...
                                <td style="width: 35%">
                                    <cc1:CustTextBox ID="txtPrincipalResidentNo" runat="server" MaxLength="22" Width="200px" TabIndex="25"
                                        onkeydown="entersubmit('btnSubmitByTaxno');" BoxName="居留證號"></cc1:CustTextBox>
                                </td>
                                <%--居留效期--%>
                                <td align="right" style="width: 15%">
                                ...
                                <td style="width: 35%">
                                    <cc1:CustTextBox ID="txtPrincipalResidentExpdt" runat="server" MaxLength="8" Width="200px" TabIndex="26"
                                        onkeydown="entersubmit('btnSubmitByTaxno');" BoxName="居留效期"></cc1:CustTextBox>
                                </td>
                            </tr>
                            ...
                            <tr class="trEven">
                                <td align="right" style="width: 15%">
                                    <cc1:CustLabel ID="CustLabel31" runat="server" CurAlign="left" CurSymbol="£"
                                        ...
                                        StickHeight="False"></cc1:CustLabel></td>
                                <td style="width: 35%" colspan="3">
                                    <cc1:CustTextBox ID="txtPrincipal_TEL1" runat="server" Width="40px" MaxLength="3"
                                        onkeydown="entersubmit('btnSubmitByTaxno');" checktype="num" BoxName="負責人電話一" TabIndex="27"></cc1:CustTextBox>
                                    <cc1:CustTextBox ID="txtPrincipal_TEL2" runat="server" Width="100px" MaxLength="8"
                                        onkeydown="entersubmit('btnBasicSubmit');" checktype="num" BoxName="負責人電話二" TabIndex="28"></cc1:CustTextBox>
                                    <cc1:CustTextBox ID="txtPrincipal_TEL3" runat="server" Width="40px" MaxLength="5"
                                        onkeydown="entersubmit('btnSubmitByTaxno');" checktype="num" BoxName="負責人電話三" TabIndex="29"></cc1:CustTextBox>
                                </td>
                            </tr>
                            <%--負責人戶籍地址--%>
                            <tr class="trOdd">
                            ...
                            <tr class="trEven" runat="server" visible="false">
                                ...
                                <td style="width: 35%" colspan="3">
                                    <cc1:CustTextBox ID="txtBANK_NAME" runat="server" Width="140px" MaxLength="5" TabIndex="33"
                            ...
                            <tr class="trOdd" runat="server" visible="false">                                
                                ...
                                <td style="width: 35%" colspan="3">
                                    <cc1:CustTextBox ID="txtBANK_BRANCH" runat="server" Width="140px" MaxLength="10" TabIndex="34"
                            ...
                            <tr class="trEven" runat="server" visible="false">                                
                                ...
                                <td style="width: 35%" colspan="3">
                                    <cc1:CustTextBox ID="txtBANK_ACCT_NAME" runat="server" Width="140px" MaxLength="20" TabIndex="35"
                            ...
                            <tr class="trEven">
                                ...
                                <td style="width: 35%" colspan="3">
                                    <cc1:CustTextBox ID="txtARCHIVE_NO" runat="server" Width="140px" MaxLength="9" TabIndex="39"
                                        onkeydown="entersubmit('btnSubmitByTaxno');" checktype="num" BoxName="歸檔編號"></cc1:CustTextBox>
                            ...
                            <tr class="trOdd">
                                ...
                                <td style="width: 16%; height: 33px;">
                                    <cc1:CustTextBox ID="txtLAST_UPD_MAKER3" runat="server" MaxLength="9" checktype="numandletter"
                                        Width="100px" onkeydown="entersubmit('btnAdd');" BoxName="資料最後異動MAKER" onfocus="allselect(this);" TabIndex="40"></cc1:CustTextBox>
                                </td>
                                <%--資料最後異動CHECKER--%>
                                <td align="right" style="width: 20%; height: 33px;" >
                                ...
                                <td style="width: 18%; height: 33px;">
                                    <cc1:CustTextBox ID="txtLAST_UPD_CHECKER3" runat="server" MaxLength="9" checktype="numandletter"
                                        Width="100px" onkeydown="entersubmit('btnAdd');" BoxName="資料最後異動CHECKER" onfocus="allselect(this);" TabIndex="41"></cc1:CustTextBox>
                                </td>
                            </tr>
                            <tr class="trEven">
                                ...
                                <td style="width: 16%; height: 33px;"colspan="3">
                                    <cc1:CustTextBox ID="txtLAST_UPD_BRANCH3" runat="server" MaxLength="4" Width="100px"
                                        onkeydown="entersubmit('btnAdd');" BoxName="資料最後異動分行" checktype="numandletter"
                                        onfocus="allselect(this);" TabIndex="42"></cc1:CustTextBox>
                                </td>
                            </tr>
                            <tr class="itemTitle">
                                <%--提交--%>
                                <td colspan="5" align="center">&nbsp;<cc1:CustButton ID="btnSubmitByTaxno" Text="" runat="server" Width="57px" CssClass="smallButton"
                                    ...
                                    onkeydown="setfocus('btnBasicDataByTaxno');" DisabledWhenSubmit="False" ShowID="01_01030100_002"  TabIndex="43" />
                                </td>
                            </tr>
                        </table>
                    </cc1:CustPanel>
