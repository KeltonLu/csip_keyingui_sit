<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010102100001.aspx.cs" Inherits="P010102100001" %>
                        ...
                        <td colspan="4">
                            <li>
                                <cc1:CustLabel ID="lblTitle" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    ...
                                    SetOmit="False" StickHeight="False" Width="275px" IsColon="False" ShowID="01_01021000_001"></cc1:CustLabel></li>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td colspan="4">
                            <li>
                                <cc1:CustLabel ID="lblHead" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0" SetBreak="False"
                                    SetOmit="False" StickHeight="False" Width="160px" IsColon="False" ShowID="01_01021000_002"></cc1:CustLabel></li>
                        </td>
                    </tr>
                    <tr class="trOdd">
                        <td align="right" style="width: 15%">
                            <cc1:CustLabel ID="lblCardNo" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                ...
                                SetBreak="False" SetOmit="False" ShowID="01_01021000_003" StickHeight="False"></cc1:CustLabel>
                        </td>
                        <td style="width: 35%">
                        ...
                        <td align="right" style="width: 15%">
                            <cc1:CustLabel ID="lblOldCode" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                IsColon="True" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
                                SetBreak="False" SetOmit="False" StickHeight="False" ShowID="01_01021000_004"></cc1:CustLabel>
                        </td>
                        <td style="width: 35%">
                        ...
                        <tr class="itemTitle">
                            <td align="center" colspan="6">
                                <cc1:CustButton ID="btnSubmit" runat="server" CssClass="smallButton" Width="40px"
                                    ...
                                    DisabledWhenSubmit="False" ShowID="01_01021000_005" />
                            </td>
                        </tr>
                    </table>
                </cc1:CustPanel>
