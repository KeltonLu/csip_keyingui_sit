<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010801160001.aspx.cs" Inherits="Page_P010801160001" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
            <ContentTemplate>
                        ...
                        <td>
                            <li>
                                <cc1:CustLabel ID="lblTitle" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                    ...
                                    SetOmit="False" StickHeight="False" Width="397px" IsColon="False" ShowID="01_01080116_001" CssClass="auto-style1"></cc1:CustLabel>
                            </li>
                        </td>
                    </tr>
                ...
                <%--商店資訊--%>
                <table width="100%" border="0" cellpadding="0" cellspacing="1" id="tabNo12" style="table-layout:fixed">
                    <tr class="itemTitle">
                        <td>
                            <li>
                    ...
                    <tr class="trOdd"> 
                        <td align="center" width="16%">
                            <cc1:CustButton ID="btnBack" runat="server" CssClass="smallButton" ShowID="01_01090400_067"
                                ...
                                DisabledWhenSubmit="False" BoxName="返回" Style="margin-right:50px" />
