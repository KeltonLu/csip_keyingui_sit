<%@ Page Language="C#" AutoEventWireup="true" CodeFile="P010401010001.aspx.cs" Inherits="P010401010001" %>
    ...
    <script language="javascript" type="text/javascript">
        function checkInputText(id,intType)
        {
            ...
            {                 var sReceiveNumber=document.getElementById('txtReceiveNumber').value.Trim() ;                            //*檢核輸入欄位【收件編號】是否為空                 if(sReceiveNumber == "")
                {
                    ...
                    alert('請輸入收件編號');
                    return false;
                }else{                    //*檢核輸入欄位【收件編號】前兩碼需為 RK                    //20160622 (U) by Tank, 允許RC 修改                    if (sReceiveNumber.substring(0,2).toUpperCase() != "RK" && sReceiveNumber.substring(0,2).toUpperCase() != "RC")
                    {
                        alert("收件編號格式不對！");
                        document.getElementById('txtReceiveNumber').focus();
                        return false;
            ...
            {                
                ...
                var sProdCode = document.getElementById('txtPRODCODE').value.Trim();
                var sProgram = document.getElementById('txtPROGRAM').value.Trim();
            	if(sProgram=="" || sProgram.length<5){
            	    document.getElementById('txtPROGRAM').focus();
            		alert('【PROGRAM-NO】欄位輸入錯誤，或者未填！');
            		return false;
                }                

            	if(sProdCode=="" || sProdCode.length<2){
            	    document.getElementById('txtPRODCODE').focus();
            		alert('【PROD-CODE】欄位輸入錯誤，或者未填！');
            		return false;
                }
                    ...
                    <cc1:CustPanel ID="pnlText" runat="server" Width="100%">
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="1" id="Table3" style="">
                            ...
                            <tr class="trOdd">
                                ...
                                <td colspan="2">
                                    <cc1:CustLabel ID="lbUSEREXIT_Type04" runat="server" CurAlign="left" CurSymbol="£" FractionalDigit="2"
                                        IsColon="False" IsCurrency="False" NeedDateFormat="False" NumBreak="0" NumOmit="0"
