...
namespace CSIPKeyInGUI.BusinessRules
{
    public class BRRedeemSet : CSIPCommonModel.BusinessRules.BRBase<EntityRedeemSet>
    {
        ...
        public const string SQL_SQL_FILE_DETAIL_HASMER = @"select a.RECEIVE_NUMBER,a.ReceiveDate+' '+a.ReceiveTime as RTime,a.USER_ID as USER_ID1,a.SubmitDate+' '+a.SubmitTime as STime1,
                                                            ...
                                                            where a.RECEIVE_NUMBER like @RECEIVE_NUMBER and a.ReceiveDate like @ReceiveDate and a.KEYIN_FLAG = '1' and 
                                                            ...
                                                            a.MERCHANT_NO10 like @MERCHANT_NO)";
        ...
        public static DataSet GetFileDetail(string strRECEIVENUMBER, string strReceiveDate, string strMERCHANT, int iPageIndex, int iPageSize, ref int iTotalCount)
        {
            try
            {
                SqlCommand sc = new SqlCommand();
                ...
                SqlParameter spRD = new SqlParameter("ReceiveDate", strReceiveDate);
                sc.Parameters.Add(spRD);
