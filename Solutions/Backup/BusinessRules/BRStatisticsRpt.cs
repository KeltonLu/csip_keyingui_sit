    ...
    {    
                                ...
                                string strSearchEnd, ref string strMsgID)
        {
            try
            {
               ...
               dstSearchResult = BRStatisticsRpt.SearchOnDataSet(sqlcmdSearch);
                ...
                sqlcmdSearch.CommandText = sbSqlCommand.ToString();
                Logging.SaveLog(ELogLayer.BusinessRule, sbSqlCommand.ToString());
                            ...
                            out ReportDocument rptResult, ref string strMsgID)
        {
            try
            {
                ...
                string strRPTPathFile = AppDomain.CurrentDomain.BaseDirectory + UtilHelper.GetAppSettings("ReportTemplate") + "newitem_sum.rpt";
